...
#disable device collectives for neighnor_allgatherv to test MPIR algorithms
...
#disable device collectives for neighnor_alltoall to test MPIR algorithms
...
#disable device collectives for neighnor_alltoallv to test MPIR algorithms
