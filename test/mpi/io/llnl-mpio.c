 ...
 * imply its endorsement, recommendation, or favoring by the Unted
 ...
 *
 * Commericialization of this product is prohibited without notifying
 * the Department of Energy (DOE) or Lawrence Livermore National
 * Laboratory (LLNL).  Contact: Lawrence Livermore National
 * Laboratory, Industrial Partnerships and Commercialization Office,
 * P.O. Box 808, L-795, Livermore, CA 94551.
 *
 * This notice must be included with any copies of the software that
 * are redistributed.
 *
 *
 * Functions:
