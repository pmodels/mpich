...
int main(int argc, char **argv)
{
    ...
    /* Test : hints vci_idx_sender and vci_idx_receiver with valid values.
     * Here we expect the program to run successfully when these valid
     * values are provided.
     */
    hints_1[0] = "vci_idx_sender";
     ...
     * We expect MPI to ignore these values and use internal vci_idx selection
     * logic. So, even with with these hints applied, send-recv should run
     * successfully.
     */
    hints_1[0] = "vci_idx_sender";
    hints_1[1] = "vci_idx_receiver";
