...
dlltool --dllname mpich2.dll --def mpich2gcc.def --output-lib ..\lib\libmpich2.a >> ..\make.log
REM dlltool --dllname mpich2d.dll --def mpich2gccd.def --output-lib ..\lib\libmpich2d.a
dlltool --dllname mpich2mpi.dll --def mpich2mpi.def --output-lib ..\lib\libmpi.a >> ..\make.log
REM dlltool --dllname mpich2mpid.dll --def mpich2mpid.def --output-lib ..\lib\libmpid.a
dlltool --dllname fmpich2g.dll --def fmpich2gcc.def --output-lib ..\lib\libfmpich2g.a >> ..\make.log
