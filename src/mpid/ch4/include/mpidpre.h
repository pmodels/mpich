...
typedef struct MPIDI_vci {
    ...
    struct MPIR_Request *request_cache[MPIDI_MAX_REQUEST_CACHE_COUNT];  /* a cache to store requests before returning them to the global pool */
    int request_cache_count;    /* TODO: this needs to be atomic */
