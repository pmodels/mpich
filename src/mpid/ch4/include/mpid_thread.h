...
#define MPID_THREAD_CS_ENTER       MPIDI_THREAD_CS_ENTER
#define MPID_THREAD_CS_EXIT        MPIDI_THREAD_CS_EXIT
#define MPID_THREAD_CS_YIELD       MPIDI_THREAD_CS_YIELD
#define MPID_Thread_mutex_create   MPIDI_Thread_mutex_create
#define MPID_Thread_mutex_destroy  MPIDI_Thread_mutex_destroy
#define MPID_Thread_mutex_lock     MPIDI_Thread_mutex_lock
#define MPID_Thread_mutex_unlock   MPIDI_Thread_mutex_unlock
#define MPID_Thread_cond_wait      MPIDI_Thread_cond_wait
#else
