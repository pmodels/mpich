...
MPL_STATIC_INLINE_PREFIX int MPID_Barrier(MPIR_Comm *, int coll_attr) MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX int MPID_Bcast(void *, MPI_Aint, MPI_Datatype, int, MPIR_Comm *,
                                        int coll_attr) MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX int MPID_Allreduce(const void *, void *, MPI_Aint, MPI_Datatype, MPI_Op,
                                            MPIR_Comm *, int coll_attr) MPL_STATIC_INLINE_SUFFIX;
