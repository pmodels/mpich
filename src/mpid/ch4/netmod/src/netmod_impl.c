...
{
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_NM_ALGORITHM_PARSER);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_NM_NM_ALGORITHM_PARSER);

    MPIDI_NM_func->algorithm_parser(coll_id, cnt_num, cnt, value);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_NM_NM_ALGORITHM_PARSER);
}
#endif
#endif
