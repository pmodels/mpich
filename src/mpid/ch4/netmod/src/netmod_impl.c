...
int MPIDI_NM_mpi_comm_parent_commit_hook(MPIR_Comm * parent_comm, MPIR_Comm * comm)
{
    int ret;

    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_NM_MPI_COMM_PARENT_COMMIT_HOOK);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_NM_MPI_COMM_PARENT_COMMIT_HOOK);

    ret = MPIDI_NM_func->mpi_comm_parent_commit_hook(parent_comm, comm);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_NM_MPI_COMM_PARENT_COMMIT_HOOK);
    return ret;
}
