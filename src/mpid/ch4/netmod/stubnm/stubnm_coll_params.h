...
typedef enum {
    ...
    MPIDI_STUBNM_Ibcast_intra_smp_id,
    MPIDI_STUBNM_Ibcast_intra_tree_id,
    MPIDI_STUBNM_Ibcast_intra_ring_id,
    MPIDI_STUBNM_Ibcast_intra_scatter_recexch_allgather_id,
