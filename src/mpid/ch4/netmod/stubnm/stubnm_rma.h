...
{
    return MPIDIG_mpi_put(origin_addr, origin_count, origin_datatype,
...
static inline int MPIDI_NM_mpi_get(void *origin_addr,
                                   ...
                                   MPIR_Win * win, MPIDI_av_entry_t * addr)
{
    return MPIDIG_mpi_get(origin_addr, origin_count, origin_datatype,
                          target_rank, target_disp, target_count, target_datatype, win);
}
...
{
    return MPIDIG_mpi_rput(origin_addr, origin_count, origin_datatype,
...
static inline int MPIDI_NM_mpi_compare_and_swap(const void *origin_addr,
                                                ...
                                                MPIR_Win * win, MPIDI_av_entry_t * addr)
{
    return MPIDIG_mpi_compare_and_swap(origin_addr, compare_addr, result_addr,
...
static inline int MPIDI_NM_mpi_raccumulate(const void *origin_addr,
                                           ...
                                           MPIDI_av_entry_t * addr, MPIR_Request ** request)
{
    return MPIDIG_mpi_raccumulate(origin_addr, origin_count, origin_datatype,
...
static inline int MPIDI_NM_mpi_rget_accumulate(const void *origin_addr,
                                               ...
                                               MPIDI_av_entry_t * addr, MPIR_Request ** request)
{
    return MPIDIG_mpi_rget_accumulate(origin_addr, origin_count, origin_datatype,
...
static inline int MPIDI_NM_mpi_fetch_and_op(const void *origin_addr,
                                            ...
                                            MPIR_Win * win, MPIDI_av_entry_t * addr)
{
    return MPIDIG_mpi_fetch_and_op(origin_addr, result_addr, datatype,
...
{
    return MPIDIG_mpi_rget(origin_addr, origin_count, origin_datatype,
                           target_rank, target_disp, target_count, target_datatype, win, request);
}
...
static inline int MPIDI_NM_mpi_get_accumulate(const void *origin_addr,
                                              ...
                                              MPIR_Win * win, MPIDI_av_entry_t * addr)
{
    return MPIDIG_mpi_get_accumulate(origin_addr, origin_count, origin_datatype,
                                     result_addr, result_count, result_datatype,
                                     target_rank, target_disp, target_count,
...
static inline int MPIDI_NM_mpi_accumulate(const void *origin_addr,
                                          ...
                                          MPIR_Win * win, MPIDI_av_entry_t * addr)
{
    return MPIDIG_mpi_accumulate(origin_addr, origin_count, origin_datatype,
