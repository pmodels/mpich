...
typedef int (*MPIDI_NM_mpi_win_attach_hook_t) (MPIR_Win * win, void *base, size_t size);
...
typedef void (*MPIDI_NM_prequest_free_hook_t) (MPIR_Request * req);
typedef int (*MPIDI_NM_mpi_send_t) (const void *buf, size_t count, MPI_Datatype datatype,
                                    int rank, int tag, MPIR_Comm * comm, int context_offset,
                                    MPIDI_av_entry_t * addr, MPIR_Request ** request);
typedef int (*MPIDI_NM_mpi_ssend_t) (const void *buf, size_t count, MPI_Datatype datatype,
                                     int rank, int tag, MPIR_Comm * comm, int context_offset,
                                     MPIDI_av_entry_t * addr, MPIR_Request ** request);
...
typedef int (*MPIDI_NM_mpi_bsend_init_t) (const void *buf, int count, MPI_Datatype datatype,
                                          int rank, int tag, MPIR_Comm * comm, int context_offset,
                                          MPIDI_av_entry_t * addr, MPIR_Request ** request);
typedef int (*MPIDI_NM_mpi_isend_t) (const void *buf, size_t count, MPI_Datatype datatype,
                                     int rank, int tag, MPIR_Comm * comm, int context_offset,
                                     MPIDI_av_entry_t * addr, MPIR_Request ** request);
typedef int (*MPIDI_NM_mpi_issend_t) (const void *buf, size_t count, MPI_Datatype datatype,
                                      int rank, int tag, MPIR_Comm * comm, int context_offset,
                                      MPIDI_av_entry_t * addr, MPIR_Request ** request);
...
typedef int (*MPIDI_NM_mpi_recv_init_t) (void *buf, int count, MPI_Datatype datatype, int rank,
                                         ...
                                         MPIDI_av_entry_t * addr, MPIR_Request ** request);
typedef int (*MPIDI_NM_mpi_recv_t) (void *buf, size_t count, MPI_Datatype datatype, int rank,
                                    int tag, MPIR_Comm * comm, int context_offset,
                                    MPIDI_av_entry_t * addr, MPI_Status * status,
                                    MPIR_Request ** request);
typedef int (*MPIDI_NM_mpi_irecv_t) (void *buf, size_t count, MPI_Datatype datatype, int rank,
                                     int tag, MPIR_Comm * comm, int context_offset,
                                     MPIDI_av_entry_t * addr, MPIR_Request ** request);
typedef int (*MPIDI_NM_mpi_imrecv_t) (void *buf, size_t count, MPI_Datatype datatype,
...
typedef int (*MPIDI_NM_mpi_win_shared_query_t) (MPIR_Win * win, int rank, size_t * size,
...
typedef int (*MPIDI_NM_mpi_win_create_t) (void *base, size_t length, int disp_unit,
...
typedef int (*MPIDI_NM_mpi_accumulate_t) (const void *origin_addr, int origin_count,
                                          ...
                                          MPIDI_av_entry_t * addr);
typedef int (*MPIDI_NM_mpi_win_attach_t) (MPIR_Win * win, void *base, size_t size);
typedef int (*MPIDI_NM_mpi_win_allocate_shared_t) (size_t size, int disp_unit,
...
typedef int (*MPIDI_NM_mpi_fetch_and_op_t) (const void *origin_addr, void *result_addr,
                                            ...
                                            MPIDI_av_entry_t * addr);
typedef int (*MPIDI_NM_mpi_win_allocate_t) (size_t size, int disp_unit, MPIR_Info * info,
...
typedef struct MPIDI_NM_funcs {
    ...
    MPIDI_NM_prequest_free_hook_t prequest_free_hook;
...
int MPIDI_NM_mpi_win_attach_hook(MPIR_Win * win, void *base, size_t size);
...
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_recv_init(void *buf, int count, MPI_Datatype datatype,
                                                    ...
                                                    MPIR_Request **
                                                    request) MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_recv(void *buf, size_t count, MPI_Datatype datatype,
                                               int rank, int tag, MPIR_Comm * comm,
                                               int context_offset, MPIDI_av_entry_t * addr,
                                               MPI_Status * status,
                                               MPIR_Request ** request) MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_irecv(void *buf, size_t count, MPI_Datatype datatype,
                                                int rank, int tag, MPIR_Comm * comm,
                                                int context_offset, MPIDI_av_entry_t * addr,
                                                MPIR_Request ** request) MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_imrecv(void *buf, size_t count, MPI_Datatype datatype,
...
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_win_fence(int assert,
                                                    MPIR_Win * win) MPL_STATIC_INLINE_SUFFIX;
int MPIDI_NM_mpi_win_create(void *base, size_t length, int disp_unit, MPIR_Info * info,
...
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_accumulate(const void *origin_addr, int origin_count,
                                                     ...
                                                     MPIDI_av_entry_t *
                                                     addr) MPL_STATIC_INLINE_SUFFIX;
int MPIDI_NM_mpi_win_attach(MPIR_Win * win, void *base, size_t size);
int MPIDI_NM_mpi_win_allocate_shared(size_t size, int disp_unit, MPIR_Info * info_ptr,
...
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_mpi_fetch_and_op(const void *origin_addr, void *result_addr,
                                                       ...
                                                       MPIDI_av_entry_t *
                                                       addr) MPL_STATIC_INLINE_SUFFIX;
int MPIDI_NM_mpi_win_allocate(size_t size, int disp_unit, MPIR_Info * info, MPIR_Comm * comm,
