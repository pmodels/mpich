...
typedef int (*MPIDI_NM_mpi_comm_parent_commit_hook_t) (MPIR_Comm * parent_comm, MPIR_Comm * comm);
...
typedef struct MPIDI_NM_funcs {
    ...
    MPIDI_NM_mpi_comm_parent_commit_hook_t mpi_comm_parent_commit_hook;
