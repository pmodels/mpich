                                                  ...
                                                  void * algo_parameters_ptr)
{
    ...
    ret = MPIDI_NM_native_func->mpi_scatter(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                                            recvtype, root, comm, errflag, algo_parameters_ptr);
                                                  ...
                                                  void * algo_parameters_ptr)
{
    ...
    ret = MPIDI_NM_native_func->mpi_gatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
                                            displs, recvtype, root, comm, errflag, algo_parameters_ptr);
                                                         ...
                                                         void * algo_parameters_ptr)
{
    ...
    ret = MPIDI_NM_native_func->mpi_reduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op,
                                                   comm_ptr, errflag, algo_parameters_ptr);
                                               ...
                                               void * algo_parameters_ptr)
{
    ...
    ret = MPIDI_NM_native_func->mpi_scan(sendbuf, recvbuf, count, datatype, op, comm, errflag, algo_parameters_ptr);
                                                 ...
                                                 void * algo_parameters_ptr)
{
    ...
    ret = MPIDI_NM_native_func->mpi_exscan(sendbuf, recvbuf, count, datatype, op, comm, errflag, algo_parameters_ptr);
