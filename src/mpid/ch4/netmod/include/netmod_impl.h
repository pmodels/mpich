...
MPL_STATIC_INLINE_PREFIX size_t MPIDI_NM_am_eager_limit(void)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_NM_AM_EAGER_LIMIT);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_NM_AM_EAGER_LIMIT);

    ret = MPIDI_NM_func->am_eager_limit();

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_NM_AM_EAGER_LIMIT);
    return ret;
}
...
MPL_STATIC_INLINE_PREFIX size_t MPIDI_NM_am_eager_buf_limit(void)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_NM_AM_EAGER_BUF_LIMIT);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_NM_AM_EAGER_BUF_LIMIT);

    ret = MPIDI_NM_func->am_eager_buf_limit();

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_NM_AM_EAGER_BUF_LIMIT);
    return ret;
}
...
MPL_STATIC_INLINE_PREFIX bool MPIDI_NM_am_check_eager(MPI_Aint am_hdr_sz, MPI_Aint data_sz,
                                                      ...
                                                      MPI_Datatype datatype, MPIR_Request * sreq)
{
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_NM_AM_CHECK_EAGER);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_NM_AM_CHECK_EAGER);

    MPIDI_NM_func->am_check_eager(am_hdr_sz, data_sz, data, count, datatype, sreq);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_NM_AM_CHECK_EAGER);
}
                                                 ...
                                                 MPIR_Errflag_t * errflag)
{
    ...
    ret = MPIDI_NM_native_func->isend_coll(buf, count, datatype, rank, tag, comm, context_offset,
