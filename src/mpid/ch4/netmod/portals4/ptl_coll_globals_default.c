...
/* Ibcast default PTL containers initialization*/
const MPIDI_PTL_coll_algo_container_t MPIDI_PTL_Ibcast_intra_binomial_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_binomial_id
};

const MPIDI_PTL_coll_algo_container_t
    MPIDI_PTL_Ibcast_intra_scatter_recursive_doubling_allgather_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_scatter_recursive_doubling_allgather_id
};

const MPIDI_PTL_coll_algo_container_t MPIDI_PTL_Ibcast_intra_scatter_ring_allgather_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_scatter_ring_allgather_id
};

const MPIDI_PTL_coll_algo_container_t MPIDI_PTL_Ibcast_intra_smp_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_smp_id
};

const MPIDI_PTL_coll_algo_container_t MPIDI_PTL_Ibcast_intra_tree_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_tree_id
};

const MPIDI_PTL_coll_algo_container_t MPIDI_PTL_Ibcast_intra_ring_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_ring_id
};

const MPIDI_PTL_coll_algo_container_t MPIDI_PTL_Ibcast_intra_scatter_recexch_allgather_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_scatter_recexch_allgather_id
};
