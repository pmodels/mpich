...
const MPIDI_PTL_coll_algo_container_t MPIDI_PTL_Ibcast_intra_tree_knomial_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_tree_knomial_id
};

const MPIDI_PTL_coll_algo_container_t MPIDI_PTL_Ibcast_intra_tree_kary_cnt = {
    .id = MPIDI_PTL_Ibcast_intra_tree_kary_id
};
