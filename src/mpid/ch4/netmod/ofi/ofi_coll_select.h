...
MPL_STATIC_INLINE_PREFIX
    MPIDI_OFI_coll_algo_container_t * MPIDI_OFI_Gatherv_select(const void *sendbuf,
                                                               ...
                                                               ATTRIBUTE((unused)))
{
    return (MPIDI_OFI_coll_algo_container_t *) & OFI_Gatherv_allcomm_linear_cnt;
}
...
MPL_STATIC_INLINE_PREFIX
    MPIDI_OFI_coll_algo_container_t * MPIDI_OFI_Scatterv_select(const void *sendbuf,
                                                                ...
                                                                ATTRIBUTE((unused)))
{
    return (MPIDI_OFI_coll_algo_container_t *) & OFI_Scatterv_allcomm_linear_cnt;
}
                                                                ...
                                                                ATTRIBUTE((unused)))
{
    ...
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Alltoall_intra_pairwise_sendrecv_replace_cnt;
                                                                 ...
                                                                 ATTRIBUTE((unused)))
{
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Alltoallv_intra_pairwise_sendrecv_replace_cnt;
    } else {
                                                                 ...
                                                                 ATTRIBUTE((unused)))
{
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Alltoallw_intra_pairwise_sendrecv_replace_cnt;
    } else {
                                                                      ...
                                                                      ATTRIBUTE((unused)))
{
    ...
    if (!is_commutative) {
        ...
        if (pof2 == comm_size && is_block_regular) {
            ...
            return (MPIDI_OFI_coll_algo_container_t *) &
                OFI_Reduce_scatter_intra_noncommutative_cnt;
        } else {
                                                                            ...
                                                                            ATTRIBUTE((unused)))
{
    ...
    if (!is_commutative) {
        ...
        if (!(comm_size & (comm_size - 1))) {
            ...
            return (MPIDI_OFI_coll_algo_container_t *) &
                OFI_Reduce_scatter_block_intra_noncommutative_cnt;
        } else {
...
MPL_STATIC_INLINE_PREFIX
    MPIDI_OFI_coll_algo_container_t * MPIDI_OFI_Scan_select(const void *sendbuf,
                                                            ...
                                                            ATTRIBUTE((unused)))
{
    return (MPIDI_OFI_coll_algo_container_t *) & OFI_Scan_intra_recursive_doubling_cnt;
}
