                                                             ...
                                                             ATTRIBUTE((unused)))
{
    ...
    if ((nbytes < MPIR_CVAR_BCAST_SHORT_MSG_SIZE) ||
        ...
        if (nbytes < MPIR_CVAR_BCAST_LONG_MSG_SIZE && MPL_is_pof2(comm_ptr->local_size, NULL)) {
            ...
            return (MPIDI_OFI_coll_algo_container_t *) &
                OFI_Bcast__intra__scatter_ring_allgather_cnt;
        }
    }
}
                                                                 ...
                                                                 ATTRIBUTE((unused)))
{
    ...
    if ((count * type_size <= MPIR_CVAR_ALLREDUCE_SHORT_MSG_SIZE) ||
        ...
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Allreduce__intra__reduce_scatter_allgather_cnt;
    }
}
                                                                ...
                                                                ATTRIBUTE((unused)))
{
    ...
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Alltoall__intra__pairwise_sendrecv_replace_cnt;
                                                                 ...
                                                                 ATTRIBUTE((unused)))
{
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Alltoallv__intra__pairwise_sendrecv_replace_cnt;
    } else {
                                                                 ...
                                                                 ATTRIBUTE((unused)))
{
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Alltoallw__intra__pairwise_sendrecv_replace_cnt;
    } else {
                                                                      ...
                                                                      ATTRIBUTE((unused)))
{
    ...
    if ((is_commutative) && (nbytes < MPIR_CVAR_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE)) {
        ...
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Reduce_scatter__intra__recursive_halving_cnt;
    }
    if (is_commutative && (nbytes >= MPIR_CVAR_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE)) {
    ...
    if (!is_commutative) {
        ...
        if (pof2 == comm_size && is_block_regular) {
            ...
            return (MPIDI_OFI_coll_algo_container_t *) &
                OFI_Reduce_scatter__intra__noncommutative_cnt;
        } else {
            /* noncommutative and (non-pof2 or block irregular), use recursive doubling. */
            return (MPIDI_OFI_coll_algo_container_t *) &
                OFI_Reduce_scatter__intra__recursive_doubling_cnt;
        }
    }
}
                                                                            ...
                                                                            ATTRIBUTE((unused)))
{
    ...
    if ((is_commutative) && (nbytes < MPIR_CVAR_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE)) {
        /* commutative and short. use recursive halving algorithm */
        return (MPIDI_OFI_coll_algo_container_t *) &
            OFI_Reduce_scatter_block__intra__recursive_halving_cnt;
    }
    if (is_commutative && (nbytes >= MPIR_CVAR_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE)) {
        /* commutative and long message, or noncommutative and long message.
         * use (p-1) pairwise exchanges */
    ...
    if (!is_commutative) {
        ...
        if (!(comm_size & (comm_size - 1))) {
            ...
            return (MPIDI_OFI_coll_algo_container_t *) &
                OFI_Reduce_scatter_block__intra__noncommutative_cnt;
        } else {
