...
typedef enum {
    MPIDI_OFI_bcast_shumilin_id,
    MPIDI_OFI_bcast_knomial_id,
    MPIDI_OFI_bcast_empty_id
...
typedef union {
    ...
    struct MPIDI_OFI_bcast_shumilin_parameters {
        int segment_size;
