...
static int async_send_copy(MPIR_Request * sreq, int nic, uint64_t disp,
                           ...
                           MPI_Aint offset, MPL_pointer_attr_t * attr)
{
    ...
    mpi_errno = MPIR_Ilocalcopy_gpu(chunk_buf, chunk_sz, MPIR_BYTE_INTERNAL, 0, NULL,
                                    (void *) buf, count, datatype, offset, attr,
    ...
    mpi_errno = MPIR_Async_things_add(send_copy_poll, p, NULL);
