...
int MPIDI_OFI_mpi_comm_accept(const char *port_name, MPIR_Info * info, int root, MPIR_Comm * comm,
...
int MPIDI_OFI_mpi_win_create_dynamic(MPIR_Info * info, MPIR_Comm * comm, MPIR_Win ** win);
