...
#undef COLL_hybrid_dt_t
#undef COLL_hybrid_op_t
#undef COLL_hybrid_comm_t
#undef COLL_hybrid_req_t
#undef COLL_hybrid_sched_t
#undef COLL_hybrid_aint_t
#undef COLL_hybrid_global_t
