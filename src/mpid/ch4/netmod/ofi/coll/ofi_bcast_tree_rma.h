 ...
 *
 */
#ifndef OFI_BCAST_TREE_RMA_H_INCLUDED
#define OFI_BCAST_TREE_RMA_H_INCLUDED
...
/*@
 * This function performs a kary/knomial tree based bcast using one-sided communication.
 *
 * Input Parameters:
                                                                 ...
                                                                 int branching_factor)
{
    ...
    int nranks, ret;
    int num_children = 0, num_works = 0, myrank = -1, leaf = 0;
    MPIR_Treealgo_tree_t my_tree;

    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_OFI_BCAST_INTRA_TRIGGERED_RMA);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_OFI_BCAST_INTRA_TRIGGERED_RMA);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_OFI_BCAST_INTRA_TRIGGERED_RMA);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
...
#endif /* OFI_BCAST_TREE_RMA_H_INCLUDED */
