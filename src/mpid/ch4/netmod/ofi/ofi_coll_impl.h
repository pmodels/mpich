...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoall_bruck
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoall_bruck(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoall_isend_irecv
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoall_isend_irecv(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                                   void *recvbuf, int recvcount, MPI_Datatype recvtype,
                                   MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag,
                                   MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
{
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoall_pairwise_exchange
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoall_pairwise_exchange(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                                         void *recvbuf, int recvcount, MPI_Datatype recvtype,
                                         MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag,
                                         MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
{
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoall_sendrecv_replace
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoall_sendrecv_replace(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                                        void *recvbuf, int recvcount, MPI_Datatype recvtype,
                                        MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag,
                                        MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
{
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoallv_sendrecv_replace
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoallv_sendrecv_replace(const void *sendbuf, const int *sendcounts,
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoallv_isend_irecv
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoallv_isend_irecv(const void *sendbuf, const int *sendcounts,
                                    const int *sdispls, MPI_Datatype sendtype,
                                    void *recvbuf, const int *recvcounts,
                                    const int *rdispls, MPI_Datatype recvtype,
                                    MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag,
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoallw_sendrecv_replace
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoallw_sendrecv_replace(const void *sendbuf, const int sendcounts[], const int sdispls[],
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoallw_isend_irecv
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoallw_isend_irecv(const void *sendbuf, const int sendcounts[], const int sdispls[],
                                    const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[],
                                    const int rdispls[], const MPI_Datatype recvtypes[],
                                    MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag,
                                    MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_alltoallw_pairwise_exchange
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_alltoallw_pairwise_exchange(const void *sendbuf, const int sendcounts[], const int sdispls[],
                                          const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[],
                                          const int rdispls[], const MPI_Datatype recvtypes[],
                                          MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag,
                                          MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_allgather_recursive_doubling
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_allgather_recursive_doubling(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                                           void *recvbuf, int recvcount, MPI_Datatype recvtype,
                                           MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag,
                                           MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
{
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_allgather_bruck
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_allgather_bruck(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                              void *recvbuf, int recvcount, MPI_Datatype recvtype,
                              MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag,
                              MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
{
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_allgather_ring
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_allgather_ring(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                             void *recvbuf, int recvcount, MPI_Datatype recvtype,
                             MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag,
                             MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
{
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_allgatherv_recursive_doubling
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_allgatherv_recursive_doubling(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_allgatherv_bruck
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_allgatherv_bruck(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                               void *recvbuf, const int *recvcounts, const int *displs,
                               MPI_Datatype recvtype, MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag,
                               MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
{
...
#undef FUNCNAME
#define FUNCNAME MPIDI_OFI_allgatherv_ring
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
int MPIDI_OFI_allgatherv_ring(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                              void *recvbuf, const int *recvcounts, const int *displs,
                              MPI_Datatype recvtype, MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag,
                              MPIDI_OFI_coll_algo_container_t * params_container ATTRIBUTE((unused)))
{
