...
#define MPIDI_OFI_CONTEXT_BITS_NO_DATA  (16)
#define MPIDI_OFI_SOURCE_BITS_NO_DATA   (16)
#define MPIDI_OFI_TAG_BITS_NO_DATA      (28)
...
#define MPIDI_OFI_CONTEXT_BITS_DATA  (16)
#define MPIDI_OFI_SOURCE_BITS_DATA   (0)
#define MPIDI_OFI_TAG_BITS_DATA      (31)
...
#define MPIDI_OFI_CONTEXT_BITS       (MPIDI_OFI_ENABLE_DATA ? MPIDI_OFI_CONTEXT_BITS_DATA : MPIDI_OFI_CONTEXT_BITS_NO_DATA)
#define MPIDI_OFI_SOURCE_BITS        (MPIDI_OFI_ENABLE_DATA ? MPIDI_OFI_SOURCE_BITS_DATA : MPIDI_OFI_SOURCE_BITS_NO_DATA)
#define MPIDI_OFI_TAG_BITS           (MPIDI_OFI_ENABLE_DATA ? MPIDI_OFI_TAG_BITS_DATA : MPIDI_OFI_TAG_BITS_NO_DATA)
#else
...
#define MPIDI_OFI_CONTEXT_BITS       MPIDI_OFI_CONTEXT_BITS_NO_DATA
#define MPIDI_OFI_SOURCE_BITS        MPIDI_OFI_SOURCE_BITS_NO_DATA
#define MPIDI_OFI_TAG_BITS           MPIDI_OFI_TAG_BITS_NO_DATA
#else
...
#define MPIDI_OFI_CONTEXT_BITS       MPIDI_OFI_CONTEXT_BITS_DATA
#define MPIDI_OFI_SOURCE_BITS        MPIDI_OFI_SOURCE_BITS_DATA
#define MPIDI_OFI_TAG_BITS           MPIDI_OFI_TAG_BITS_DATA
#endif
#endif
