                                         ...
                                         MPIR_Comm * comm_self, int spawned, int *n_vnis_provided)
{
    ...
    *tag_bits = MPIDI_OFI_TAG_BITS;
    ...
    if (MPIDI_Global.max_mr_key_size >= 8) {
        ...
        MPIDI_Global.context_bits = MPIDI_OFI_MAX_CONTEXT_BITS_64;
        ...
        MPIDI_Global.context_bits = MPIDI_OFI_MAX_CONTEXT_BITS_32;
        ...
        MPIDI_Global.context_bits = MPIDI_OFI_MAX_CONTEXT_BITS_16;
