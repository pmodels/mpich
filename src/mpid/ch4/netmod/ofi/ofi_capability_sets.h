...
#define MPIDI_OFI_MAX_ENDPOINTS             MPIDI_OFI_MAX_ENDPOINTS_REGULAR
#define MPIDI_OFI_MAX_ENDPOINTS_BITS        MPIDI_OFI_MAX_ENDPOINTS_BITS_REGULAR
...
#define MPIDI_OFI_MAX_ENDPOINTS             MPIDI_OFI_MAX_ENDPOINTS_SCALABLE
#define MPIDI_OFI_MAX_ENDPOINTS_BITS        MPIDI_OFI_MAX_ENDPOINTS_BITS_SCALABLE
#define MPIDI_OFI_ENABLE_STX_RMA            MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_MR_SCALABLE        MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_TAGGED             MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_AM                 MPIDI_OFI_ON
