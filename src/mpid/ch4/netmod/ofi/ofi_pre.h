...
typedef struct {
    ...
    MPIDI_OFI_am_request_header_t *sreq_hdr;    /* used during am_isend_{eager,rdma_read,pipeline} */
    MPIDI_OFI_am_request_header_t *rreq_hdr;    /* only used during rdma_read */
