                            ...
                            MPIR_Comm * comm_self, int spawned, int *n_vnis_provided)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_UCX_MPI_INIT);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_UCX_MPI_INIT);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_UCX_MPI_INIT);
    return mpi_errno;
  fn_fail:
...
int MPIDI_UCX_mpi_finalize_hook(void)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_UCX_MPI_FINALIZE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_UCX_MPI_FINALIZE);
  ...
  fn_exit:
    MPL_free(pending);
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_UCX_MPI_FINALIZE);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
