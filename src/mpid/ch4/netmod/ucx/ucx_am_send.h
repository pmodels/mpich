...
static inline int MPIDI_NM_rsend(const void *buf,
                                 ...
                                 MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
    return MPIDI_CH4U_rsend(buf, count, datatype, rank, tag, comm, context_offset,
                            request, MPIDI_NM);
}
...
static inline int MPIDI_NM_irsend(const void *buf,
                                  ...
                                  MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
    return MPIDI_CH4U_irsend(buf, count, datatype, rank, tag, comm, context_offset,
                             request, MPIDI_NM);
}
...
{
    return MPIDI_CH4U_mpi_cancel_send(sreq, MPIDI_NM);
}
