...
#undef FUNCNAME
#define FUNCNAME ucx_send_continous_light
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX int ucx_send_continous_light(const void *buf,
                                                size_t data_sz,
                                                int rank,
                                                int tag,
                                                ...
                                                MPIR_Request ** request)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_SEND_CONTINOUS_LIGHT);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_SEND_CONTINOUS_LIGHT);
  ...
  fn_exit:
    *request = req;
    ...
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_SEND_CONTINOUS_LIGHT);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
...
#undef FUNCNAME
#define FUNCNAME ucx_send_non_continous_light
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)


MPL_STATIC_INLINE_PREFIX int ucx_send_non_continous_light(const void *buf,
                                                    size_t count,
                                                    int rank,
                                                    int tag,
                                                    MPIR_Comm * comm, int context_offset,
                                                    ...
                                                    MPIR_Datatype * datatype)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_SEND_NON_CONTINOUS_LIGHT);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_SEND_NON_CONTINOUS_LIGHT);
  ...
  fn_exit:
    *request = req;
    ...
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_SEND_NON_CONTINOUS_LIGHT);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
...
#undef FUNCNAME
#define FUNCNAME ucx_sync_send__continous
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME ucx_sync_send_non_continous
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                         ...
                                                         MPIR_Datatype * datatype)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_SYNC_SEND_CONTINOUS);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_SYNC_SEND_CONTINOUS);
  ...
  fn_exit:
    *request = req;
    ...
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_SYNC_SEND_CONTINOUS);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
...
#undef FUNCNAME
#define FUNCNAME ucx_send_non_continous
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                                    ...
                                                    MPIR_Datatype * datatype)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_SEND_NON_CONTINOUS);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_SEND_NON_CONTINOUS);
                           ...
                           MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
    ...
    if (dt_contig)
        ...
        mpi_errno =
            ucx_send_non_continous(buf, count, rank, tag, comm, context_offset, request,  dt_ptr);
...
#undef FUNCNAME
#define FUNCNAME ucx_send_light
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int ucx_send_light(const void *buf,
                           int count,
                           MPI_Datatype datatype,
                           int rank,
                           int tag,
                           MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
    ...
    if (dt_contig)
        mpi_errno =
            ucx_send_continous_light((char *) buf + dt_true_lb, data_sz, rank, tag, comm, context_offset, request);
    else
        mpi_errno =
            ucx_send_non_continous_light(buf, count, rank, tag, comm, context_offset, request,  dt_ptr);
                                    ...
                                    MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_SEND);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_SEND);
    mpi_errno = ucx_send_light(buf, count, datatype, rank, tag, comm, context_offset, request);
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_SEND);
    return mpi_errno;
}
                                 ...
                                 MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
    ...
    return ucx_send(buf, count, datatype, rank, tag, comm, context_offset, request);
}
...
static inline int MPIDI_NM_mpi_ssend(const void *buf,
                                     ...
                                     MPIR_Comm * comm, int context_offset, MPIR_Request ** request)
{
    return ucx_sync_send(buf, count, datatype, rank, tag, comm, context_offset, request);
}
