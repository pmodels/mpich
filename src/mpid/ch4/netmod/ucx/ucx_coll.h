                                                    ...
                                                    MPIR_Errflag_t errflag)
{
    ...
    {
        mpi_errno =
            MPIR_Allreduce_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group,
                                errflag);
    }
                                                  ...
                                                  MPIR_Errflag_t errflag)
{
    ...
    mpi_errno = MPIR_Gatherv_impl(sendbuf, sendcount, sendtype, recvbuf,
                                  recvcounts, displs, recvtype, root, comm_ptr, coll_group,
                                  errflag);
                                                   ...
                                                   MPIR_Errflag_t errflag)
{
    ...
    mpi_errno = MPIR_Scatterv_impl(sendbuf, sendcounts, displs, sendtype,
                                   recvbuf, recvcount, recvtype, root, comm_ptr, coll_group,
                                   errflag);
                                                 ...
                                                 MPIR_Errflag_t errflag)
{
    ...
    {
        mpi_errno =
            MPIR_Reduce_impl(sendbuf, recvbuf, count, datatype, op, root, comm_ptr, coll_group,
                             errflag);
    }
    MPIR_FUNC_EXIT;
    return mpi_errno;
                                               ...
                                               MPIR_Errflag_t errflag)
{
    ...
    mpi_errno =
        MPIR_Scan_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group, errflag);
                                                 ...
                                                 MPIR_Errflag_t errflag)
{
    ...
    mpi_errno =
        MPIR_Exscan_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group, errflag);
                                                   ...
                                                   MPIR_Request ** req)
{
    ...
    mpi_errno = MPIR_Ibarrier_impl(comm_ptr, coll_group, req);
                                                 ...
                                                 MPIR_Request ** req)
{
    ...
    mpi_errno = MPIR_Ibcast_impl(buffer, count, datatype, root, comm_ptr, coll_group, req);
                                                  ...
                                                  MPIR_Request ** req)
{
    ...
    mpi_errno = MPIR_Iexscan_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group, req);
                                                  ...
                                                  MPIR_Request ** req)
{
    ...
    mpi_errno =
        MPIR_Ireduce_impl(sendbuf, recvbuf, count, datatype, op, root, comm_ptr, coll_group, req);
                                                ...
                                                MPIR_Request ** req)
{
    ...
    mpi_errno = MPIR_Iscan_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group, req);
