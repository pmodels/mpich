...
#define MPIDI_UCX_COMM_TO_EP(comm,rank,vci) \
    MPIDI_UCX_AV(MPIDIU_comm_rank_to_av(comm, rank)).dest[vci]
#define MPIDI_UCX_AV_TO_EP(av,vci) MPIDI_UCX_AV((av)).dest[vci]
