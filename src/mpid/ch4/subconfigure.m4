...
MPIDI_${net_upper}_gather_params_t ${net};"
    fi
...
MPIDI_${net_upper}_gatherv_params_t ${net};"
    fi
...
MPIDI_${net_upper}_scatter_params_t ${net};"
    fi
...
MPIDI_${net_upper}_scan_params_t ${net};"
    fi
...
MPIDI_${net_upper}_exscan_params_t ${net};"
    fi
...
MPIDI_${shm_upper}_gather_params_t ${shm};"
    fi
...
MPIDI_${shm_upper}_gatherv_params_t ${shm};"
    fi
...
MPIDI_${shm_upper}_scatter_params_t ${shm};"
    fi
...
MPIDI_${shm_upper}_exscan_params_t ${shm};"
    fi
...
MPIDI_${shm_upper}_scan_params_t ${shm};"
    fi
