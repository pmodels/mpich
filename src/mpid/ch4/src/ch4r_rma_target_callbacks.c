...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_unlock_ack_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
...
int MPIDI_get_ack_target_cmpl_cb(MPIR_Request * rreq)
{
    ...
    MPIDI_win_remote_cmpl_cnt_decr(win, MPIDIG_REQUEST(greq, rank));
...
int MPIDI_get_acc_ack_target_cmpl_cb(MPIR_Request * areq)
{
    ...
    MPIDI_win_remote_cmpl_cnt_decr(win, MPIDIG_REQUEST(areq, rank));
    MPIDI_win_remote_acc_cmpl_cnt_decr(win, MPIDIG_REQUEST(areq, rank));
...
int MPIDI_cswap_ack_target_cmpl_cb(MPIR_Request * rreq)
{
    ...
    MPIDI_win_remote_cmpl_cnt_decr(win, MPIDIG_REQUEST(rreq, rank));
    MPIDI_win_remote_acc_cmpl_cnt_decr(win, MPIDIG_REQUEST(rreq, rank));
                                ...
                                MPIDIG_am_target_cmpl_cb * target_cmpl_cb, MPIR_Request ** req)
{
    ...
    MPIDI_win_remote_cmpl_cnt_decr(win, MPIDIG_REQUEST(preq, rank));
