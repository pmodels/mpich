...
static void win_lock_req_proc(int handler_id, const MPIDI_CH4U_win_cntrl_msg_t * info,
                              MPIR_Win * win);
static void win_lock_ack_proc(int handler_id, const MPIDI_CH4U_win_cntrl_msg_t * info,
                              MPIR_Win * win);
static void win_unlock_proc(const MPIDI_CH4U_win_cntrl_msg_t * info, MPIR_Win * win);
static void win_complete_proc(const MPIDI_CH4U_win_cntrl_msg_t * info, MPIR_Win * win);
static void win_post_proc(const MPIDI_CH4U_win_cntrl_msg_t * info, MPIR_Win * win);
static void win_unlock_done(const MPIDI_CH4U_win_cntrl_msg_t * info, MPIR_Win * win);
