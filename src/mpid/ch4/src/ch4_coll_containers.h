...
extern const MPIDI_coll_algo_container_t MPIDI_Reduce_inter_fallback_cnt;
...
extern const MPIDI_coll_algo_container_t MPIDI_Alltoallv_inter_fallback_cnt;

/* Alltoallw  CH4 level containers declaration */
extern const MPIDI_coll_algo_container_t MPIDI_Alltoallw_intra_netmod_cnt;
extern const MPIDI_coll_algo_container_t MPIDI_Alltoallw_inter_fallback_cnt;
...
extern const MPIDI_coll_algo_container_t MPIDI_Reduce_scatter_intra_netmod_cnt;
extern const MPIDI_coll_algo_container_t MPIDI_Reduce_scatter_inter_fallback_cnt;

/* Reduce_scatter_block CH4 level containers declaration */
extern const MPIDI_coll_algo_container_t MPIDI_Reduce_scatter_block_intra_netmod_cnt;
extern const MPIDI_coll_algo_container_t MPIDI_Reduce_scatter_block_inter_fallback_cnt;
