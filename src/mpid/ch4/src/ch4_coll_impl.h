...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Bcast_intra_local_then_nodes(void *buffer,
                                                                     int count,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Bcast_inter_fallback(void *buffer, int count,
                                                        MPI_Datatype datatype, int root,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Allreduce_intra_netmod(const void *sendbuf, void *recvbuf,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Allreduce_inter_fallback(const void *sendbuf, void *recvbuf,
                                                            int count, MPI_Datatype datatype,
                                                            MPI_Op op, MPIR_Comm * comm,
                                                            MPIR_Errflag_t * errflag,
                                                            const MPIDI_coll_algo_container_t * ch4_algo_parameters_container ATTRIBUTE((unused)))
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Reduce_intra_netmod(const void *sendbuf, void *recvbuf,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Reduce_inter_fallback(const void *sendbuf, void *recvbuf,
                                                         int count, MPI_Datatype datatype,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Alltoall_intra_netmod(const void *sendbuf, int sendcount,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Alltoall_inter_fallback(const void *sendbuf, int sendcount,
                                                           MPI_Datatype sendtype, void *recvbuf,
                                                           int recvcount, MPI_Datatype recvtype,
                                                           MPIR_Comm * comm_ptr,
                                                           MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Alltoallv_intra_netmod(const void *sendbuf,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Alltoallv_inter_fallback(const void *sendbuf,
                                                            const int *sendcounts,
                                                            const int *sdispls,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Alltoallw_intra_netmod(const void *sendbuf,
                                                          const int sendcounts[],
                                                          const int sdispls[],
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Allgather_intra_netmod(const void *sendbuf, int sendcount,
                                                          MPI_Datatype sendtype, void *recvbuf,
                                                          int recvcount, MPI_Datatype recvtype,
                                                          MPIR_Comm * comm_ptr,
                                                          MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Allgatherv_intra_netmod(const void *sendbuf, int sendcount,
                                                           MPI_Datatype sendtype, void *recvbuf,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Allgatherv_inter_fallback(const void *sendbuf, int sendcount,
                                                             MPI_Datatype sendtype, void *recvbuf,
                                                             const int *recvcounts,
                                                             const int *displs,
                                                             MPI_Datatype recvtype,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Gather_intra_netmod(const void *sendbuf, int sendcount,
                                                       MPI_Datatype sendtype, void *recvbuf,
                                                       int recvcount, MPI_Datatype recvtype,
                                                       int root, MPIR_Comm * comm,
                                                       MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Gather_inter_fallback(const void *sendbuf, int sendcount,
                                                         MPI_Datatype sendtype, void *recvbuf,
                                                         int recvcount, MPI_Datatype recvtype,
                                                         int root,
                                                         MPIR_Comm * comm, MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Gatherv_inter_fallback(const void *sendbuf, int sendcount,
                                                          MPI_Datatype sendtype, void *recvbuf,
                                                          const int *recvcounts, const int *displs,
                                                          MPI_Datatype recvtype, int root,
                                                          MPIR_Comm * comm,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Scatter_intra_netmod(const void *sendbuf, int sendcount,
                                                        MPI_Datatype sendtype, void *recvbuf,
                                                        int recvcount, MPI_Datatype recvtype,
                                                        int root, MPIR_Comm * comm,
                                                        MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Scatter_inter_fallback(const void *sendbuf, int sendcount,
                                                          MPI_Datatype sendtype, void *recvbuf,
                                                          int recvcount, MPI_Datatype recvtype,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Scatterv_intra_netmod(const void *sendbuf, const int *sendcounts,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Reduce_scatter_inter_fallback(const void *sendbuf, void *recvbuf,
                                                                 const int recvcounts[],
                                                                 MPI_Datatype datatype, MPI_Op op,
                                                                 MPIR_Comm * comm_ptr,
                                                                 MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Reduce_scatter_intra_netmod(const void *sendbuf, void *recvbuf,
                                                               const int recvcounts[],
                                                               MPI_Datatype datatype, MPI_Op op,
                                                               MPIR_Comm * comm_ptr,
                                                               MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Reduce_scatter_block_inter_fallback(const void *sendbuf,
                                                                       void *recvbuf, int recvcount,
                                                                       MPI_Datatype datatype,
                                                                       MPI_Op op,
                                                                       MPIR_Comm * comm_ptr,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Scan_intra_local_node_local(const void *sendbuf, void *recvbuf,
                                                               int count, MPI_Datatype datatype,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
/* *INDENT-OFF* */
MPL_STATIC_INLINE_PREFIX int MPIDI_Exscan_intra_netmod(const void *sendbuf, void *recvbuf,
                                                       int count, MPI_Datatype datatype,
                                                       MPI_Op op, MPIR_Comm * comm_ptr,
                                                       MPIR_Errflag_t * errflag,
                                                       const MPIDI_coll_algo_container_t * ch4_algo_parameters_container)
