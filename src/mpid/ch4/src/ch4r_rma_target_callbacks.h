...
static inline int MPIDIG_RMA_Init_targetcb_pvars(void)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_ack_put
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_ack_put(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_ack_cswap
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_ack_cswap(MPIR_Request * rreq)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_ack_acc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_ack_acc(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_ack_get_acc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_ack_get_acc(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS, c;
    MPIDIG_acc_ack_msg_t ack_msg;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_lock_advance
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_win_lock_advance(MPIR_Win * win)
{
    int mpi_errno = MPI_SUCCESS;
    ...
    if ((lock_recvd_q->head != NULL) && ((lock_recvd_q->count == 0) ||
        ...
        mpi_errno = MPIDIG_win_lock_advance(win);
        if (mpi_errno)
            MPIR_ERR_POP(mpi_errno);
    }
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_lock_req_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDIG_win_lock_req_proc(int handler_id,
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_lock_ack_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDIG_win_lock_ack_proc(int handler_id,
                                            const MPIDIG_win_cntrl_msg_t * info, MPIR_Win * win)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_unlock_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDIG_win_unlock_proc(const MPIDIG_win_cntrl_msg_t * info, int is_local,
                                          MPIR_Win * win)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_complete_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDIG_win_complete_proc(const MPIDIG_win_cntrl_msg_t * info, MPIR_Win * win)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_post_proc
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDIG_win_post_proc(const MPIDIG_win_cntrl_msg_t * info, MPIR_Win * win)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_unlock_done
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDIG_win_unlock_done(const MPIDIG_win_cntrl_msg_t * info, MPIR_Win * win)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_handle_acc_cmpl
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_handle_acc_cmpl(MPIR_Request * rreq)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_handle_get_acc_cmpl
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_handle_get_acc_cmpl(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS, i;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_handle_acc_data
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDIG_handle_acc_data(void **data, size_t * p_data_sz, int *is_contig,
                                          MPIR_Request * rreq)
{
    void *p_data = NULL;
    size_t data_sz;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_target_cmpl_cb(MPIR_Request * req)
{
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_put_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_put_target_cmpl_cb(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_put_iov_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_put_iov_target_cmpl_cb(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_acc_iov_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_acc_iov_target_cmpl_cb(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_acc_iov_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_acc_iov_target_cmpl_cb(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_cswap_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_cswap_target_cmpl_cb(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    void *compare_addr;
    void *origin_addr;
    ...
    if (!MPIDIG_check_cmpl_order(rreq, MPIDIG_cswap_target_cmpl_cb))
        return mpi_errno;
    ...
    mpi_errno = MPIDIG_ack_cswap(rreq);
    if (mpi_errno)
        MPIR_ERR_POP(mpi_errno);
    MPID_Request_complete(rreq);
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_acc_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_acc_target_cmpl_cb(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    ...
    if (!MPIDIG_check_cmpl_order(rreq, MPIDIG_acc_target_cmpl_cb))
        return mpi_errno;

    mpi_errno = MPIDIG_handle_acc_cmpl(rreq);
    if (mpi_errno)
        MPIR_ERR_POP(mpi_errno);
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_acc_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_acc_target_cmpl_cb(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    ...
    if (!MPIDIG_check_cmpl_order(rreq, MPIDIG_get_acc_target_cmpl_cb))
        return mpi_errno;

    mpi_errno = MPIDIG_handle_get_acc_cmpl(rreq);
    if (mpi_errno)
        MPIR_ERR_POP(mpi_errno);
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_acc_ack_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_acc_ack_target_cmpl_cb(MPIR_Request * areq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_Win *win;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_cswap_ack_target_cmpl_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_cswap_ack_target_cmpl_cb(MPIR_Request * rreq)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_Win *win;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_put_ack_taget_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_put_ack_taget_msg_cb(int handler_id, void *am_hdr,
                                              void **data,
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_acc_ack_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_acc_ack_target_msg_cb(int handler_id, void *am_hdr,
                                               void **data,
                                               size_t * p_data_sz, int is_local, int *is_contig,
                                               MPIDIG_am_target_cmpl_cb * target_cmpl_cb,
                                               MPIR_Request ** req)
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_acc_ack_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_acc_ack_target_msg_cb(int handler_id, void *am_hdr,
                                                   void **data,
                                                   size_t * p_data_sz, int is_local, int *is_contig,
                                                   MPIDIG_am_target_cmpl_cb * target_cmpl_cb,
                                                   MPIR_Request ** req)
{
    ...
    *req = areq;
    *target_cmpl_cb = MPIDIG_get_acc_ack_target_cmpl_cb;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_cswap_ack_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_cswap_ack_target_msg_cb(int handler_id, void *am_hdr,
                                                 void **data,
                                                 size_t * p_data_sz, int is_local, int *is_contig,
                                                 MPIDIG_am_target_cmpl_cb * target_cmpl_cb,
                                                 MPIR_Request ** req)
{
    ...
    *req = creq;
    *target_cmpl_cb = MPIDIG_cswap_ack_target_cmpl_cb;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_win_ctrl_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_win_ctrl_target_msg_cb(int handler_id, void *am_hdr,
                                                void **data,
                                                size_t * p_data_sz, int is_local, int *is_contig,
                                                MPIDIG_am_target_cmpl_cb * target_cmpl_cb,
                                                MPIR_Request ** req)
{
    ...
    switch (handler_id) {
        ...
        case MPIDIG_WIN_LOCKALL:
            MPIDIG_win_lock_req_proc(handler_id, msg_hdr, win);
            break;

        case MPIDIG_WIN_LOCK_ACK:
        case MPIDIG_WIN_LOCKALL_ACK:
            MPIDIG_win_lock_ack_proc(handler_id, msg_hdr, win);
            break;

        case MPIDIG_WIN_UNLOCK:
        case MPIDIG_WIN_UNLOCKALL:
            MPIDIG_win_unlock_proc(msg_hdr, is_local, win);
            break;

        case MPIDIG_WIN_UNLOCK_ACK:
        case MPIDIG_WIN_UNLOCKALL_ACK:
            MPIDIG_win_unlock_done(msg_hdr, win);
            break;

        case MPIDIG_WIN_COMPLETE:
            MPIDIG_win_complete_proc(msg_hdr, win);
            break;

        case MPIDIG_WIN_POST:
            MPIDIG_win_post_proc(msg_hdr, win);
            break;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_put_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_put_target_msg_cb(int handler_id, void *am_hdr,
                                           void **data,
                                           size_t * p_data_sz,
                                           int is_local,
                                           int *is_contig,
                                           ...
                                           MPIR_Request ** req)
{
    ...
    *target_cmpl_cb = MPIDIG_put_target_cmpl_cb;
#ifndef MPIDI_CH4_DIRECT_NETMOD
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_put_iov_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_put_iov_target_msg_cb(int handler_id, void *am_hdr,
                                               void **data,
                                               size_t * p_data_sz,
                                               int is_local,
                                               int *is_contig,
                                               ...
                                               MPIR_Request ** req)
{
    ...
    *target_cmpl_cb = MPIDIG_put_iov_target_cmpl_cb;
#ifndef MPIDI_CH4_DIRECT_NETMOD
    MPIDI_REQUEST(rreq, is_local) = is_local;
#endif
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_put_iov_ack_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_put_iov_ack_target_msg_cb(int handler_id, void *am_hdr,
                                                   void **data,
                                                   size_t * p_data_sz,
                                                   int is_local,
                                                   int *is_contig,
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_acc_iov_ack_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_acc_iov_ack_target_msg_cb(int handler_id, void *am_hdr,
                                                   void **data,
                                                   size_t * p_data_sz,
                                                   int is_local,
                                                   int *is_contig,
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_acc_iov_ack_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_acc_iov_ack_target_msg_cb(int handler_id, void *am_hdr,
                                                       void **data,
                                                       size_t * p_data_sz,
                                                       int is_local,
                                                       int *is_contig,
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_put_data_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_put_data_target_msg_cb(int handler_id, void *am_hdr,
                                                void **data,
                                                size_t * p_data_sz,
                                                int is_local,
                                                int *is_contig,
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_acc_data_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_acc_data_target_msg_cb(int handler_id, void *am_hdr,
                                                void **data,
                                                size_t * p_data_sz,
                                                int is_local,
                                                int *is_contig,
                                                ...
                                                MPIR_Request ** req)
{
    ...
    *req = rreq;
    *target_cmpl_cb = MPIDIG_acc_target_cmpl_cb;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_acc_data_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_acc_data_target_msg_cb(int handler_id, void *am_hdr,
                                                    void **data,
                                                    size_t * p_data_sz,
                                                    int is_local,
                                                    int *is_contig,
                                                    ...
                                                    MPIR_Request ** req)
{
    ...
    *req = rreq;
    *target_cmpl_cb = MPIDIG_get_acc_target_cmpl_cb;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_cswap_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_cswap_target_msg_cb(int handler_id, void *am_hdr,
                                             void **data,
                                             size_t * p_data_sz,
                                             int is_local,
                                             int *is_contig,
                                             ...
                                             MPIR_Request ** req)
{
    ...
    *target_cmpl_cb = MPIDIG_cswap_target_cmpl_cb;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_acc_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_acc_target_msg_cb(int handler_id, void *am_hdr,
                                           void **data,
                                           size_t * p_data_sz,
                                           int is_local,
                                           int *is_contig,
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_acc_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_acc_target_msg_cb(int handler_id, void *am_hdr,
                                               void **data,
                                               size_t * p_data_sz,
                                               int is_local,
                                               int *is_contig,
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_acc_iov_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_acc_iov_target_msg_cb(int handler_id, void *am_hdr,
                                               void **data,
                                               size_t * p_data_sz,
                                               int is_local,
                                               int *is_contig,
                                               ...
                                               MPIR_Request ** req)
{
    ...
    *target_cmpl_cb = MPIDIG_acc_iov_target_cmpl_cb;
    MPIDIG_REQUEST(rreq, req->seq_no) = OPA_fetch_and_add_int(&MPIDI_CH4_Global.nxt_seq_no, 1);
#ifndef MPIDI_CH4_DIRECT_NETMOD
    MPIDI_REQUEST(rreq, is_local) = is_local;
#endif
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_acc_iov_target_msg_cb(int handler_id, void *am_hdr,
                                                   void **data,
                                                   size_t * p_data_sz,
                                                   int is_local,
                                                   int *is_contig,
                                                   ...
                                                   MPIR_Request ** req)
{
    ...
    *target_cmpl_cb = MPIDIG_get_acc_iov_target_cmpl_cb;
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_target_msg_cb(int handler_id, void *am_hdr,
                                           void **data,
                                           size_t * p_data_sz,
                                           int is_local,
                                           int *is_contig,
                                           ...
                                           MPIR_Request ** req)
{
    ...
    *req = rreq;
    *target_cmpl_cb = MPIDIG_get_target_cmpl_cb;
#ifndef MPIDI_CH4_DIRECT_NETMOD
    MPIDI_REQUEST(rreq, is_local) = is_local;
#endif
...
#undef FUNCNAME
#define FUNCNAME MPIDIG_get_ack_target_msg_cb
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline int MPIDIG_get_ack_target_msg_cb(int handler_id, void *am_hdr,
                                               void **data,
                                               size_t * p_data_sz,
                                               int is_local,
                                               int *is_contig,
