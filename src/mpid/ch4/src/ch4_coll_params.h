...
typedef union {
    ...
    struct {
        int allreduce;
    } ch4_allreduce_netmod;
} MPIDI_Allreduce_params_t;

typedef enum {
    MPIDI_Alltoall_intra_netmod_id,
    MPIDI_Alltoall_inter_fallback_id
} MPIDI_Alltoall_id_t;
...
typedef enum {
    ...
    MPIDI_Alltoallv_inter_fallback_id
...
typedef union {
    struct {
        int alltoallw;
    } ch4_alltoallw_netmod;
} MPIDI_Alltoallw_params_t;

typedef enum {
    MPIDI_Allgather_intra_netmod_id,
    MPIDI_Allgather_inter_fallback_id
} MPIDI_Allgather_id_t;

typedef union {
    struct {
        int allgather;
    } ch4_allgather_netmod;
} MPIDI_Allgather_params_t;

typedef enum {
    MPIDI_Allgatherv_intra_netmod_id,
    MPIDI_Allgatherv_inter_fallback_id
} MPIDI_allgatherv_id_t;

typedef union {
    struct {
        int allgatherv;
    } ch4_allgatherv_netmod;
} MPIDI_Allgatherv_params_t;

typedef enum {
    MPIDI_Gather_intra_netmod_id,
    MPIDI_Gather_inter_fallback_id
} MPIDI_Gather_id_t;
...
typedef enum {
    ...
    MPIDI_Scatter_inter_fallback_id
} MPIDI_Scatter_id_t;
...
typedef enum {
    MPIDI_Scatterv_intra_netmod_id,
    MPIDI_Scatterv_inter_fallback_id
} MPIDI_Scatterv_id_t;
...
typedef enum {
    ...
    MPIDI_Reduce_scatter_inter_fallback_id
...
typedef union {
    ...
    } ch4_reduce_scatter_block_netmod;
