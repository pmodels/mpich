                                         ...
                                         int root, MPIR_Comm * comm, MPIR_Request ** req)
{
    ...
    ch4_algo_parameters_container = MPIDI_Ibcast_select(buffer, count, datatype, root, comm);

    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Ibcast_intra_composition_alpha_id:  /* MPICH scheduler */
            mpi_errno =
                MPIDI_Ibcast_intra_composition_alpha(buffer, count, datatype, root, comm, req,
                                                     ch4_algo_parameters_container);
            break;
        case MPIDI_Ibcast_intra_composition_beta_id:   /* Gentran scheduler */
            mpi_errno =
                MPIDI_Ibcast_intra_composition_beta(buffer, count, datatype, root, comm, req,
                                                    ch4_algo_parameters_container);
            break;
        case MPIDI_Ibcast_inter_composition_alpha_id:  /* MPICH scheduler for intercomm */
            mpi_errno =
