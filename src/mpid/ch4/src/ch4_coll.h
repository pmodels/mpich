...
MPL_STATIC_INLINE_PREFIX int MPID_Barrier(MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        ...
        case MPIDI_Barrier_intra_netmod_id:
            ...
            break;
        case MPIDI_Barrier_inter_fallback_id:
            mpi_errno = MPIDI_Barrier_inter_fallback(comm, errflag, ch4_algo_parameters_container);
            break;
        default:
        ...
        case MPIDI_Bcast_intra_local_then_nodes_id:
            mpi_errno =
                MPIDI_Bcast_intra_local_then_nodes(buffer, count, datatype, root, comm,
                                                   errflag, ch4_algo_parameters_container);
            break;
        case MPIDI_Bcast_intra_netmod_id:
            mpi_errno =
                MPIDI_Bcast_intra_netmod(buffer, count, datatype, root, comm, errflag,
                                         ch4_algo_parameters_container);
            break;
        case MPIDI_Bcast_inter_fallback_id:
            mpi_errno =
                MPIDI_Bcast_inter_fallback(buffer, count, datatype, root, comm, errflag,
                                           ch4_algo_parameters_container);
            break;
        default:
                                            ...
                                            MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Allreduce_intra_local_node_bcast_id:
            mpi_errno =
                MPIDI_Allreduce_intra_local_node_bcast(sendbuf, recvbuf, count, datatype, op, comm,
                                                       errflag, ch4_algo_parameters_container);
            break;
        case MPIDI_Allreduce_intra_netmod_id:
            mpi_errno =
                                            ...
                                            MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Allgather_intra_netmod_id:
            mpi_errno =
                MPIDI_Allgather_intra_netmod(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                                             recvtype, comm, errflag,
                                             ch4_algo_parameters_container);
            break;
        case MPIDI_Allgather_inter_fallback_id:
            mpi_errno =
                MPIDI_Allgather_inter_fallback(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                                               recvtype, comm, errflag,
                                               ch4_algo_parameters_container);
            break;
        default:
                                          ...
                                          MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Scatter_intra_netmod_id:
            mpi_errno =
                MPIDI_Scatter_intra_netmod(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                                         ...
                                         int root, MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Gather_intra_netmod_id:
            mpi_errno =
                MPIDI_Gather_intra_netmod(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                                          recvtype, root, comm, errflag,
                                          ch4_algo_parameters_container);
            break;
                                          ...
                                          MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Gatherv_intra_netmod_id:
            mpi_errno =
                MPIDI_Gatherv_intra_netmod(sendbuf, sendcount, sendtype, recvbuf,
                                           recvcounts, displs, recvtype, root,
                                           comm, errflag, ch4_algo_parameters_container);
            break;
        case MPIDI_Gatherv_inter_fallback_id:
            mpi_errno =
                MPIDI_Gatherv_inter_fallback(sendbuf, sendcount, sendtype, recvbuf,
                                             recvcounts, displs, recvtype, root,
                                             comm, errflag, ch4_algo_parameters_container);
            break;
        default:
        ...
        case MPIDI_Alltoall_intra_netmod_id:
            mpi_errno =
                MPIDI_Alltoall_intra_netmod(sendbuf, sendcount, sendtype,
                                            ...
                                            comm, errflag, ch4_algo_parameters_container);
            break;
        case MPIDI_Alltoall_inter_fallback_id:
            mpi_errno =
                MPIDI_Alltoall_inter_fallback(sendbuf, sendcount, sendtype,
                                              recvbuf, recvcount, recvtype,
                                              comm, errflag, ch4_algo_parameters_container);
            break;
        default:
                                            ...
                                            MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Alltoallv_intra_netmod_id:
            mpi_errno =
                MPIDI_Alltoallv_intra_netmod(sendbuf, sendcounts, sdispls,
                                             sendtype, recvbuf, recvcounts,
                                             rdispls, recvtype, comm, errflag,
                                             ch4_algo_parameters_container);
            break;
        case MPIDI_Alltoallv_inter_fallback_id:
            mpi_errno =
                MPIDI_Alltoallv_inter_fallback(sendbuf, sendcounts, sdispls,
                                               sendtype, recvbuf, recvcounts,
                                               rdispls, recvtype, comm, errflag,
                                               ch4_algo_parameters_container);
            break;
                                            ...
                                            MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Alltoallw_intra_netmod_id:
            mpi_errno =
                MPIDI_Alltoallw_intra_netmod(sendbuf, sendcounts, sdispls,
                                             sendtypes, recvbuf, recvcounts,
                                             rdispls, recvtypes, comm, errflag,
                                             ch4_algo_parameters_container);
            break;
        case MPIDI_Alltoallw_inter_fallback_id:
            mpi_errno =
                MPIDI_Alltoallw_inter_fallback(sendbuf, sendcounts, sdispls,
                                               sendtypes, recvbuf, recvcounts,
                                               rdispls, recvtypes, comm, errflag,
                                               ch4_algo_parameters_container);
            break;
                                         ...
                                         int root, MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Reduce_intra_remote_then_root_id:
            mpi_errno =
                MPIDI_Reduce_intra_remote_then_root(sendbuf, recvbuf, count, datatype, op,
                                                    root, comm, errflag,
                                                    ch4_algo_parameters_container);
            break;
        case MPIDI_Reduce_intra_netmod_id:
            ...
            break;
        case MPIDI_Reduce_inter_fallback_id:
            mpi_errno =
                MPIDI_Reduce_inter_fallback(sendbuf, recvbuf, count, datatype, op,
                                            root, comm, errflag, ch4_algo_parameters_container);
            break;
        default:
        ...
        case MPIDI_Reduce_scatter_intra_netmod_id:
            mpi_errno =
                MPIDI_Reduce_scatter_intra_netmod(sendbuf, recvbuf, recvcounts,
                                                  ...
                                                  ch4_algo_parameters_container);
            break;
        case MPIDI_Reduce_scatter_inter_fallback_id:
            mpi_errno =
                MPIDI_Reduce_scatter_inter_fallback(sendbuf, recvbuf, recvcounts,
                                                    datatype, op, comm, errflag,
                                                    ch4_algo_parameters_container);
            break;
        default:
                                                       ...
                                                       MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Reduce_scatter_block_intra_netmod_id:
            mpi_errno =
                MPIDI_Reduce_scatter_block_intra_netmod(sendbuf, recvbuf, recvcount,
                                                        datatype, op, comm, errflag,
                                                        ch4_algo_parameters_container);
            break;
