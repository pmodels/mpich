...
MPL_STATIC_INLINE_PREFIX int MPID_Barrier(MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        ...
        case MPIDI_Barrier_intra_composition_gamma_id:
            mpi_errno =
                                        ...
                                        int root, MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        ...
        case MPIDI_Bcast_intra_composition_gamma_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Bcast_intra_composition_delta_id:
            mpi_errno =
                                            ...
                                            MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Allgather_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Allgather_intra_composition_beta_id:
            mpi_errno =
                                             ...
                                             MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Allgatherv_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Allgatherv_intra_composition_beta_id:
            mpi_errno =
                                          ...
                                          MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Scatter_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Scatter_intra_composition_beta_id:
            mpi_errno =
                                         ...
                                         int root, MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Gather_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Gather_intra_composition_beta_id:
            mpi_errno =
                                          ...
                                          MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Gatherv_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Gatherv_intra_composition_beta_id:
            mpi_errno =
                                            ...
                                            MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Alltoallv_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Alltoallv_intra_composition_beta_id:
            mpi_errno =
                                            ...
                                            MPIR_Comm * comm, MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Alltoallw_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Alltoallw_intra_composition_beta_id:
            mpi_errno =
                                                 ...
                                                 MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Reduce_scatter_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Reduce_scatter_intra_composition_beta_id:
            mpi_errno =
                                                       ...
                                                       MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Reduce_scatter_block_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Reduce_scatter_block_intra_composition_beta_id:
            mpi_errno =
                                       ...
                                       MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        ...
        case MPIDI_Scan_intra_composition_beta_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Scan_intra_composition_gamma_id:
            mpi_errno =
                                         ...
                                         MPIR_Errflag_t * errflag)
{
    ...
    switch (ch4_algo_parameters_container->id) {
        case MPIDI_Exscan_intra_composition_alpha_id:
            ...
            break;
#ifdef MPIDI_BUILD_CH4_SHM
        case MPIDI_Exscan_intra_composition_beta_id:
            mpi_errno =
