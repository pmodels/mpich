...
MPL_STATIC_INLINE_PREFIX int MPIDI_workq_dispatch(MPIDI_workq_elemt_t * workq_elemt)
{
    ...
    switch (workq_elemt->op) {
        ...
        case TARGET_LOCAL_CMPL_HOOK:
            ...
            break;
        case ACC:
            MPIDI_NM_mpi_accumulate(workq_elemt->rma.origin_addr, workq_elemt->rma.origin_count,
                                    workq_elemt->rma.origin_datatype, workq_elemt->rma.target_rank,
                                    workq_elemt->rma.target_disp, workq_elemt->rma.target_count,
            ...
            break;
        case GET_ACC:
            MPIDI_NM_mpi_get_accumulate(workq_elemt->rma.origin_addr, workq_elemt->rma.origin_count,
                                        workq_elemt->rma.origin_datatype,
                                        workq_elemt->rma.result_addr, workq_elemt->rma.result_count,
            ...
            break;
        case FOP:
            MPIDI_NM_mpi_fetch_and_op(workq_elemt->rma.origin_addr, workq_elemt->rma.result_addr,
                                      workq_elemt->rma.origin_datatype,
                                      workq_elemt->rma.target_rank, workq_elemt->rma.target_disp,
                                      workq_elemt->rma.acc_op, workq_elemt->rma.win_ptr,
                                      workq_elemt->rma.addr);
            OPA_decr_int(&MPIDI_CH4U_WIN(workq_elemt->rma.win_ptr, local_enq_cnts));
            MPIDI_workq_elemt_free(workq_elemt);
            break;
        case CAS:
            MPIDI_NM_mpi_compare_and_swap(workq_elemt->rma.origin_addr,
                                          workq_elemt->rma.compare_addr,
                                          workq_elemt->rma.result_addr,
                                          workq_elemt->rma.origin_datatype,
                                          workq_elemt->rma.target_rank,
                                          workq_elemt->rma.target_disp, workq_elemt->rma.win_ptr,
                                          workq_elemt->rma.addr);
            OPA_decr_int(&MPIDI_CH4U_WIN(workq_elemt->rma.win_ptr, local_enq_cnts));
            MPIDI_workq_elemt_free(workq_elemt);
            break;
