...
int map_size(MPIR_Comm_map_t map);
int detect_regular_model(int *lpid, int size, int *offset, int *blocksize, int *stride);
int src_comm_to_lut(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, int size,
                    int total_mapper_size, int mapper_offset);
int src_comm_to_mlut(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, int size,
                     int total_mapper_size, int mapper_offset);
int src_mlut_to_mlut(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, MPIR_Comm_map_t * mapper,
                     int total_mapper_size, int mapper_offset);
int src_map_to_lut(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, MPIR_Comm_map_t * mapper,
                   int total_mapper_size, int mapper_offset);
void direct_of_src_rmap(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, MPIR_Comm_map_t * mapper);
void offset_of_src_rmap(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest,
                        MPIR_Comm_map_t * mapper, int offset);
void stride_of_src_rmap(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest,
                        MPIR_Comm_map_t * mapper, int stride, int blocksize, int offset);
int check_convert_mlut_to_lut(MPIDI_rank_map_t * src);
int check_convert_lut_to_regular(MPIDI_rank_map_t * src);
int set_map(MPIDI_rank_map_t * src_rmap, MPIDI_rank_map_t * dest_rmap, MPIR_Comm_map_t * mapper,
            int src_comm_size, int total_mapper_size, int mapper_offset);
/* END   internal function decls */

#undef FUNCNAME
#define FUNCNAME map_size
#undef FCNAME
...
/*
 * This enum is used exclusively in this source file
 */
...
#undef FUNCNAME
#define FUNCNAME detect_regular_model
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int detect_regular_model(int *lpid, int size, int *offset, int *blocksize, int *stride)
{
...
#undef FUNCNAME
#define FUNCNAME src_comm_to_mlut
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int src_comm_to_mlut(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, int size,
                     int total_mapper_size, int mapper_offset)
...
#undef FUNCNAME
#define FUNCNAME src_mlut_to_mlut
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int src_mlut_to_mlut(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, MPIR_Comm_map_t * mapper,
                     int total_mapper_size, int mapper_offset)
...
#undef FUNCNAME
#define FUNCNAME src_map_to_lut
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int src_map_to_lut(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, MPIR_Comm_map_t * mapper,
                   int total_mapper_size, int mapper_offset)
...
#undef FUNCNAME
#define FUNCNAME direct_of_src_rmap
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
void direct_of_src_rmap(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest, MPIR_Comm_map_t * mapper)
{
...
#undef FUNCNAME
#define FUNCNAME offset_of_src_rmap
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
void offset_of_src_rmap(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest,
                        MPIR_Comm_map_t * mapper, int offset)
...
#undef FUNCNAME
#define FUNCNAME stride_of_src_rmap
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
void stride_of_src_rmap(MPIDI_rank_map_t * src, MPIDI_rank_map_t * dest,
                        MPIR_Comm_map_t * mapper, int stride, int blocksize, int offset)
...
#undef FUNCNAME
#define FUNCNAME check_convert_mlut_to_lut
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int check_convert_mlut_to_lut(MPIDI_rank_map_t * src)
{
...
#undef FUNCNAME
#define FUNCNAME check_convert_lut_to_regular
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int check_convert_lut_to_regular(MPIDI_rank_map_t * src)
{
    ...
    lut = src->irreg.lut.t;
    mode_detected = detect_regular_model(src->irreg.lut.lpid, src->size,
            ...
            int src_comm_size, int total_mapper_size, int mapper_offset)
{
    ...
    /* single src_comm, newcomm is smaller than src_comm, only one mapper */
        ...
        mode_detected = detect_regular_model(mapper->src_mapping, mapper->src_mapping_size,
                                             &offset, &blocksize, &stride);
        MPL_DBG_MSG_FMT(MPIDI_CH4_DBG_MAP, VERBOSE,
                        (MPL_DBG_FDEST, "\tdetected mode: %d", mode_detected));
