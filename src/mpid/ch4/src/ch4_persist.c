...
int MPID_Bcast_init(void *buffer, MPI_Aint count, MPI_Datatype datatype,
                    int root, MPIR_Comm * comm_ptr, int coll_group, MPIR_Info * info_ptr,
                    MPIR_Request ** request)
{
    ...
    mpi_errno =
        MPIR_Bcast_init_impl(buffer, count, datatype, root, comm_ptr, coll_group, info_ptr,
                             request);
...
int MPID_Allreduce_init(const void *sendbuf, void *recvbuf, MPI_Aint count,
                        ...
                        MPIR_Comm * comm_ptr, int coll_group, MPIR_Info * info_ptr,
                        MPIR_Request ** request)
{
    int mpi_errno = MPI_SUCCESS;
    ...
    mpi_errno =
        MPIR_Allreduce_init_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group,
                                 info_ptr, request);
                     ...
                     MPIR_Request ** request)
{
    ...
    mpi_errno =
        MPIR_Reduce_init_impl(sendbuf, recvbuf, count, datatype, op, root, comm_ptr, coll_group,
                              info_ptr, request);
                        ...
                        MPIR_Request ** request)
{
    ...
    mpi_errno = MPIR_Alltoallv_init_impl(sendbuf, sendcounts, sdispls, sendtype, recvbuf,
                                         recvcounts, rdispls, recvtype, comm_ptr, coll_group,
                                         info_ptr, request);
                        ...
                        MPIR_Request ** request)
{
    ...
    mpi_errno = MPIR_Alltoallw_init_impl(sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
                                         recvcounts, rdispls, recvtypes, comm_ptr, coll_group,
                                         info_ptr, request);
                         ...
                         MPIR_Request ** request)
{
    ...
    mpi_errno = MPIR_Allgatherv_init_impl(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
                                          displs, recvtype, comm_ptr, coll_group, info_ptr,
                                          request);
...
int MPID_Reduce_scatter_block_init(const void *sendbuf, void *recvbuf,
                                   MPI_Aint recvcount,
                                   MPI_Datatype datatype, MPI_Op op,
                                   MPIR_Comm * comm, int coll_group, MPIR_Info * info,
                                   MPIR_Request ** request)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_FUNC_ENTER;
    ...
    mpi_errno =
        MPIR_Reduce_scatter_block_init_impl(sendbuf, recvbuf, recvcount, datatype, op, comm,
                                            coll_group, info, request);
                             ...
                             MPIR_Request ** request)
{
    ...
    mpi_errno =
        MPIR_Reduce_scatter_init_impl(sendbuf, recvbuf, recvcounts, datatype, op, comm, coll_group,
                                      info, request);
                   ...
                   MPIR_Info * info, MPIR_Request ** request)
{
    ...
    mpi_errno =
        MPIR_Scan_init_impl(sendbuf, recvbuf, count, datatype, op, comm, coll_group, info, request);
...
int MPID_Gather_init(const void *sendbuf, MPI_Aint sendcount,
                     ...
                     MPIR_Comm * comm, int coll_group, MPIR_Info * info, MPIR_Request ** request)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_FUNC_ENTER;
                     ...
                     MPIR_Info * info, MPIR_Request ** request)
{
    ...
    mpi_errno =
        MPIR_Exscan_init_impl(sendbuf, recvbuf, count, datatype, op, comm, coll_group, info,
                              request);
