                               ...
                               MPIR_Request ** sreq_ptr)
{
    ...
    MPIDIU_RMA_OP_CHECK_SYNC(target_rank, win);
    ...
    am_hdr.win_id = MPIDIU_WIN(win, win_id);
    ...
    MPIDIU_win_cmpl_cnts_incr(win, target_rank, &sreq->completion_notification);
                                                 ...
                                                 MPIR_Request ** sreq_ptr)
{
    ...
    MPIDIU_win_remote_acc_cmpl_cnt_incr(win, target_rank);
