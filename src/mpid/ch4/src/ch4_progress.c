...
static inline int do_global_progress(void)
{
...
static inline void check_progress_made_idx(MPID_Progress_state * state, int idx)
{
...
static inline void check_progress_made_vci(MPID_Progress_state * state, int vci)
{
