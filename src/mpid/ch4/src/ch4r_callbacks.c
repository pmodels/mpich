...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_handle_unexp_cmpl(MPIR_Request * rreq)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_do_send_target(void **data,
                         size_t * p_data_sz,
                         int *is_contig,
    ...
    *is_contig = dt_contig;
    ...
    if (dt_contig) {
        ...
        *data = (char *) MPIDIG_REQUEST(rreq, buffer) + dt_true_lb;
        ...
        MPIR_Segment_init(MPIDIG_REQUEST(rreq, buffer),
                          MPIDIG_REQUEST(rreq, count), MPIDIG_REQUEST(rreq, datatype), segment_ptr);
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_send_target_msg_cb(int handler_id, void *am_hdr,
                             void **data,
                             size_t * p_data_sz,
                             int *is_contig,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_send_long_req_target_msg_cb(int handler_id, void *am_hdr,
                                      void **data,
                                      size_t * p_data_sz,
                                      int *is_contig,
                                      MPIDIG_am_target_cmpl_cb * target_cmpl_cb,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_send_long_lmt_target_msg_cb(int handler_id, void *am_hdr,
                                      void **data,
                                      size_t * p_data_sz,
                                      int *is_contig,
                                      MPIDIG_am_target_cmpl_cb * target_cmpl_cb,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_ssend_target_msg_cb(int handler_id, void *am_hdr,
                              void **data,
                              size_t * p_data_sz,
                              int *is_contig,
                              MPIDIG_am_target_cmpl_cb * target_cmpl_cb, MPIR_Request ** req)
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_ssend_ack_target_msg_cb(int handler_id, void *am_hdr,
                                  void **data,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_send_long_ack_target_msg_cb(int handler_id, void *am_hdr,
                                      void **data,
                                      size_t * p_data_sz, int *is_contig,
                                      MPIDIG_am_target_cmpl_cb * target_cmpl_cb,
                                      MPIR_Request ** req)
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIDI_comm_abort_target_msg_cb(int handler_id, void *am_hdr,
                                   void **data,
                                   size_t * p_data_sz,
                                   int *is_contig,
                                   MPIDIG_am_target_cmpl_cb * target_cmpl_cb, MPIR_Request ** req)
