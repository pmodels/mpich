    ...
    for (i = 0; i < count; i++) {
        ...
        switch (MPIDIG_REQUEST(preq, p_type)) {
            ...
            case MPIDI_PTYPE_RECV:
                mpi_errno = MPID_Irecv(MPIDIG_REQUEST(preq, buffer),
            ...
            case MPIDI_PTYPE_SEND:
                mpi_errno = MPID_Isend(MPIDIG_REQUEST(preq, buffer),
                                       MPIDIG_REQUEST(preq, count),
                                       MPIDIG_REQUEST(preq, datatype),
                                       MPIDIG_REQUEST(preq, rank),
                                       MPIDIG_REQUEST(preq, tag),
            ...
            case MPIDI_PTYPE_SSEND:
                mpi_errno = MPID_Issend(MPIDIG_REQUEST(preq, buffer),
                                        MPIDIG_REQUEST(preq, count),
                                        MPIDIG_REQUEST(preq, datatype),
                                        MPIDIG_REQUEST(preq, rank),
                                        MPIDIG_REQUEST(preq, tag),
            ...
            case MPIDI_PTYPE_BSEND:{
                    ...
                    mpi_errno = MPIR_Ibsend_impl(MPIDIG_REQUEST(preq, buffer),
                                                 MPIDIG_REQUEST(preq, count),
                                                 MPIDIG_REQUEST(preq, datatype),
                                                 MPIDIG_REQUEST(preq, rank),
                                                 MPIDIG_REQUEST(preq, tag),
        ...
        MPIR_Datatype_release_if_not_builtin(MPIDIG_REQUEST(preq, datatype));
    }
