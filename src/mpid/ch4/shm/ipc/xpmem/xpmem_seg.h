...
#define MPIDI_IPC_XPMEM_AVL_STACK_SIZE 64
#define MPIDI_IPC_XPMEM_AVL_DECLARE_STACK(stack, type, size) \
        const size_t stack##_size = size; \
        type stack[stack##_size]; \
        int stack##_sp = 0
#define MPIDI_IPC_XPMEM_AVL_STACK_PUSH(stack, value) do {           \
        MPIR_Assert(stack##_sp < MPIDI_IPC_XPMEM_AVL_STACK_SIZE);   \
        stack[stack##_sp++] = value;                            \
} while (0)
#define MPIDI_IPC_XPMEM_AVL_STACK_POP(stack, value) do {   \
        MPIR_Assert(stack##_sp > 0);                   \
        value = stack[--stack##_sp];                   \
} while (0)
#define MPIDI_IPC_XPMEM_AVL_STACK_EMPTY(stack) (!stack##_sp)

/* Creates a new segment and attaches into local virtual address space. */
MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_seg_do_create(MPIDI_IPC_xpmem_seg_t ** seg_ptr,
                                                           uint64_t low, uint64_t high,
                                                           xpmem_apid_t apid)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_IPC_xpmem_seg_t *seg = NULL;
    struct xpmem_addr xpmem_addr;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DO_CREATE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DO_CREATE);

    *seg_ptr = MPIR_Handle_obj_alloc(&MPIDI_IPC_xpmem_seg_mem);
    MPIR_ERR_CHKANDJUMP1(!(*seg_ptr), mpi_errno, MPI_ERR_OTHER, "**nomem",
                         "**nomem %s", "MPIDI_IPC_xpmem_seg_t");
    seg = *seg_ptr;
    seg->low = low;
    seg->high = high;
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DO_CREATE);
    return mpi_errno;
  fn_fail:
    if (seg)    /* in case xpmem_attach fails */
        MPIR_Handle_obj_free(&MPIDI_IPC_xpmem_seg_mem, seg);
    goto fn_exit;
}

/* Detaches and releases a segment. */
MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_seg_do_release(MPIDI_IPC_xpmem_seg_t * seg)
{
    int ret;
    int mpi_errno = MPI_SUCCESS;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DO_RELEASE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DO_RELEASE);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DO_RELEASE);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}

MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_avl_do_update_node_info(MPIDI_IPC_xpmem_seg_t * node)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_UPDATE_NODE_INFO);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_UPDATE_NODE_INFO);
    ...
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_UPDATE_NODE_INFO);
    return mpi_errno;
}

MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_avl_do_right_rotation(MPIDI_IPC_xpmem_seg_t * parent,
                                                                   MPIDI_IPC_xpmem_seg_t *
                                                                   left_child)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_RIGHT_ROTATION);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_RIGHT_ROTATION);
    ...
    mpi_errno = MPIDI_IPC_xpmem_avl_do_update_node_info(parent);
    MPIR_ERR_CHECK(mpi_errno);
    mpi_errno = MPIDI_IPC_xpmem_avl_do_update_node_info(left_child);
    MPIR_ERR_CHECK(mpi_errno);

  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_RIGHT_ROTATION);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}

MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_avl_do_left_rotation(MPIDI_IPC_xpmem_seg_t * parent,
                                                                  MPIDI_IPC_xpmem_seg_t *
                                                                  right_child)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_LEFT_ROTATION);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_LEFT_ROTATION);
    ...
    mpi_errno = MPIDI_IPC_xpmem_avl_do_update_node_info(parent);
    MPIR_ERR_CHECK(mpi_errno);
    mpi_errno = MPIDI_IPC_xpmem_avl_do_update_node_info(right_child);
    MPIR_ERR_CHECK(mpi_errno);

  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_LEFT_ROTATION);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}

MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_avl_do_left_right_rotation(MPIDI_IPC_xpmem_seg_t *
                                                                        parent,
                                                                        MPIDI_IPC_xpmem_seg_t *
                                                                        left_child)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_LEFT_RIGHT_ROTATION);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_LEFT_RIGHT_ROTATION);

    MPIDI_IPC_xpmem_seg_t *lr_child = left_child->right;
    /* Left rotate */
    mpi_errno = MPIDI_IPC_xpmem_avl_do_left_rotation(left_child, lr_child);
    MPIR_ERR_CHECK(mpi_errno);
    /* Right rotate */
    mpi_errno = MPIDI_IPC_xpmem_avl_do_right_rotation(parent, lr_child);
    MPIR_ERR_CHECK(mpi_errno);

  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_LEFT_RIGHT_ROTATION);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}

MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_avl_do_right_left_rotation(MPIDI_IPC_xpmem_seg_t *
                                                                        parent,
                                                                        MPIDI_IPC_xpmem_seg_t *
                                                                        right_child)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_RIGHT_LEFT_ROTATION);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_RIGHT_LEFT_ROTATION);

    MPIDI_IPC_xpmem_seg_t *rl_child = right_child->left;
    mpi_errno = MPIDI_IPC_xpmem_avl_do_right_rotation(right_child, rl_child);
    MPIR_ERR_CHECK(mpi_errno);
    mpi_errno = MPIDI_IPC_xpmem_avl_do_left_rotation(parent, rl_child);
    MPIR_ERR_CHECK(mpi_errno);

  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_AVL_DO_RIGHT_LEFT_ROTATION);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_segtree_do_create_node(uint64_t low,
                                                                    uint64_t high,
                                                                    xpmem_apid_t apid,
                                                                    MPIDI_IPC_xpmem_seg_t **
                                                                    seg_ptr)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_IPC_xpmem_seg_t *seg = NULL;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DO_CREATE_NODE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DO_CREATE_NODE);

    mpi_errno = MPIDI_IPC_xpmem_seg_do_create(seg_ptr, low, high, apid);
    MPIR_ERR_CHECK(mpi_errno);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DO_CREATE_NODE);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
...
MPIDI_IPC_xpmem_segtree_do_search_and_insert_safe(MPIDI_IPC_xpmem_segtree_t * tree, uint64_t low,
                                                  uint64_t high, xpmem_apid_t apid,
                                                  MPIDI_IPC_xpmem_seg_t ** seg_ptr, off_t * voffset)
{
    int direction;
    int mpi_errno = MPI_SUCCESS;
    MPIDI_IPC_xpmem_seg_t *sub_root = NULL;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DO_SEARCH_AND_INSERT_SAFE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DO_SEARCH_AND_INSERT_SAFE);

    MPID_THREAD_CS_ENTER(VCI, tree->lock);

    if (tree->root == NULL) {
        mpi_errno = MPIDI_IPC_xpmem_segtree_do_create_node(low, high, apid, seg_ptr);
        MPIR_ERR_CHECK(mpi_errno);
        ...
        *voffset = 0;
        ...
        MPIDI_IPC_XPMEM_AVL_DECLARE_STACK(node_stack, MPIDI_IPC_xpmem_seg_t *,
                                          MPIDI_IPC_XPMEM_AVL_STACK_SIZE);

        do {
            if (low < sub_root->low) {
                /* Insert into left branch */
                if (sub_root->left != NULL) {
                    MPIDI_IPC_XPMEM_AVL_STACK_PUSH(node_stack, sub_root);
          ...
          stack_recovery:
            mpi_errno = MPIDI_IPC_xpmem_avl_do_update_node_info(sub_root);
            MPIR_ERR_CHECK(mpi_errno);
            ...
            if (lheight - rheight > 1) {
                /* left unbalanced */
                MPIDI_IPC_xpmem_seg_t *ct_node = sub_root->left;
                int lct_height = ct_node->left == NULL ? 0 : ct_node->left->height;
                if (lct_height + 1 == lheight) {
                    /* Insert into left child of left child */
                    /* Do right rotation */
                    mpi_errno = MPIDI_IPC_xpmem_avl_do_right_rotation(sub_root, ct_node);
                    MPIR_ERR_CHECK(mpi_errno);
                } else {
                    /* Insert into right child of left child */
                    /* Do left-right rotation */
                    mpi_errno = MPIDI_IPC_xpmem_avl_do_left_right_rotation(sub_root, ct_node);
                    MPIR_ERR_CHECK(mpi_errno);
                }
            } else if (rheight - lheight > 1) {
                /* right unbalanced */
                MPIDI_IPC_xpmem_seg_t *ct_node = sub_root->right;
                int lct_height = ct_node->left == NULL ? 0 : ct_node->left->height;
                if (lct_height + 1 == rheight) {
                    /* Insert into left child of right child */
                    /* Do right-left rotation */
                    mpi_errno = MPIDI_IPC_xpmem_avl_do_right_left_rotation(sub_root, ct_node);
                    MPIR_ERR_CHECK(mpi_errno);
                } else {
                    /* Insert into right child of right child */
                    /* Do left rotation */
                    mpi_errno = MPIDI_IPC_xpmem_avl_do_left_rotation(sub_root, ct_node);
                    MPIR_ERR_CHECK(mpi_errno);
                }
            }

            if (!MPIDI_IPC_XPMEM_AVL_STACK_EMPTY(node_stack)) {
                MPIDI_IPC_XPMEM_AVL_STACK_POP(node_stack, sub_root);
                goto stack_recovery;
            } else
                break;
  ...
  fn_exit:
    ...
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DO_SEARCH_AND_INSERT_SAFE);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_segtree_init(MPIDI_IPC_xpmem_segtree_t * tree)
{
    int mpi_errno = MPI_SUCCESS, ret;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_INIT);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_INIT);

    tree->root = NULL;
    tree->tree_size = 0;
    MPID_Thread_mutex_create(&tree->lock, &ret);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_INIT);
    return mpi_errno;
}

/* Deletes all registered segments in the segment cache.
 * It detaches and frees each segment. */
MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_segtree_delete_all(MPIDI_IPC_xpmem_segtree_t * tree)
{
    uint8_t direction;
    int mpi_errno = MPI_SUCCESS, ret;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DELETE_ALL);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DELETE_ALL);

    MPIDI_IPC_XPMEM_AVL_DECLARE_STACK(node_stack, MPIDI_IPC_xpmem_seg_t *,
                                      MPIDI_IPC_XPMEM_AVL_STACK_SIZE);
    MPIDI_IPC_XPMEM_AVL_DECLARE_STACK(direction_stack, uint8_t, MPIDI_IPC_XPMEM_AVL_STACK_SIZE);

    if (tree->tree_size) {
        MPIDI_IPC_xpmem_seg_t *node = tree->root;
        while (1) {
            ...
            if (node->left != NULL) {
                MPIDI_IPC_XPMEM_AVL_STACK_PUSH(node_stack, node);
                /* AVL_LEFT stands for recovering from LEFT. */
                MPIDI_IPC_XPMEM_AVL_STACK_PUSH(direction_stack, AVL_LEFT);
                node = node->left;
                continue;
            }
          left_recovery:
            if (node->right != NULL) {
                ...
                MPIDI_IPC_XPMEM_AVL_STACK_PUSH(direction_stack, AVL_RIGHT);
                node = node->right;
                continue;
            }
          right_recovery:
            mpi_errno = MPIDI_IPC_xpmem_seg_do_release(node);
            MPIR_ERR_CHECK(mpi_errno);
            tree->tree_size--;
            if (!MPIDI_IPC_XPMEM_AVL_STACK_EMPTY(node_stack)) {
                MPIDI_IPC_XPMEM_AVL_STACK_POP(node_stack, node);
                MPIDI_IPC_XPMEM_AVL_STACK_POP(direction_stack, direction);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_SEGTREE_DELETE_ALL);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_seg_regist(int node_rank, size_t size,
                                                        void *remote_vaddr,
                                                        MPIDI_IPC_xpmem_seg_t ** seg_ptr,
                                                        void **vaddr,
                                                        MPIDI_IPC_xpmem_segtree_t * segcache)
{
    int mpi_errno = MPI_SUCCESS;
    MPIDI_IPC_xpmem_segmap_t *segmap = &MPIDI_IPC_xpmem_global.segmaps[node_rank];
    MPIDI_IPC_xpmem_seg_t *seg = NULL;
    off_t offset_diff = 0, voffset = 0;
    uint64_t seg_low, seg_size, seg_high;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_SEG_REGIST);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_SEG_REGIST);
    ...
    seg_low = MPL_ROUND_DOWN_ALIGN((uint64_t) remote_vaddr,
                                   (uint64_t) MPIDI_IPC_xpmem_global.sys_page_sz);
    offset_diff = (off_t) remote_vaddr - seg_low;
    seg_size = MPL_ROUND_UP_ALIGN(size + (size_t) offset_diff, MPIDI_IPC_xpmem_global.sys_page_sz);
    seg_high = seg_low + seg_size;
    mpi_errno =
        MPIDI_IPC_xpmem_segtree_do_search_and_insert_safe(segcache, seg_low, seg_high,
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_SEG_REGIST);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_IPC_xpmem_seg_deregist(MPIDI_IPC_xpmem_seg_t * seg)
{
    int mpi_errno = MPI_SUCCESS, c = 0;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DEREGIST);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DEREGIST);
    MPIR_Object_release_ref(seg, &c);
    XPMEM_TRACE("seg: deregister segment %p(refcount %d) vaddr=%p\n", seg,
                MPIR_Object_get_ref(seg), seg->vaddr);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_SEG_DEREGIST);
    return mpi_errno;
}
