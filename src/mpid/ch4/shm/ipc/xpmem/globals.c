...
MPIDI_IPC_xpmem_seg_t MPIDI_IPC_xpmem_seg_mem_direct[MPIDI_IPC_XPMEM_SEG_PREALLOC];

/* Preallocated counter objects */
MPIDI_IPC_xpmem_cnt_t MPIDI_IPC_xpmem_cnt_mem_direct[MPIDI_IPC_XPMEM_CNT_PREALLOC];
