...
{
    MPIDI_SHM_ctrl_reg_cb(MPIDI_SHM_IPC_SEND_CONTIG_LMT_RTS, &MPIDI_IPCI_send_contig_lmt_rts_cb);
    MPIDI_SHM_ctrl_reg_cb(MPIDI_SHM_IPC_SEND_CONTIG_LMT_FIN, &MPIDI_IPCI_send_contig_lmt_fin_cb);
}
