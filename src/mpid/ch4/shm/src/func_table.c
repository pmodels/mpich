...
MPIDI_SHM_funcs_t MPIDI_SHM_src_funcs = {
    ...
    .mpi_close_port = MPIDI_SHMI_mpi_close_port,
    .mpi_comm_accept = MPIDI_SHMI_mpi_comm_accept,
    ...
    .mpi_win_allocate_hook = MPIDI_SHMI_mpi_win_allocate_hook,
    .mpi_win_allocate_shared_hook = MPIDI_SHMI_mpi_win_allocate_shared_hook,
    .mpi_win_create_dynamic_hook = MPIDI_SHMI_mpi_win_create_dynamic_hook,
    .mpi_win_attach_hook = MPIDI_SHMI_mpi_win_attach_hook,
    .mpi_win_detach_hook = MPIDI_SHMI_mpi_win_detach_hook,
    .mpi_win_free_hook = MPIDI_SHMI_mpi_win_free_hook,
    ...
    /* Communicator */
    .mpi_comm_set_info_mutable = MPIDI_SHMI_mpi_comm_set_info_mutable,
    .mpi_comm_set_info_immutable = MPIDI_SHMI_mpi_comm_set_info_immutable,
    .mpi_comm_get_info = MPIDI_SHMI_mpi_comm_get_info,
};
...
MPIDI_SHM_native_funcs_t MPIDI_SHM_native_src_funcs = {
    ...
    .mpi_alloc_mem = MPIDI_SHMI_mpi_alloc_mem,
    .mpi_free_mem = MPIDI_SHMI_mpi_free_mem,
    .mpi_improbe = MPIDI_SHM_mpi_improbe,
    .mpi_iprobe = MPIDI_SHM_mpi_iprobe,
    .mpi_win_set_info = MPIDI_SHMI_mpi_win_set_info,
    ...
    .mpi_win_get_info = MPIDI_SHMI_mpi_win_get_info,
    .mpi_get = MPIDI_SHM_mpi_get,
    .mpi_win_free = MPIDI_SHM_mpi_win_free,
    .mpi_win_fence = MPIDI_SHM_mpi_win_fence,
    .mpi_win_create = MPIDI_SHMI_mpi_win_create,
    .mpi_accumulate = MPIDI_SHM_mpi_accumulate,
    .mpi_win_attach = MPIDI_SHMI_mpi_win_attach,
    .mpi_win_allocate_shared = MPIDI_SHMI_mpi_win_allocate_shared,
    .mpi_rput = MPIDI_SHM_mpi_rput,
    .mpi_win_flush_local = MPIDI_SHM_mpi_win_flush_local,
    .mpi_win_detach = MPIDI_SHMI_mpi_win_detach,
    ...
    .mpi_win_allocate = MPIDI_SHMI_mpi_win_allocate,
    ...
    .mpi_win_create_dynamic = MPIDI_SHMI_mpi_win_create_dynamic,
    ...
    /* Datatype hooks */
    .mpi_type_commit_hook = MPIDI_SHMI_mpi_type_commit_hook,
    .mpi_type_free_hook = MPIDI_SHMI_mpi_type_free_hook,
    /* Op hooks */
    .mpi_op_commit_hook = MPIDI_SHMI_mpi_op_commit_hook,
    .mpi_op_free_hook = MPIDI_SHMI_mpi_op_free_hook,
};
#endif
