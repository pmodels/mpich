...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_barrier(MPIR_Comm * comm, int coll_group,
                                                   MPIR_Errflag_t errflag)
{
    ...
    ret = MPIDI_POSIX_mpi_barrier(comm, coll_group, errflag);
                                                 ...
                                                 int coll_group, MPIR_Errflag_t errflag)
{
    ...
    ret = MPIDI_POSIX_mpi_bcast(buffer, count, datatype, root, comm, coll_group, errflag);
                                                     ...
                                                     MPIR_Errflag_t errflag)
{
    ...
    ret =
        MPIDI_POSIX_mpi_allreduce(sendbuf, recvbuf, count, datatype, op, comm, coll_group, errflag);
                                                     ...
                                                     int coll_group, MPIR_Errflag_t errflag)
{
    ...
    ret = MPIDI_POSIX_mpi_alltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf,
                                    recvcounts, rdispls, recvtype, comm, coll_group, errflag);
                                                     ...
                                                     MPIR_Errflag_t errflag)
{
    ...
    ret = MPIDI_POSIX_mpi_alltoallw(sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
                                    recvcounts, rdispls, recvtypes, comm, coll_group, errflag);
                                                  ...
                                                  MPIR_Errflag_t errflag)
{
    ...
    ret =
        MPIDI_POSIX_mpi_reduce(sendbuf, recvbuf, count, datatype, op, root, comm_ptr, coll_group,
                               errflag);
                                                ...
                                                MPIR_Errflag_t errflag)
{
    ...
    ret = MPIDI_POSIX_mpi_scan(sendbuf, recvbuf, count, datatype, op, comm, coll_group, errflag);
                                                  ...
                                                  MPIR_Errflag_t errflag)
{
    ...
    ret = MPIDI_POSIX_mpi_exscan(sendbuf, recvbuf, count, datatype, op, comm, coll_group, errflag);
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_ibarrier(MPIR_Comm * comm, int coll_group,
                                                    MPIR_Request ** req)
{
    int ret;
    ...
    ret = MPIDI_POSIX_mpi_ibarrier(comm, coll_group, req);
                                                  ...
                                                  int coll_group, MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_ibcast(buffer, count, datatype, root, comm, coll_group, req);
                                                       ...
                                                       int coll_group, MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_iallgatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
                                      displs, recvtype, comm, coll_group, req);
                                                      ...
                                                      MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_iallreduce(sendbuf, recvbuf, count, datatype, op, comm, coll_group, req);
                                                      ...
                                                      int coll_group, MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_ialltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf,
                                     recvcounts, rdispls, recvtype, comm, coll_group, req);
                                                      ...
                                                      MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_ialltoallw(sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
                                     recvcounts, rdispls, recvtypes, comm, coll_group, req);
                                                   ...
                                                   MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_iexscan(sendbuf, recvbuf, count, datatype, op, comm, coll_group, req);
                                                   ...
                                                   MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_igather(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                                  recvtype, root, comm, coll_group, req);
                                                    ...
                                                    MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_igatherv(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
                                   displs, recvtype, root, comm, coll_group, req);
                                                           ...
                                                           MPIR_Request ** req)
{
    ...
    ret =
        MPIDI_POSIX_mpi_ireduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op, comm,
                                        coll_group, req);
                                                   ...
                                                   MPIR_Request ** req)
{
    ...
    ret =
        MPIDI_POSIX_mpi_ireduce(sendbuf, recvbuf, count, datatype, op, root, comm_ptr, coll_group,
                                req);
                                                 ...
                                                 MPIR_Request ** req)
{
    ...
    ret = MPIDI_POSIX_mpi_iscan(sendbuf, recvbuf, count, datatype, op, comm, coll_group, req);
