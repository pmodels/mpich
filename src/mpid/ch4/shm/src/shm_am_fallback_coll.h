...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_barrier(MPIR_Comm * comm_ptr, int coll_group,
                                                   MPIR_Errflag_t errflag)
{
    return MPIR_Barrier_impl(comm_ptr, coll_group, errflag);
}
...
{
    return MPIR_Allreduce_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group,
                               errflag);
}
                                                  ...
                                                  MPIR_Errflag_t errflag)
{
    return MPIR_Gather_impl(sendbuf, sendcount, sendtype, recvbuf,
                            recvcount, recvtype, root, comm_ptr, coll_group, errflag);
}
                                                    ...
                                                    MPIR_Errflag_t errflag)
{
    return MPIR_Scatterv_impl(sendbuf, sendcounts, displs, sendtype,
                              recvbuf, recvcount, recvtype, root, comm_ptr, coll_group, errflag);
}
                                                     ...
                                                     int coll_group, MPIR_Errflag_t errflag)
{
    return MPIR_Alltoallv_impl(sendbuf, sendcounts, sdispls, sendtype,
                               recvbuf, recvcounts, rdispls, recvtype, comm_ptr, coll_group,
                               errflag);
}
                                                     ...
                                                     MPIR_Errflag_t errflag)
{
    return MPIR_Alltoallw_impl(sendbuf, sendcounts, sdispls, sendtypes,
                               recvbuf, recvcounts, rdispls, recvtypes, comm_ptr, coll_group,
                               errflag);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_reduce(const void *sendbuf, void *recvbuf,
                                                  ...
                                                  MPIR_Errflag_t errflag)
{
    return MPIR_Reduce_impl(sendbuf, recvbuf, count, datatype, op, root, comm_ptr, coll_group,
                            errflag);
}
                                                                ...
                                                                MPIR_Errflag_t errflag)
{
    return MPIR_Reduce_scatter_block_impl(sendbuf, recvbuf, recvcount,
                                          datatype, op, comm_ptr, coll_group, errflag);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_scan(const void *sendbuf, void *recvbuf, MPI_Aint count,
                                                ...
                                                MPIR_Errflag_t errflag)
{
    return MPIR_Scan_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group, errflag);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_exscan(const void *sendbuf, void *recvbuf,
                                                  ...
                                                  MPIR_Errflag_t errflag)
{
    return MPIR_Exscan_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group, errflag);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_ibarrier(MPIR_Comm * comm_ptr, int coll_group,
                                                    MPIR_Request ** req)
{
    return MPIR_Ibarrier_impl(comm_ptr, coll_group, req);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_ibcast(void *buffer, MPI_Aint count,
                                                  ...
                                                  MPIR_Request ** req)
{
    return MPIR_Ibcast_impl(buffer, count, datatype, root, comm_ptr, coll_group, req);
}
                                                      ...
                                                      MPIR_Request ** req)
{
    return MPIR_Iallgather_impl(sendbuf, sendcount, sendtype, recvbuf,
                                recvcount, recvtype, comm_ptr, coll_group, req);
}
                                                       ...
                                                       int coll_group, MPIR_Request ** req)
{
    return MPIR_Iallgatherv_impl(sendbuf, sendcount, sendtype, recvbuf,
                                 recvcounts, displs, recvtype, comm_ptr, coll_group, req);
}
...
{
    return MPIR_Iallreduce_impl(sendbuf, recvbuf, count, datatype, op, comm, coll_group, request);
}
                                                      ...
                                                      int coll_group, MPIR_Request ** req)
{
    return MPIR_Ialltoallv_impl(sendbuf, sendcounts, sdispls, sendtype,
                                recvbuf, recvcounts, rdispls, recvtype, comm_ptr, coll_group, req);
}
                                                      ...
                                                      MPIR_Request ** req)
{
    return MPIR_Ialltoallw_impl(sendbuf, sendcounts, sdispls, sendtypes,
                                recvbuf, recvcounts, rdispls, recvtypes, comm_ptr, coll_group, req);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_iexscan(const void *sendbuf, void *recvbuf,
                                                   ...
                                                   MPIR_Request ** req)
{
    return MPIR_Iexscan_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group, req);
}
                                                   ...
                                                   MPIR_Request ** req)
{
    return MPIR_Igather_impl(sendbuf, sendcount, sendtype, recvbuf,
                             recvcount, recvtype, root, comm_ptr, coll_group, req);
}
                                                    ...
                                                    MPIR_Request ** req)
{
    return MPIR_Igatherv_impl(sendbuf, sendcount, sendtype, recvbuf,
                              recvcounts, displs, recvtype, root, comm_ptr, coll_group, req);
}
                                                                 ...
                                                                 MPIR_Request ** req)
{
    return MPIR_Ireduce_scatter_block_impl(sendbuf, recvbuf, recvcount,
                                           datatype, op, comm_ptr, coll_group, req);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_ireduce_scatter(const void *sendbuf, void *recvbuf,
                                                           ...
                                                           MPIR_Request ** req)
{
    return MPIR_Ireduce_scatter_impl(sendbuf, recvbuf, recvcounts, datatype, op, comm_ptr,
                                     coll_group, req);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_ireduce(const void *sendbuf, void *recvbuf,
                                                   ...
                                                   MPIR_Request ** req)
{
    return MPIR_Ireduce_impl(sendbuf, recvbuf, count, datatype, op, root, comm_ptr, coll_group,
                             req);
}
...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_iscan(const void *sendbuf, void *recvbuf, MPI_Aint count,
                                                 ...
                                                 MPIR_Request ** req)
{
    return MPIR_Iscan_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, coll_group, req);
}
...
#endif /* SHM_AM_FALLBACK_COLL_H_INCLUDED */
