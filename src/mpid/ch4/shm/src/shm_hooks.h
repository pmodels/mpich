...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_comm_collective_selection_init(MPIR_Comm * comm)
{
    int ret = MPI_SUCCESS;

    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_POSIX_COMM_COLLECTIVE_SELECTION_INIT);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_POSIX_COMM_COLLECTIVE_SELECTION_INIT);

    ret = MPIDI_POSIX_mpi_comm_collective_selection_init(comm);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_POSIX_COMM_COLLECTIVE_SELECTION_INIT);
    return ret;
}

MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_mpi_comm_collective_selection_finalize(MPIR_Comm * comm)
{
    int ret = MPI_SUCCESS;

    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_POSIX_COMM_COLLECTIVE_SELECTION_FINALIZE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_POSIX_COMM_COLLECTIVE_SELECTION_FINALIZE);

    ret = MPIDI_POSIX_mpi_comm_collective_selection_finalize(comm);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_POSIX_COMM_COLLECTIVE_SELECTION_FINALIZE);
    return ret;
}
