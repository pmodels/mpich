...
int MPIDI_POSIX_mpi_comm_set_info_mutable(MPIR_Comm * comm, MPIR_Info * info)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_POSIX_MPI_COMM_SET_INFO_MUTABLE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_POSIX_MPI_COMM_SET_INFO_MUTABLE);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_POSIX_MPI_COMM_SET_INFO_MUTABLE);
...
int MPIDI_POSIX_mpi_comm_set_info_immutable(MPIR_Comm * comm, MPIR_Info * info)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_POSIX_MPI_COMM_SET_INFO_IMMUTABLE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_POSIX_MPI_COMM_SET_INFO);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_POSIX_MPI_COMM_SET_INFO_IMMUTABLE);
...
int MPIDI_POSIX_mpi_comm_get_info(MPIR_Comm * comm, MPIR_Info ** info_p_p)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_POSIX_MPI_COMM_GET_INFO);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_POSIX_MPI_COMM_GET_INFO);

    /* TODO: Read SHM specific hints here */

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_POSIX_MPI_COMM_GET_INFO);
