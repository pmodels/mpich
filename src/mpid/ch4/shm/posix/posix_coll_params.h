...
typedef enum {
    MPIDI_POSIX_bcast_shumilin_id,
    MPIDI_POSIX_bcast_knomial_id,
    MPIDI_POSIX_bcast_empty_id
...
typedef union {
    ...
    struct MPIDI_POSIX_bcast_shumilin_parameters {
        int segment_size;
...
typedef enum {
    MPIDI_POSIX_allreduce_empty_id
