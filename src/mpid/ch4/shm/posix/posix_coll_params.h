...
typedef enum {
    ...
    MPIDI_POSIX_Ibcast_intra_nbc_smp_id,
    MPIDI_POSIX_Ibcast_intra_tree_id,
    MPIDI_POSIX_Ibcast_intra_ring_id,
    MPIDI_POSIX_Ibcast_intra_scatter_recexch_allgather_id,
