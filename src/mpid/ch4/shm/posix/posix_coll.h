                                            ...
                                            ch4_algo_parameters_ptr_in)
{
    ...
    mpi_errno =
        MPIDI_POSIX_Allgather_call(sendbuf, sendcount, sendtype,
                                   recvbuf, recvcount, recvtype,
                                             ...
                                             ch4_algo_parameters_ptr_in)
{
    ...
    mpi_errno =
        MPIDI_POSIX_Allgatherv_call(sendbuf, sendcount, sendtype,
                                    recvbuf, recvcounts, displs,
                                    recvtype, comm_ptr, errflag,
                                    shm_algo_parameters_container_out);
    if (mpi_errno)
                                           ...
                                           ch4_algo_parameters_ptr_in)
{
    ...
    mpi_errno =
        MPIDI_POSIX_Alltoall_call(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                                  recvtype, comm_ptr, errflag, shm_algo_parameters_container_out);
    if (mpi_errno)
        MPIR_ERR_POP(mpi_errno);
                                            ...
                                            ch4_algo_parameters_ptr_in)
{
    ...
    mpi_errno =
        MPIDI_POSIX_Alltoallv_call(sendbuf, sendcounts, sdispls,
                                   sendtype, recvbuf, recvcounts,
                                   rdispls, recvtype, comm_ptr,
                                            ...
                                            ch4_algo_parameters_ptr_in)
{
    ...
    mpi_errno =
        MPIDI_POSIX_Alltoallw_call(sendbuf, sendcounts, sdispls,
                                   sendtypes, recvbuf, recvcounts,
                                   rdispls, recvtypes, comm_ptr,
                                   errflag, shm_algo_parameters_container_out);
    if (mpi_errno)
