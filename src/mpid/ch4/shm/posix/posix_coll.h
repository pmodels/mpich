                                          ...
                                          ch4_algo_parameters_container_in)
{
    ...
    mpi_errno = MPIDI_POSIX_Barrier_call(comm, errflag, shm_algo_parameters_container_out);
    if (mpi_errno)
                                        ...
                                        ch4_algo_parameters_container_in)
{
    ...
    mpi_errno =
        MPIDI_POSIX_Bcast_call(buffer, count, datatype, root, comm, errflag,
                               shm_algo_parameters_container_out);
    if (mpi_errno)
        MPIR_ERR_POP(mpi_errno);
                                         ...
                                         ch4_algo_parameters_container_in)
{
    ...
    mpi_errno =
        MPIDI_POSIX_Reduce_call(sendbuf, recvbuf, count, datatype, op, root, comm, errflag,
                                shm_algo_parameters_container_out);
    if (mpi_errno)
        MPIR_ERR_POP(mpi_errno);
