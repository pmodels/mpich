                                          ...
                                          ch4_algo_parameters_container_in)
{
    ...
    mpi_errno = MPIDI_POSIX_Barrier_call(comm_ptr, errflag, shm_algo_parameters_container_out);
    if (mpi_errno)
                                             ...
                                             MPIR_Comm * comm_ptr, MPIR_Request ** req)
{
    ...
    mpi_errno = MPIR_Ialltoallv(sendbuf, sendcounts, sdispls,
                                sendtype, recvbuf, recvcounts, rdispls, recvtype, comm_ptr, req);
                                             ...
                                             MPIR_Comm * comm_ptr, MPIR_Request ** req)
{
    ...
    mpi_errno = MPIR_Ialltoallw(sendbuf, sendcounts, sdispls,
                                sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm_ptr, req);
                                                  ...
                                                  MPIR_Request ** req)
{
    ...
    mpi_errno = MPIR_Ireduce_scatter(sendbuf, recvbuf, recvcounts, datatype, op, comm_ptr, req);
