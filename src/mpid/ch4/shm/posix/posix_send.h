...
static inline int MPIDI_POSIX_mpi_rsend(const void *buf,
                                        int count,
                                        MPI_Datatype datatype,
                                        int rank,
                                        int tag,
                                        ...
                                        MPIR_Request ** request)
{
    return MPIDIG_mpi_rsend(buf, count, datatype, rank, tag, comm, context_offset, addr, request);
}



static inline int MPIDI_POSIX_mpi_irsend(const void *buf,
                                         int count,
                                         MPI_Datatype datatype,
                                         int rank,
                                         int tag,
                                         ...
                                         MPIR_Request ** request)
{
    return MPIDIG_mpi_irsend(buf, count, datatype, rank, tag, comm, context_offset, addr, request);
}
