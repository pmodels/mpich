...
const MPIDI_POSIX_coll_algo_container_t POSIX_Gatherv_allcomm_linear_cnt = {
...
const MPIDI_POSIX_coll_algo_container_t POSIX_Scatterv_allcomm_linear_cnt = {
    .id = MPIDI_POSIX_Scatterv_allcomm_linear_id
};

/* Reduce_scatter default POSIX containers initialization*/
const MPIDI_POSIX_coll_algo_container_t POSIX_Reduce_scatter_intra_noncommutative_cnt = {
...
const MPIDI_POSIX_coll_algo_container_t POSIX_Reduce_scatter_block_intra_noncommutative_cnt = {
...
const MPIDI_POSIX_coll_algo_container_t POSIX_Scan_intra_recursive_doubling_cnt = {
