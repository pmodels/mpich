...
typedef struct {
    enum {
        ...
        MPIDI_POSIX_CSEL_CONTAINER_TYPE__ALGORITHM__MPIDI_POSIX_ireduce_release_gather,
        MPIDI_POSIX_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Ireduce_sched_intra_gentran_auto,
