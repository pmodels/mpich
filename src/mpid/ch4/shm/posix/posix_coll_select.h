...
MPL_STATIC_INLINE_PREFIX
int MPIDI_POSIX_Bcast_scatter_ring_allgather(void *buffer, int count,
                                             MPI_Datatype datatype,
                                             int root,
                                             MPIR_Comm * comm_ptr,
                                             MPIR_Errflag_t * errflag,
...
MPL_STATIC_INLINE_PREFIX
int MPIDI_POSIX_allreduce_recursive_doubling(const void *sendbuf,
...
MPL_STATIC_INLINE_PREFIX
int MPIDI_POSIX_allreduce_reduce_scatter_allgather(const void *sendbuf,
                                                   void *recvbuf,
                                                   int count,
                                                   MPI_Datatype datatype,
                                                   MPI_Op op,
...
MPL_STATIC_INLINE_PREFIX
int MPIDI_POSIX_reduce_redscat_gather(const void *sendbuf, void *recvbuf,
...
MPL_STATIC_INLINE_PREFIX
int MPIDI_POSIX_reduce_binomial(const void *sendbuf, void *recvbuf,
                                int count, MPI_Datatype datatype,
