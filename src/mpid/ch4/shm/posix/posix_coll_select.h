...
MPL_STATIC_INLINE_PREFIX int MPIDI_POSIX_Bcast_knomial(void *buffer,
                                                       int count,
...
MPL_STATIC_INLINE_PREFIX int MPIDI_POSIX_Allreduce_1(const void *sendbuf, void *recvbuf, int count,
                                                     MPI_Datatype datatype, MPI_Op op,
                                                     MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag,
                                                     MPIDI_POSIX_coll_algo_container_t *
                                                     params_container) MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX int MPIDI_POSIX_Reduce_1(const void *sendbuf, void *recvbuf, int count,
...
MPL_STATIC_INLINE_PREFIX void MPIDI_SHM_collective_selection_init(MPIR_Comm * comm)
{
    int coll_id;
    ...
    for (coll_id = 0; coll_id < MPIDI_NUM_COLLECTIVES; coll_id++) {
        tuner_table_ptr[coll_id].table_size = MPIDI_coll_table_size[SHM][coll_id];

        if (tuner_table_ptr[coll_id].table_size) {
            tuner_table_ptr[coll_id].table = MPIDI_coll_tuning_table[SHM][coll_id];
        }
...
MPL_STATIC_INLINE_PREFIX void MPIDI_SHM_collective_selection_free(MPIR_Comm * comm)
{
                                                                                     ...
                                                                                     ch4_algo_parameters_container_in)
{
    ...
    if (ch4_algo_parameters_container_in->id != MPIDI_CH4_COLL_AUTO_SELECT) {
        ...
        MPIDI_coll_tuner_table_t *tuning_table_ptr =
            &MPIDI_POSIX_COMM(comm_ptr).colltuner_table[MPIDI_BCAST];
        MPIDI_coll_tuning_table_entry_t *entry = tuning_table_ptr->table;

        while (nbytes > entry[i].msg_size && entry[i].msg_size != -1 &&
               i < tuning_table_ptr->table_size) {
            i++;
        }

        return (MPIDI_POSIX_coll_algo_container_t *)entry[i].algo_container;
    }
}
                                                    ...
                                                    ch4_algo_parameters_container)
{
    ...
    case MPIDI_POSIX_bcast_knomial_id:
        mpi_errno =
            MPIDI_POSIX_Bcast_knomial(buffer, count, datatype, root, comm, errflag,
                                      ch4_algo_parameters_container);
        break;
    default:
                                                                                         ...
                                                                                         ch4_algo_parameters_ptr_in)
{
    ...
    if (ch4_algo_parameters_ptr_in->id != MPIDI_CH4_COLL_AUTO_SELECT) {
        return ch4_algo_parameters_ptr_in;
    }
    else {
        MPID_Datatype_get_size_macro(datatype, type_size);
        nbytes = type_size * count;
        ...
        MPIDI_coll_tuner_table_t *tuning_table_ptr =
            &MPIDI_POSIX_COMM(comm_ptr).colltuner_table[MPIDI_ALLREDUCE];
        MPIDI_coll_tuning_table_entry_t *entry = tuning_table_ptr->table;
                                                        ...
                                                        ch4_algo_parameters_container)
{
    ...
    switch (ch4_algo_parameters_container->id) {
    case MPIDI_POSIX_allreduce_empty_id:
        mpi_errno =
            MPIDI_POSIX_Allreduce_1(sendbuf, recvbuf, count, datatype, op, comm_ptr, errflag,
                                    ch4_algo_parameters_container);
        break;
    default:
                                                                                      ...
                                                                                      ch4_algo_parameters_container_in)
{
    ...
    if (ch4_algo_parameters_container_in->id != MPIDI_CH4_COLL_AUTO_SELECT) {
        ...
        MPIDI_coll_tuner_table_t *tuning_table_ptr =
            &MPIDI_POSIX_COMM(comm_ptr).colltuner_table[MPIDI_REDUCE];
        MPIDI_coll_tuning_table_entry_t *entry = tuning_table_ptr->table;
                                                     ...
                                                     ch4_algo_parameters_container)
{
    ...
    switch (ch4_algo_parameters_container->id) {
    case MPIDI_POSIX_reduce_empty_id:
        mpi_errno =
            MPIDI_POSIX_Reduce_1(sendbuf, recvbuf, count, datatype, op, root, comm_ptr, errflag,
                                 ch4_algo_parameters_container);
        break;
    default:
