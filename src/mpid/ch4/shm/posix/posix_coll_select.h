...
MPL_STATIC_INLINE_PREFIX
    MPIDI_POSIX_coll_algo_container_t * MPIDI_POSIX_Gatherv_select(const void *sendbuf,
                                                                   ...
                                                                   *
                                                                   ...
                                                                   ATTRIBUTE((unused)))
{
    return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_Gatherv_allcomm_linear_cnt;
}
...
MPL_STATIC_INLINE_PREFIX
    MPIDI_POSIX_coll_algo_container_t * MPIDI_POSIX_Scatterv_select(const void *sendbuf,
                                                                    ...
                                                                    *
                                                                    ...
                                                                    ATTRIBUTE((unused)))
{
    return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_Scatterv_allcomm_linear_cnt;
}
                                                                    ...
                                                                    ATTRIBUTE((unused)))
{
    ...
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_POSIX_coll_algo_container_t *) &
            POSIX_Alltoall_intra_pairwise_sendrecv_replace_cnt;
                                                                     ...
                                                                     ATTRIBUTE((unused)))
{
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_POSIX_coll_algo_container_t *) &
            POSIX_Alltoallv_intra_pairwise_sendrecv_replace_cnt;
    } else {
                                                                     ...
                                                                     ATTRIBUTE((unused)))
{
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_POSIX_coll_algo_container_t *) &
            POSIX_Alltoallw_intra_pairwise_sendrecv_replace_cnt;
    } else {
                                                                      ...
                                                                      ATTRIBUTE((unused)))
{
    ...
    if ((nbytes < MPIR_CVAR_ALLGATHER_LONG_MSG_SIZE) && !(comm_size & (comm_size - 1))) {
        return (MPIDI_POSIX_coll_algo_container_t *) &
            POSIX_Allgatherv_intra_recursive_doubling_cnt;
    } else if (nbytes < MPIR_CVAR_ALLGATHER_SHORT_MSG_SIZE) {
                                                                          ...
                                                                          ATTRIBUTE((unused)))
{
    ...
    if (!is_commutative) {
        ...
        if (pof2 == comm_size && is_block_regular) {
            ...
            return (MPIDI_POSIX_coll_algo_container_t *) &
                POSIX_Reduce_scatter_intra_noncommutative_cnt;
        } else {
                                                                                ...
                                                                                ATTRIBUTE((unused)))
{
    ...
    if (!is_commutative) {
        ...
        if (!(comm_size & (comm_size - 1))) {
            ...
            return (MPIDI_POSIX_coll_algo_container_t *) &
                POSIX_Reduce_scatter_block_intra_noncommutative_cnt;
        } else {
...
MPL_STATIC_INLINE_PREFIX
    MPIDI_POSIX_coll_algo_container_t * MPIDI_POSIX_Scan_select(const void *sendbuf,
                                                                ...
                                                                ATTRIBUTE((unused)))
{
    return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_Scan_intra_recursive_doubling_cnt;
}
