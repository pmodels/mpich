                                                                    ...
                                                                    ATTRIBUTE((unused)))
{
    ...
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_alltoall_sendrecv_replace_cnt;
    }
    else if ((nbytes <= MPIR_CVAR_ALLTOALL_SHORT_MSG_SIZE) && (comm_ptr->local_size >= 8)) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_alltoall_bruck_cnt;
    }
    else if (nbytes <= MPIR_CVAR_ALLTOALL_MEDIUM_MSG_SIZE) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_alltoall_isend_irecv_cnt;
    }
    else {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_alltoall_pairwise_exchange_cnt;
    }
}

MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoall_call(const void *sendbuf, int sendcount,
                                  ...
                                  MPIDI_POSIX_coll_algo_container_t * ch4_algo_parameters_container)
{
    ...
    switch (ch4_algo_parameters_container->id) {
    case MPIDI_POSIX_alltoall_bruck_id:
        mpi_errno =
            MPIDI_POSIX_alltoall_bruck(sendbuf, sendcount, sendtype,
                                       recvbuf, recvcount, recvtype,
                                       comm_ptr, errflag, ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_alltoall_isend_irecv_id:
        mpi_errno =
            MPIDI_POSIX_alltoall_isend_irecv(sendbuf, sendcount, sendtype,
                                             recvbuf, recvcount, recvtype,
                                             comm_ptr, errflag, ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_alltoall_pairwise_exchange_id:
        mpi_errno =
            MPIDI_POSIX_alltoall_pairwise_exchange(sendbuf, sendcount, sendtype,
                                                   recvbuf, recvcount, recvtype,
                                                   comm_ptr, errflag,
                                                   ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_alltoall_sendrecv_replace_id:
        mpi_errno =
            MPIDI_POSIX_alltoall_sendrecv_replace(sendbuf, sendcount, sendtype,
                                                  recvbuf, recvcount, recvtype,
                                                  comm_ptr, errflag, ch4_algo_parameters_container);
        break;
    default:
...
{
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_alltoallv_sendrecv_replace_cnt;
    }
    else {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_alltoallv_isend_irecv_cnt;
    }
}

MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoallv_call(const void *sendbuf, const int *sendcounts, const int *sdispls,
                                   ...
                                   ch4_algo_parameters_container)
{
    ...
    switch (ch4_algo_parameters_container->id) {
    case MPIDI_POSIX_alltoallv_sendrecv_replace_id:
        mpi_errno =
            MPIDI_POSIX_alltoallv_sendrecv_replace(sendbuf, sendcounts, sdispls,
                                                   sendtype, recvbuf, recvcounts,
                                                   rdispls, recvtype, comm_ptr,
                                                   errflag, ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_alltoallv_isend_irecv_id:
        mpi_errno =
            MPIDI_POSIX_alltoallv_isend_irecv(sendbuf, sendcounts, sdispls,
                                              sendtype, recvbuf, recvcounts,
                                              rdispls, recvtype, comm_ptr,
                                              errflag, ch4_algo_parameters_container);
        break;
...
{
    if (sendbuf == MPI_IN_PLACE) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_alltoallw_sendrecv_replace_cnt;
    }
    else {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_alltoallw_isend_irecv_cnt;
    }
}

MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoallw_call(const void *sendbuf, const int sendcounts[], const int sdispls[],
                                   ...
                                   ch4_algo_parameters_container)
{
    ...
    switch (ch4_algo_parameters_container->id) {
    case MPIDI_POSIX_alltoallw_sendrecv_replace_id:
        mpi_errno =
            MPIDI_POSIX_alltoallw_sendrecv_replace(sendbuf, sendcounts, sdispls,
                                                   sendtypes, recvbuf, recvcounts,
                                                   rdispls, recvtypes, comm_ptr,
                                                   errflag, ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_alltoallw_isend_irecv_id:
        mpi_errno =
            MPIDI_POSIX_alltoallw_isend_irecv(sendbuf, sendcounts, sdispls,
                                              sendtypes, recvbuf, recvcounts,
                                              rdispls, recvtypes, comm_ptr,
                                              errflag, ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_alltoallw_pairwise_exchange_id:
        mpi_errno =
            MPIDI_POSIX_alltoallw_pairwise_exchange(sendbuf, sendcounts, sdispls,
                                                    sendtypes, recvbuf, recvcounts,
                                                    rdispls, recvtypes, comm_ptr,
                                                    errflag, ch4_algo_parameters_container);
        break;
                                                                     ...
                                                                     ch4_algo_parameters_container_in)
{
    ...
    if ((nbytes < MPIR_CVAR_ALLGATHER_LONG_MSG_SIZE) && !(comm_size & (comm_size - 1))) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_allgather_recursive_doubling_cnt;
    }
    else if (nbytes < MPIR_CVAR_ALLGATHER_SHORT_MSG_SIZE) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_allgather_bruck_cnt;
    }
    else {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_allgather_ring_cnt;
    }
}

MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allgather_call(const void *sendbuf, int sendcount,
                                   ...
                                   ch4_algo_parameters_container)
{
    ...
    switch (ch4_algo_parameters_container->id) {
    case MPIDI_POSIX_allgather_recursive_doubling_id:
        mpi_errno =
            MPIDI_POSIX_allgather_recursive_doubling(sendbuf, sendcount, sendtype,
                                                     recvbuf, recvcount, recvtype,
                                                     comm_ptr, errflag,
                                                     ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_allgather_bruck_id:
        mpi_errno =
            MPIDI_POSIX_allgather_bruck(sendbuf, sendcount, sendtype,
                                        recvbuf, recvcount, recvtype,
                                        comm_ptr, errflag, ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_allgather_ring_id:
        mpi_errno =
            MPIDI_POSIX_allgather_ring(sendbuf, sendcount, sendtype,
                                       recvbuf, recvcount, recvtype,
                                       comm_ptr, errflag, ch4_algo_parameters_container);
        break;
    default:
                                                                      ...
                                                                      ch4_algo_parameters_container_in)
{
    ...
    if ((nbytes < MPIR_CVAR_ALLGATHER_LONG_MSG_SIZE) && !(comm_size & (comm_size - 1))) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_allgatherv_recursive_doubling_cnt;
    }
    else if (nbytes < MPIR_CVAR_ALLGATHER_SHORT_MSG_SIZE) {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_allgatherv_bruck_cnt;
    }
    else {
        return (MPIDI_POSIX_coll_algo_container_t *) & POSIX_allgatherv_ring_cnt;
    }
}

MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allgatherv_call(const void *sendbuf, int sendcount,
                                    MPI_Datatype sendtype, void *recvbuf,
                                    ...
                                    ch4_algo_parameters_container)
{
    ...
    case MPIDI_POSIX_allgather_recursive_doubling_id:
        mpi_errno =
            MPIDI_POSIX_allgatherv_recursive_doubling(sendbuf, sendcount, sendtype,
    ...
    case MPIDI_POSIX_allgather_bruck_id:
        mpi_errno =
            MPIDI_POSIX_allgatherv_bruck(sendbuf, sendcount, sendtype,
                                         recvbuf, recvcounts, displs,
                                         recvtype, comm_ptr, errflag,
                                         ch4_algo_parameters_container);
        break;
    case MPIDI_POSIX_allgather_ring_id:
        mpi_errno =
            MPIDI_POSIX_allgatherv_ring(sendbuf, sendcount, sendtype,
                                        recvbuf, recvcounts, displs,
                                        recvtype, comm_ptr, errflag, ch4_algo_parameters_container);
        break;
    default:
