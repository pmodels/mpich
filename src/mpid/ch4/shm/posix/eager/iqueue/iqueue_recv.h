...
static void MPIDI_POSIX_EAGER_IQUEUE_enqueue_cell(
    MPIDI_POSIX_EAGER_IQUEUE_transport_t* transport,
    MPIDI_POSIX_EAGER_IQUEUE_cell_t* cell)
{
    /* Ingress queue of cells is inverted. Thus, we need to re-invert it. */
    if (cell->prev) {
        MPIDI_POSIX_EAGER_IQUEUE_cell_t* prev = MPIDI_POSIX_EAGER_IQUEUE_GET_CELL(transport, cell->prev);
...
static inline MPIDI_POSIX_EAGER_IQUEUE_cell_t* MPIDI_POSIX_EAGER_IQUEUE_receive_cell(MPIDI_POSIX_EAGER_IQUEUE_transport_t* transport)
{
    MPIDI_POSIX_EAGER_IQUEUE_cell_t* cell;
