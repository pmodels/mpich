                                                                       ...
                                                                       ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Bcast__intra__scatter_recursive_doubling_allgather(buffer, count, datatype, root,
                                                                comm_ptr, errflag);
                                                         ...
                                                         params_container ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Bcast__intra__scatter_ring_allgather(buffer, count, datatype, root, comm_ptr, errflag);
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allreduce__intra__recursive_doubling(const void *sendbuf, void *recvbuf,
                                                         ...
                                                         params_container ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Allreduce__intra__recursive_doubling(sendbuf, recvbuf, count, datatype, op, comm_ptr,
                                                  errflag);
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allreduce__intra__reduce_scatter_allgather(const void *sendbuf, void *recvbuf,
                                                               int count, MPI_Datatype datatype,
                                                               MPI_Op op, MPIR_Comm * comm_ptr,
                                                               MPIR_Errflag_t * errflag,
                                                               MPIDI_POSIX_coll_algo_container_t *
                                                               params_container ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Allreduce__intra__reduce_scatter_allgather(sendbuf, recvbuf, count, datatype, op,
                                                        comm_ptr, errflag);
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Reduce__intra__reduce_scatter_gather(const void *sendbuf, void *recvbuf,
                                                         int count, MPI_Datatype datatype,
                                                         ...
                                                         params_container ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Reduce__intra__reduce_scatter_gather(sendbuf, recvbuf, count, datatype, op, root,
                                                  comm_ptr, errflag);
                                            ...
                                            params_container ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Reduce__intra__binomial(sendbuf, recvbuf, count, datatype, op, root, comm_ptr,
                                     errflag);
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoall__intra__brucks(const void *sendbuf, int sendcount,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoall__intra__scattered(const void *sendbuf, int sendcount,
                                               MPI_Datatype sendtype, void *recvbuf, int recvcount,
                                               MPI_Datatype recvtype, MPIR_Comm * comm_ptr,
                                               MPIR_Errflag_t * errflag,
                                               MPIDI_POSIX_coll_algo_container_t *
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoall__intra__pairwise(const void *sendbuf, int sendcount,
                                              MPI_Datatype sendtype, void *recvbuf, int recvcount,
                                              MPI_Datatype recvtype, MPIR_Comm * comm_ptr,
                                              MPIR_Errflag_t * errflag,
                                              MPIDI_POSIX_coll_algo_container_t *
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoall__intra__pairwise_sendrecv_replace(const void *sendbuf, int sendcount,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoallv__intra__pairwise_sendrecv_replace(const void *sendbuf,
                                                                ...
                                                                ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Alltoallv__intra__pairwise_sendrecv_replace(sendbuf, sendcounts, sdispls, sendtype,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoallw__intra__pairwise_sendrecv_replace(const void *sendbuf,
                                                                const int sendcounts[],
                                                                const int sdispls[],
                                                                ...
                                                                ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Alltoallw__intra__pairwise_sendrecv_replace(sendbuf, sendcounts, sdispls, sendtypes,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Alltoallw__intra__scattered(const void *sendbuf, const int sendcounts[],
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allgather__intra__recursive_doubling(const void *sendbuf, int sendcount,
                                                         MPI_Datatype sendtype, void *recvbuf,
                                                         int recvcount, MPI_Datatype recvtype,
                                                         MPIR_Comm * comm_ptr,
                                                         MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allgather__intra__brucks(const void *sendbuf, int sendcount,
                                             MPI_Datatype sendtype, void *recvbuf, int recvcount,
                                             MPI_Datatype recvtype, MPIR_Comm * comm_ptr,
                                             MPIR_Errflag_t * errflag,
                                             MPIDI_POSIX_coll_algo_container_t *
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allgather__intra__ring(const void *sendbuf, int sendcount,
                                           MPI_Datatype sendtype, void *recvbuf, int recvcount,
                                           MPI_Datatype recvtype, MPIR_Comm * comm_ptr,
                                           MPIR_Errflag_t * errflag,
                                           MPIDI_POSIX_coll_algo_container_t *
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allgatherv__intra__recursive_doubling(const void *sendbuf, int sendcount,
                                                          MPI_Datatype sendtype, void *recvbuf,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allgatherv__intra__brucks(const void *sendbuf, int sendcount,
                                              MPI_Datatype sendtype, void *recvbuf,
                                              const int *recvcounts, const int *displs,
                                              MPI_Datatype recvtype, MPIR_Comm * comm_ptr,
                                              MPIR_Errflag_t * errflag,
...
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX
    int MPIDI_POSIX_Allgatherv__intra__ring(const void *sendbuf, int sendcount,
                                            MPI_Datatype sendtype, void *recvbuf,
                                            const int *recvcounts, const int *displs,
                                            MPI_Datatype recvtype, MPIR_Comm * comm_ptr,
                                            MPIR_Errflag_t * errflag,
                                                              ...
                                                              params_container ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Reduce_scatter__intra__recursive_doubling(sendbuf, recvbuf, recvcounts, datatype, op,
                                                       comm_ptr, errflag);
    return mpi_errno;
}
                                                             ...
                                                             params_container ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Reduce_scatter__intra__recursive_halving(sendbuf, recvbuf, recvcounts, datatype, op,
                                                      comm_ptr, errflag);
    return mpi_errno;
}
                                                                ...
                                                                ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Reduce_scatter_block__intra__noncommutative(sendbuf, recvbuf, recvcount, datatype, op,
                                                         comm_ptr, errflag);
    return mpi_errno;
}
                                                                   ...
                                                                   ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Reduce_scatter_block__intra__recursive_halving(sendbuf, recvbuf, recvcount, datatype,
                                                            op, comm_ptr, errflag);
    return mpi_errno;
}
                                                    ...
                                                    params_container ATTRIBUTE((unused)))
{
    ...
    mpi_errno =
        MPIR_Scan__intra__recursive_doubling(sendbuf, recvbuf, count, datatype, op, comm_ptr,
                                             errflag);
    return mpi_errno;
}
