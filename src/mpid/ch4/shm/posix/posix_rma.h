                                                                       ...
                                                                       int is_dev2, int dev2)
{
    ...
    } else if (MPIR_CVAR_CH4_GPU_RMA_ENGINE_TYPE == MPIR_CVAR_CH4_GPU_RMA_ENGINE_TYPE_compute) {
        return MPL_GPU_ENGINE_TYPE_COMPUTE;
    } else if (MPIR_CVAR_CH4_GPU_RMA_ENGINE_TYPE ==
               MPIR_CVAR_CH4_GPU_RMA_ENGINE_TYPE_copy_high_bandwidth) {
        return MPL_GPU_ENGINE_TYPE_COPY_HIGH_BANDWIDTH;
    } else if (MPIR_CVAR_CH4_GPU_RMA_ENGINE_TYPE ==
               MPIR_CVAR_CH4_GPU_RMA_ENGINE_TYPE_copy_low_latency) {
        return MPL_GPU_ENGINE_TYPE_COPY_LOW_LATENCY;
    } else {
