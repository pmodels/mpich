                                                           ...
                                                           MPIR_Win * win, MPIDI_winattr_t winattr)
{
    ...
    if (winattr & MPIDI_WINATTR_SHM_ALLOCATED) {
        ...
        MPID_THREAD_CS_ENTER(VCI, MPIDI_VCI(win->dev.shm.posix.vsi).lock);
    }
    ...
    if (winattr & MPIDI_WINATTR_SHM_ALLOCATED) {
        ...
        MPID_THREAD_CS_EXIT(VCI, MPIDI_VCI(win->dev.shm.posix.vsi).lock);
    }
                                                  ...
                                                  MPIR_Request ** request)
{
    ...
    if (!(winattr & MPIDI_WINATTR_SHM_ALLOCATED) &&
        ...
        mpi_errno = MPIDIG_mpi_rput(origin_addr, origin_count, origin_datatype,
                                    ...
                                    target_datatype, win, vsi, request);
        goto fn_exit;
    }
    ...
    if (mpi_errno == MPI_SUCCESS) {
        ...
        MPIDI_CH4_REQUEST_CREATE(sreq, MPIR_REQUEST_KIND__RMA, vsi, 2);
        MPIR_Assert(sreq);
                                                              ...
                                                              MPIDI_winattr_t winattr)
{
    ...
    if (!(winattr & MPIDI_WINATTR_SHM_ALLOCATED) &&
        ...
        mpi_errno = MPIDIG_mpi_compare_and_swap(origin_addr, compare_addr, result_addr,
                                                datatype, target_rank, target_disp, win, vsi);
        goto fn_exit;
    }
                                                         ...
                                                         MPIR_Request ** request)
{
    ...
    if (!(winattr & MPIDI_WINATTR_SHM_ALLOCATED) &&
        ...
        mpi_errno = MPIDIG_mpi_raccumulate(origin_addr, origin_count, origin_datatype,
                                           target_rank, target_disp, target_count,
                                           target_datatype, op, win, vsi, request);
        goto fn_exit;
    }
                                                          ...
                                                          MPIR_Win * win, MPIDI_winattr_t winattr)
{
    ...
    if (!(winattr & MPIDI_WINATTR_SHM_ALLOCATED) &&
        ...
        mpi_errno = MPIDIG_mpi_fetch_and_op(origin_addr, result_addr, datatype,
                                            target_rank, target_disp, op, win, vsi);
        goto fn_exit;
    }
