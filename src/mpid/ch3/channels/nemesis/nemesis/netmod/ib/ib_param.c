...
int MPID_nem_ib_init_dev_param();
int MPID_nem_ib_init_cm_param();

#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_init_dev_param
#undef FCNAME
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_init_cm_param
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
#if 0
int MPID_nem_ib_init_param(MPID_nem_ib_device_ptr_t dev)
{
    int mpi_errno = MPI_SUCCESS;
