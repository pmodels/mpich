...
static void MPID_nem_ib_get_wc_err_string(int err_code)
{
    switch(err_code) {
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_open_hca
#undef FCNAME
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_alloc_pd
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
/**
 * MPID_nem_ib_get_dev_attr - Gets IB device attributes 
 *
 * @ctxt: Context of IB device for which protection
 *  domain has to be allocated (IN)
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_get_dev_attr
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_create_cq
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_create_srq
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
/**
 * MPID_nem_ib_is_port_active - Finds out if a particular
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_is_port_active
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_get_port_prop
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_reg_mem
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_post_srq
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_post_send
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_poll_cq
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
        ...
        struct ibv_wc *wc)
{
    ...
    if(ret < 0) {
        ...
        if(IBV_WC_SUCCESS != wc->status) {
            ...
            MPID_nem_ib_get_wc_err_string(wc->status);
...
#undef FUNCNAME
#define FUNCNAME MPID_nem_ib_modify_srq
#undef FCNAME
#define FCNAME MPIDI_QUOTE(FUNCNAME)
