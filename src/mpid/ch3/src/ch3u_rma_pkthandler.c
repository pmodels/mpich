        ...
        *rreqp = NULL;
        ...
        if (MPIR_DATATYPE_IS_PREDEFINED(put_pkt->datatype)) {
            ...
            *buflen = data_len;
            ...
            req->dev.flattened_type_size = put_pkt->info.flattened_type_size;
             ...
             * channel copy it */
            if (data_len >= req->dev.flattened_type_size) {
                /* Copy flattened type */
                MPIR_Memcpy(req->dev.flattened_type, data_buf, req->dev.flattened_type_size);

                *buflen = req->dev.flattened_type_size;
                ...
                req->dev.iov[0].MPL_IOV_LEN = req->dev.flattened_type_size;
                req->dev.iov_count = 1;
                             ...
                             intptr_t * buflen, MPIR_Request ** rreqp)
{
    ...
    if (MPIR_DATATYPE_IS_PREDEFINED(get_pkt->datatype)) {
        ...
        *rreqp = NULL;
        ...
        /* put flattened type in a separate buffer to be reused in
         * datatype.  It will be freed when free datatype. */
        req->dev.flattened_type_size = get_pkt->info.flattened_type_size;
