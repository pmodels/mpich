...
int socket_handle_written_via(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr);
#endif
#ifdef WITH_METHOD_VIA_RDMA
int socket_handle_written_via_rdma(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr);
#endif
int socket_handle_written_vec(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr);
int socket_handle_written_tmp(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr);
int socket_handle_written_simple(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr);

#if 0
int socket_handle_written(MPIDI_VC *vc_ptr)
{
    MM_Car *car_ptr;
    ...
    {
	msg_printf("socket_handle_written: write called with no vc's in the write queue.\n");
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN);
	return MPI_SUCCESS;
    }
...
#ifdef WITH_METHOD_SHM
    case MM_SHM_BUFFER:
	ret_val = socket_handle_written_shm(vc_ptr, car_ptr, buf_ptr);
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN);
	return ret_val;
	break;
#endif
#ifdef WITH_METHOD_VIA
    case MM_VIA_BUFFER:
	ret_val = socket_handle_written_via(vc_ptr, car_ptr, buf_ptr);
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN);
	return ret_val;
	break;
#endif
	...
	ret_val = socket_handle_written_via_rdma(vc_ptr, car_ptr, buf_ptr);
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN);
	return ret_val;
	break;
#endif
    case MM_VEC_BUFFER:
	ret_val = (buf_ptr->vec.num_cars_outstanding > 0) ? socket_handle_written_vec(vc_ptr, car_ptr, buf_ptr) : MPI_SUCCESS;
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN);
	return ret_val;
	break;
    case MM_SIMPLE_BUFFER:
	ret_val = socket_handle_written_simple(vc_ptr, car_ptr, buf_ptr);
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN);
	return ret_val;
	break;
    case MM_TMP_BUFFER:
	ret_val = socket_handle_written_tmp(vc_ptr, car_ptr, buf_ptr);
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN);
	return ret_val;
	break;
#ifdef WITH_METHOD_NEW
    case MM_NEW_METHOD_BUFFER:
	ret_val = socket_handle_written_new(vc_ptr, car_ptr, buf_ptr);
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN);
	return ret_val;
	break;
#endif
    case MM_NULL_BUFFER:
	err_printf("Error: socket_handle_written called on a null buffer\n");
	break;
    default:
	err_printf("Error: socket_handle_written: unknown or unsupported buffer type: %d\n", buf_ptr->type);
	break;
    }
...
int socket_handle_written_shm(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr)
{
    MPIDI_STATE_DECL(MPID_STATE_SOCKET_HANDLE_WRITTEN_SHM);
    MPIDI_FUNC_ENTER(MPID_STATE_SOCKET_HANDLE_WRITTEN_SHM);
    MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN_SHM);
    return MPI_SUCCESS;
}
#endif
...
int socket_handle_written_via(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr)
{
    MPIDI_STATE_DECL(MPID_STATE_SOCKET_HANDLE_WRITTEN_VIA);
    MPIDI_FUNC_ENTER(MPID_STATE_SOCKET_HANDLE_WRITTEN_VIA);
    MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN_VIA);
    return MPI_SUCCESS;
}
#endif
...
int socket_handle_written_via_rdma(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr)
{
    MPIDI_STATE_DECL(MPID_STATE_SOCKET_HANDLE_WRITTEN_VIA_RDMA);
    MPIDI_FUNC_ENTER(MPID_STATE_SOCKET_HANDLE_WRITTEN_VIA_RDMA);
    MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN_VIA_RDMA);
    return MPI_SUCCESS;
}
#endif
...
int socket_handle_written_vec(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr)
{
    ...
    int num_left, i;
    MPIDI_STATE_DECL(MPID_STATE_SOCKET_HANDLE_WRITTEN_VEC);
    
    MPIDI_FUNC_ENTER(MPID_STATE_SOCKET_HANDLE_WRITTEN_VEC);

#ifdef MPICH_DEV_BUILD
    /* this function assumes that buf_ptr->vec.num_cars_outstanding > 0 */
    if (buf_ptr->vec.num_cars_outstanding == 0)
    {
	err_printf("Error: socket_handle_written_vec called when num_cars_outstanding == 0.\n");
	return -1;
    }
#endif
	...
	if (car_ptr->data.socket.buf.vec_write.vec_size == 1) /* optimization for single buffer writes */
	{
		...
		*/
		...
		MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN_VEC);
		return -1;
	    }
	}
	else
	...
	{
	    err_printf("Error: socket_handle_written_vec not dequeueing the head write car.\n");
	}
#endif
...
int socket_handle_written_tmp(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr)
{
    int error;
    int num_written;
    MPIDI_STATE_DECL(MPID_STATE_SOCKET_HANDLE_WRITTEN_TMP);

    MPIDI_FUNC_ENTER(MPID_STATE_SOCKET_HANDLE_WRITTEN_TMP);

    if ((car_ptr->data.socket.buf.tmp.num_written == buf_ptr->tmp.num_read) || (buf_ptr->tmp.num_read == 0))
    {
	MPIDI_FUNC_EXIT(MPID_STATE_SOCKET_HANDLE_WRITTEN_TMP);
	return MPI_SUCCESS;
    }
	...
	*/
    ...
    {
	socket_print_sock_error(error, "socket_handle_written_tmp: sock_write failed");
    }
	...
	{
	    err_printf("Error: socket_handle_written_tmp not dequeueing the head write car.\n");
	}
#endif
...
int socket_handle_written_simple(MPIDI_VC *vc_ptr, MM_Car *car_ptr, MM_Segment_buffer *buf_ptr)
{
    int error;
    int num_written;
    MPIDI_STATE_DECL(MPID_STATE_SOCKET_HANDLE_WRITTEN_SIMPLE);

    MPIDI_FUNC_ENTER(MPID_STATE_SOCKET_HANDLE_WRITTEN_SIMPLE);
