...
\hline
\hline 
\includegraphics[scale=0.8]{pic/timeline_nesting_legend_innermost}&
Innermost Nested State&
0.5 sec&
50\%&
50\%\tabularnewline
\hline 
\multicolumn{1}{|c|}{\includegraphics[scale=0.8]{pic/timeline_nesting_legend_middle}}&
Intermediate Nested State&
0.8 sec&
80\%&
30\%\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/timeline_nesting_legend_outermost}&
...
Currently, five convertors are supported: \emph{CLOG} --\textgreater{}
\emph{SLOG-2}, \emph{CLOG-2 --\textgreater{} SLOG-2, RLOG} --\textgreater{}
\emph{SLOG-2,} \emph{UTE} --\textgreater{} \emph{SLOG-2} and \emph{TXT
--\textgreater{} SLOG-2.} The convertor is generally selected based
...
\begin{figure}[!htbp]
\centering
\subfigure[Legend Window's initial view]{\includegraphics[scale=0.6]{pic/legend_popup}}~~~~~~~~~~~~~~~\subfigure[Fully extended Legend window that shows statistics sumary]{\includegraphics[scale=0.6]{pic/legend_popup_full}}
...
%
\begin{table}[!htbp]
\centering\begin{longtable}{|c|c|>{\centering}p{2in}|>{\centering}p{2in}|}
\hline 
Icon&
Description&
...
\hline
\hline 
\includegraphics[scale=0.8]{pic/legend_topo}&
Topology&
Pick new Color (Figure \ref{fig:legend_color_chooser})&
None\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_name}&
Name&
Edit Name&
String Sort Order Menu (Figure \ref{fig:legend_sort_orders}(a))\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_v}&
Visibility&
Check or Uncheck&
Checkbox Operations Menu (Figure \ref{fig:legend_checkbox_ops})\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_s}&
Searchability&
Check or Uncheck&
Checkbox Operations Menu (Figure \ref{fig:legend_checkbox_ops})\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_count}&
Count&
Non-editable&
Number Sort Order Menu(Figure\ref{fig:legend_sort_orders}(b))\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_incl}&
Inclusion Ratio&
Non-editable&
Number Sort Order Menu(Figure\ref{fig:legend_sort_orders}(b))\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_excl}&
Exclusion Ratio&
Non-editable&
Number Sort Order Menu(Figure\ref{fig:legend_sort_orders}(b))\tabularnewline
\hline
...
\begin{figure}[!htbp]
\centering
\subfigure[Sort Order menu for Name]{\includegraphics[scale=0.6]{pic/legend_sort_string_menu}}~~~~~~~~~~~~~~~\subfigure[Sort Order menu for count, inclusion and exclusion ratios]{\includegraphics[scale=0.6]{pic/legend_sort_number_menu}}
...
\hline 
9 ... 1&
Decreasing numerical ordering\tabularnewline
\hline 
1 ... 9&
Increasing numerical ordering\tabularnewline
\hline
\end{longtable}
...
to starting point, and {}``{[}1]'' refers to the ending point. The
three {}``average'' timestamps are averaged over all the real drawables
represented by this preview drawable. Besides timestamps, the info
box also tells the{}``Number of Real Drawables'' represented by
the preview object. In this case, 136 real states are amalgamated
...
\hline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Up24}&
Up&
Alt-UP&
Scroll upward by half a screen\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Down24}&
Down&
Alt-DOWN&
Scroll downward by half of a screen\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Edit24}&
LabelMark&
none&
Mark the timeline(s)\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Paste24}&
LabelMove&
none&
Move the marked timeline(s)\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Delete24}&
LabelDelete&
none&
Delete the marked timeline(s)\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/TreeExpand24}&
LabelExpand&
Alt-E&
Expand the y-axis tree label by 1 level. Useful in Process-Thread
...
\hline 
\includegraphics[scale=0.8]{pic/gif2png/TreeCollapse24}&
LabelCollapse&
Alt-C&
Collapse the y-axis tree label by 1 level. Useful in collapsing multiple
thread timelines into single process timeline.\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Backward24}&
Backward&
Alt-LEFT&
Scroll Backward by half a screen\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Forward24}&
Forward&
Alt-RIGHT&
Scroll Forward by half a screen\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/WinUndo}&
ZoomUndo&
Alt-U&
Undo the previous zoom operation\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/ZoomOut24}&
ZoomOut&
Alt-O&
Zoom Out by 1 level in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Home24}&
ZoomHome&
Alt-H&
Reset zoom to the initial resolution in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/ZoomIn24}&
ZoomIn&
Alt-I&
Zoom In by 1 level in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/WinRedo}&
ZoomRedo&
Alt-R&
Redo the previous zoom operation\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/FindBack24}&
SearchBackward&
Alt-B&
Search backward in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Find24}&
SeachInitialize&
Alt-S&
Search initialization from last popup InfoBox's time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/FindFore24}&
SearchForward&
Alt-F&
Search forward in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Refresh24}&
CanvasReDraw&
Alt-D&
Redraw canvas to synchronize changes from Preference/Legend window
or y-axis label panel.\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Print24}&
Print&
none&
...
\begin{figure}[!htbp]
\centering
\subfigure[Row Count mode]{\includegraphics[scale=0.6]{pic/adj_row_count}}~~~~~~~~~~~~~~~\subfigure[Row Height mode]{\includegraphics[scale=0.6]{pic/adj_row_height}}
...
child thread count&
MPICH2&
OpenMPI+progress\_thread&
OpenMPI\tabularnewline
\hline
\hline 
1&
0.025299&
0.029545&
0.029230\tabularnewline
\hline 
2&
0.026213 &
0.030872 &
0.032966 \ref{fig:openmpi_4_2}\tabularnewline
\hline 
3&
0.028916 &
0.038964 &
0.050484 \ref{fig:openmpi_4_3}\tabularnewline
\hline 
4&
0.030145 &
0.045354 &
0.054791 \ref{fig:openmpi_4_4}\tabularnewline
\hline 
5&
0.031977 &
0.058039 &
0.149200 \ref{fig:openmpi_4_5}\tabularnewline
\hline 
6&
0.034462 &
0.058505 &
0.193399 \ref{fig:openmpi_4_6}\tabularnewline
\hline
\end{longtable}
...
\caption{\label{fig:pthread_sendrecv_legend} The legend table of all the
pthread\_sendrecv runs.}
\end{figure}
...
\subfigure[process-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_2_procthd}}

\centering

\subfigure[communicator-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_2_commthd}}


\caption{\label{fig:openmpi_4_2}OpenMPI without progress thread: 2 child
threads per process. As shown in both the Process-Thread view and
Communicator-Thread views here, everything performs as expected.}
\end{figure}
...
\subfigure[process-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_3_procthd}}

\centering

\subfigure[communicator-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_3_commthd}}


\caption{\label{fig:openmpi_4_3}OpenMPI without progress thread: 3 child
threads per process where there are 3 MPI\_Comm\_dup() calls in the
master thread 0. As shown in the expanded Process-Thread view, the
3rd MPI\_Comm\_dup() call takes significantly longer than the first
two MPI\_Comm\_dup(). The expanded Communicator-Thread view also suggests
that the delayed 3rd MPI\_Comm\_dup() is blocking MPI point-to-point
communication in the first two duplicated MPI\_COMM\_WORLD. As soon
as the delayed MPI\_Comm\_dup() exits, the MPI point-to-point communication
is restored. }
\end{figure}
...
\subfigure[process-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_4_procthd}}

\centering

\subfigure[communicator-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_4_commthd}}


\caption{\label{fig:openmpi_4_4}OpenMPI without progress thread: 4 child
threads per process. Similar to Fig. \ref{fig:openmpi_4_3}, the 3rd
MPI\_Comm\_dup() is delayed but not the 4th MPI\_Comm\_dup(). The
interference between the delayed 3rd MPI\_Comm\_dup() and the other
dup MPI\_COMM\_WORLD seen in Fig. \ref{fig:openmpi_4_3} is not observed
here. So the communication in first two dup MPI\_COMM\_WORLD finishes
much earlier than the communication in the last two communicators.}
\end{figure}
...
\subfigure[process-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_5_procthd}}

\centering

\subfigure[communicator-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_5_commthd}}


\caption{\label{fig:openmpi_4_5}OpenMPI without progress thread: 5 child
threads per process. Again, the last MPI\_Comm\_dup() takes longer
than previous MPI\_Comm\_dup()s in finishing up. The feature that
we observed in Fig. \ref{fig:openmpi_4_3} that the delayed MPI\_Comm\_dup()
is blocking other communicator's communication occurs here. However,
even long after all MPI\_Comm\_dup() are done, there are many regions
...
\subfigure[process-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_6_procthd}}

\centering

\subfigure[communicator-thread view]{\includegraphics[scale=0.4]{pic/openmpi_4_6_commthd}}


\caption{\label{fig:openmpi_4_6}OpenMPI without progress thread: 6 child
threads per process. This is very similar to Fig. \ref{fig:openmpi_4_5}.}
\end{figure}
