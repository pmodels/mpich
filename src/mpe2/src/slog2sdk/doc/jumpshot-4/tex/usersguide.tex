...
\author{Anthony Chan,%
\thanks{chan@mcs.anl.gov%
} David Ashton,%
\thanks{ashton@mcs.anl.gov%
} Rusty Lusk,%
\thanks{lusk@mcs.anl.gov%
} William Gropp%
\thanks{gropp@mcs.anl.gov%
}\\
...
state is a \textquotedbl{}state amalgamates only\textquotedbl{} object.
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/timeline_preview_detail_0}
...
and in Table \ref{table:preference_zoomable_timeline_a}. Different
...
and in Table \ref{table:preference_zoomable_timeline_a}, there is
also a PREVIEW\_STATE\_DISPLAY variable. The variable determines the
initial PREVIEW\_STATE\_DISPLAY used when the Timeline window is first
made visible.%
...
\includegraphics[scale=0.6]{pic/timeline_preview_detail_1}
...
\includegraphics[scale=0.6]{pic/timeline_preview_detail_2}
...
\includegraphics[scale=0.6]{pic/timeline_preview_detail_3}
...
\includegraphics[scale=0.6]{pic/timeline_preview_detail_4}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/timeline_nesting_detail}
...
\hline 
Icon & Description & Duration & Inclusion Ratio & Exclusion Ratio\tabularnewline
\hline 
\hline 
\includegraphics[scale=0.8]{pic/timeline_nesting_legend_innermost} & Innermost Nested State & 0.5 sec & 50\% & 50\%\tabularnewline
\hline 
\multicolumn{1}{|c|}{\includegraphics[scale=0.8]{pic/timeline_nesting_legend_middle}} & Intermediate Nested State & 0.8 sec & 80\% & 30\%\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/timeline_nesting_legend_outermost} & Outermost Enclosing State & 1.0 sec & 100\% & 20\%\tabularnewline
\hline 
\end{longtable}

\caption{\label{table:legend_nesting_detail}Contributions of real states to
a preview state of duration 1.0 sec as marked by the pair of green
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/timeline_nesting_preview_all}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/timeline_preview_detail_0_excl}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/timeline_preview_detail_1_excl}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/main}
...
lists all the available ViewMaps in the SLOG-2 file. The CLOG%
...
} SLOG-2 files contain one ViewMap, called the Identity Map. The recent
CLOG-2 and IBM's UTE trace-converted SLOG-2 file contains multiple
ViewMaps, e.g. a CLOG-2 logfile generated from a multi-threaded MPI
program contains the Process-Thread and Communicator-Thread ViewMaps
besides the Identity Map.

\begin{table}[!htbp]
\begin{longtable}{|c|c|c|}
\hline 
Icon & Description & Function\tabularnewline
\hline 
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Open24} & File Selection  & display a File Chooser dialog to select logfile to be processed\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Convert24} & Logfile Conversion & invoke the Logfile Convertor to convert non-slog2 file to slog2 format\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Properties24} & Show Legend Window & display the Legend window of the selected logfile if it is hidden\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/New24} & Show Timeline Window & display the Timeline window of the selected logfile if it is hidden\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Preferences24} & Edit Preferences & display the Preference window that adjusts Jumpshot's properties\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Help24} & Show Users Manual & show the Users Manual of this program\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Information24} & Show FAQs & show the FAQs of this program\tabularnewline
\hline 
\end{longtable}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/convertor_init}
...
Currently, five convertors are supported: \emph{CLOG} --> \emph{SLOG-2},
\emph{CLOG-2 --> SLOG-2, RLOG} --> \emph{SLOG-2,} \emph{UTE} --> \emph{SLOG-2}
and \emph{TXT --> SLOG-2.} The convertor is generally selected based
on the input file's file extension. If the wrong file convertor is
selected, the user can correct it through the pale-blue pulldown menu
...
return key in the Input File Specification field will force an update
of the Output File Name field with the default name. The Logfile Convertor
has five major functions, each is associated with a button in the
lower panel of the window. They are listed in Table \ref{table:convertor_buttons}.
...
\hline 
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Convert24} & Convert & Start the logfile conversion of the selected convertor\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Stop24} & Stop & Stop the ongoing logfile conversion of the selected convertor\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/About24} & Usage & Print the usage information of the selected convertor\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/ConvertCancel24} & Cancel & Close the window without doing anything\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/ConvertOk24} & OK & Display the last converted SLOG-2 file and close the window\tabularnewline
\hline 
\end{longtable}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/convertor_parameters}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/convertor_progress}
...
\begin{figure}[!htbp]
\centering\includegraphics[scale=0.5]{pic/convertor_done}
...
\begin{figure}[!htbp]
\centering
\subfloat[Legend Window's initial view]{

\includegraphics[scale=0.6]{pic/legend_popup}}~~~~~~~~~~~~~~~\subfloat[Fully extended Legend window that shows statistics sumary]{

\includegraphics[scale=0.6]{pic/legend_popup_full}}

\caption{\label{fig:legend_popup} Typical Legend window when a slog2 file
is first loaded into Jumpshot-4. The Legend window can be expanded
to reveal the hidden statistics, \emph{count}, \emph{inclusion ratio}
and \emph{exclusion ratio} of each category of drawables, stored in
the 5th, 6th and 7th columns of the window.}
\end{figure}


The Legend window contains mainly a seven-column legend table. The
seven columns are labeled \emph{Topo, Name, V, S, count, incl and
excl} as in Table \ref{table:legend_column_ops}.

\begin{table}[!htbp]
\centering%
\begin{longtable}{|c|c|>{\centering}p{2in}|>{\centering}p{2in}|}
\hline 
Icon & Description & Left Mouse Click on Column Cell & Right Mouse Click on Column Cell or Left Mouse Click on Column Title\tabularnewline
\hline 
\hline 
\includegraphics[scale=0.8]{pic/legend_topo} & Topology & Pick new Color (Figure \ref{fig:legend_color_chooser}) & None\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_name} & Name & Edit Name & String Sort Order Menu (Figure \ref{fig:legend_sort_orders}(a))\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_v} & Visibility & Check or Uncheck & Checkbox Operations Menu (Figure \ref{fig:legend_checkbox_ops})\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_s} & Searchability & Check or Uncheck & Checkbox Operations Menu (Figure \ref{fig:legend_checkbox_ops})\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_count} & Count & Non-editable & Number Sort Order Menu(Figure\ref{fig:legend_sort_orders}(b))\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_incl} & Inclusion Ratio & Non-editable & Number Sort Order Menu(Figure\ref{fig:legend_sort_orders}(b))\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/legend_excl} & Exclusion Ratio & Non-editable & Number Sort Order Menu(Figure\ref{fig:legend_sort_orders}(b))\tabularnewline
\hline 
\end{longtable}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/legend_color_chooser}
...
\begin{figure}[!htbp]
\centering
\subfloat[Sort Order menu for Name]{

\includegraphics[scale=0.6]{pic/legend_sort_string_menu}}~~~~~~~~~~~~~~~\subfloat[Sort Order menu for count, inclusion and exclusion ratios]{

\includegraphics[scale=0.6]{pic/legend_sort_number_menu}}

\caption{\label{fig:legend_sort_orders} Sort Order operation menu for the
column \emph{Name, count, incl} and \emph{excl} in the Legend window.}
\end{figure}


Figure \ref{fig:legend_sort_orders}(a) shows the popup dialog box
either when the title icon of column \emph{Name} is pressed or when
the right mouse button is clicked somewhere in the column. Altogether,
there are six different alphabetical sort orders as shown in the figure
and they are summarized in Table \ref{table:legend_sort_string_orders}.
Fig \ref{fig:legend_sort_orders}(b) shows the popup dialog box for
the column \emph{count}, i\emph{ncl} or \emph{excl} is pressed or
when the right mouse button is clicked somewhere in the column. The
popup dialog box contains a menu which will be described later in
Table \ref{table:legend_sort_number_orders}.

\begin{table}[!htbp]
\centering
\begin{longtable}{|c|c|}
\hline 
Ordering & Description\tabularnewline
\hline 
\hline 
\emph{A...Z a...z} & case-sensitive alphabetical ordering\tabularnewline
\hline 
\emph{z...a Z...A} & reverse-case-sensitive alphabetical ordering\tabularnewline
\hline 
\emph{Aa...Zz} & case-insensitive alphabetical ordering\tabularnewline
\hline 
\emph{zZ...aA} & reverse-case-insensitive alphabetical ordering\tabularnewline
\hline 
Creation & category storage ordering in the slog2 file\tabularnewline
\hline 
Reverse Creation & reverse of Creation order\tabularnewline
\hline 
\end{longtable}

\caption{\label{table:legend_sort_string_orders}Description of the alphabetical
Sort Order operation menu for column \emph{Name} in the Legend window.}
\end{table}
...
\hline 
\hline 
9 ... 1 & Decreasing numerical ordering\tabularnewline
\hline 
1 ... 9 & Increasing numerical ordering\tabularnewline
\hline 
\end{longtable}

\caption{\label{table:legend_sort_number_orders}Description of the numerical
Sort Order operation menu for columns \emph{count}, i\emph{ncl} and
\emph{excl} in the Legend window}
\end{table}


Table \ref{table:legend_sort_number_orders} shows the only two orderings
allowed for all numerical entries in the Legend window.

\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/legend_checkbox_menu}
...
the title icon of column \emph{V (Visibility)} or \emph{S (Searchability)}
is pressed or when the right mouse button is clicked somewhere in
either column. The rule of selection in the legend table follows the
standard practice of other graphical user interfaces as in Table \ref{table:selection_rules}.
...
in CLOG2 converted SLOG-2 file where all MPI states will be prefixed
with MPI\_, the case-sensitive alphabetical ordering allows all MPI
names to be put before all user-defined categories. With continuous
mouse selection, the user can easily toggle the visibility of user-defined
states in the Timeline or Histogram window. Also, every element in
the column Name can be edited. This feature allows the user to correct
undesirable category names set during logfile creation and even facilitates
sorting of the names for selection purposes.

\begin{table}[!htbp]
\begin{longtable}{|c|>{\centering}m{4in}|}
\hline 
Left Mouse Operation & Action\tabularnewline
\hline 
\hline 
\noun{Click} & \emph{Click} on an object deselects any existing selection and selects
the object.\tabularnewline
\hline 
\noun{Control-Click} & \emph{Control-click} on an object toggles its selection without affecting
the selection of any other objects\tabularnewline
\hline 
\noun{Shift-Click} & \emph{Shift-click} on an object extends the selection from the most
recently selected object to the current object.\tabularnewline
\hline 
\noun{Dragging } & \emph{Dragging} (that is, moving the mouse while holding down left
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/timeline_popup}
...
\begin{figure}[!htbp]
\centering
\includegraphics{pic/mouse_zoom_mode}
...
\begin{figure}[!htbp]
\centering
\includegraphics{pic/mouse_hand_mode}
...
\begin{figure}[!htbp]
\centering
\includegraphics{pic/gif2png/ZoomPlusUpLeft25}
...
\begin{figure}[!htbp]
\centering
\includegraphics{pic/gif2png/ZoomMinusUpLeft25}
...
\begin{figure}[!htbp]
\centering
\includegraphics{pic/gif2png/HandOpenUpLeft25}
...
\begin{figure}[!htbp]
\centering
\includegraphics{pic/gif2png/HandCloseUpLeft25}

\caption{\label{fig:hand_close_cursor} Closed-hand cursor indicates that the
left mouse click is scrolling.}
\end{figure}
...
\includegraphics[scale=0.6]{pic/timeline_infobox_preview_state}
...
mouse click is detected, and a green line with a upper and lower 3D
triangular markers will appear on the canvas to indicate what time
has been clicked, in case the dialog box is moved from its original
popup location. The clicked preview state will also be highlighted
by a 3D rectangular box. To illustrate what information is presented
by the Drawable Info Box, we take the highlighted Drawable Info Box
in Figure \ref{fig:timeline_infobox_preview_state} as an example.
The Drawable Info Box for the preview state contains a pink label
``Preview State'', and the icon inside the dialog box shows the
color and shape of the drawable. Below the icon is a big text area
that prints all the detailed statistical information about this preview
state. There are six timestamps in the text area: maximum duration,
minimum starttime, maximum endtime, average duration, average starttime,
and average endtime. Here ``{[}0{]}'' refers to starting point,
and ``{[}1{]}'' refers to the ending point. The three ``average''
...
the``Number of Real Drawables'' represented by the preview object.
In this case, 136 real states are amalgamated by the pure white preview
state. Also, the text area lists all the categories of real drawables
amalgamated and their ratios of the total duration of all real drawables
to the duration of the preview states. In this case, there is only
one category of real states in the preview state, so the 136 states
are all PACKs. The sum of the durations of all PACKs is about half
of the duration of the preview state, as indicated by ``ratio=0.5021433''. 

Another Drawable Info Box, shown in Figure \ref{fig:timeline_infobox_preview_state},
corresponds to the preview state that has four different strips of
colors: yellow, royal blue, white, and purple. Right mouse clicking
at the yellow strip pops up a Drawable Info Box with a yellow state
icon with label BARRIER. As shown in the figure, this preview state
amalgamated four categories of real states: ALLREDUCE, PACK, SSEND,
and BARRIER; the statistically most significant one is BARRIER. It
proportionally and exclusively occupies 55\% of the length of the
...
message, as listed in Table \ref{table:preference_zoomable_timeline_a}
.%
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/timeline_infobox_real_primitive}
...
Drawable Info Box for the arrow is created by clicking anywhere within
...
bytes. Both the clicked arrow and state are highlighted by 3D raised
border%
\footnote{The display properties of the hightlighted border for arrow, state
and event can be adjusted through Preference Panel as defined in Table
\ref{table:preference_zoomable_timeline_b}.%
}. The highlighted border is used to tell where clicked drawable is
when viewport has been scrolled far away from the original clicked
location. Also, there are a set of three navigation buttons at the
bottom of the Drawable Info Box that navigate the viewport back to
the starting or ending positions of the drawable as well as a home
button that brings the viewport back to original clicked position
of the drawable. The navigation buttons are meant to ease the task
of identifying the very long drawable(relative to the viewport) in
a busy logfile with large number of timelines.
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/timeline_infobox_duration}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/timeline_infobox_time}
...
\hline 
Icon & Description & Shortcut & Function\tabularnewline
\hline 
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Up24} & Up & Alt-UP & Scroll upward by half a screen\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Down24} & Down & Alt-DOWN & Scroll downward by half of a screen\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Edit24} & LabelMark & none & Mark the timeline(s)\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Paste24} & LabelMove & none & Move the marked timeline(s)\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Delete24} & LabelDelete & none & Delete the marked timeline(s)\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/TreeExpand24} & LabelExpand & Alt-E & Expand the y-axis tree label by 1 level. Useful in Process-Thread
or Communicator-Thread view to expand each process timeline into multiple
thread timelines in multi-threaded slog2 file.\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/TreeCollapse24} & LabelCollapse & Alt-C & Collapse the y-axis tree label by 1 level. Useful in collapsing multiple
thread timelines into single process timeline.\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Backward24} & Backward & Alt-LEFT & Scroll Backward by half a screen\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Forward24} & Forward & Alt-RIGHT & Scroll Forward by half a screen\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/WinUndo} & ZoomUndo & Alt-U & Undo the previous zoom operation\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/ZoomOut24} & ZoomOut & Alt-O & Zoom Out by 1 level in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Home24} & ZoomHome & Alt-H & Reset zoom to the initial resolution in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/ZoomIn24} & ZoomIn & Alt-I & Zoom In by 1 level in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/WinRedo} & ZoomRedo & Alt-R & Redo the previous zoom operation\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/FindBack24} & SearchBackward & Alt-B & Search backward in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Find24} & SeachInitialize & Alt-S & Search initialization from last popup InfoBox's time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/FindFore24} & SearchForward & Alt-F & Search forward in time\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Refresh24} & CanvasReDraw & Alt-D & Redraw canvas to synchronize changes from Preference/Legend window
or y-axis label panel.\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Print24} & Print & none & Print the Timeline window\tabularnewline
\hline 
\includegraphics[scale=0.8]{pic/gif2png/Stop24} & Exit & none & Exit the Timeline window\tabularnewline
\hline 
\end{longtable}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/yaxis_label_panel_simple}~~~~~~~~~~~~~~~\includegraphics[scale=0.6]{pic/yaxis_label_panel_expanded}
...
\begin{figure}[!htbp]
\centering
\subfloat[Row Count mode]{

\includegraphics[scale=0.6]{pic/adj_row_count}}~~~~~~~~~~~~~~~\subfloat[Row Height mode]{

\includegraphics[scale=0.6]{pic/adj_row_height}}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/histogram_state_all_cumu_excl}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/histogram_state_infobox}

\caption{\label{fig:histogram_state_infobox} Summary state info boxes of the
Histogram window.}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/histogram_state_over_incl}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/histogram_arrow}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/histogram_arrow_infobox}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.6]{pic/preference_pview_state}
...
\ref{table:preference_zoomable_reinit}, \ref{table:preference_zoomable_all},
 \ref{table:preference_zoomable_timeline_a}, \ref{table:preference_zoomable_timeline_b}
\ref{table:preference_zoomable_histogram} , and \ref{table:preference_legend}.

\begin{table}[!htbp]
\centering
\begin{longtable}{|l|>{\centering}p{1.1in}|p{3.5in}|}
\hline 
Parameter & Values & Description\tabularnewline
\hline 
\hline 
{\small Y\_AXIS\_ROOT\_LABEL} & any text & Label for the root node of the y-axis tree label in the left panel.\tabularnewline
\hline 
INIT\_SLOG2\_LEVEL\_READ & +ve integer & The number of slog2 levels being read into memory when the Timeline
...
\hline 
AUTO\_WINDOWS\_LOCATION & true, false & Whether to let Jumpshot-4 automatically set windows placement\tabularnewline
\hline 
SCREEN\_HEIGHT\_RATIO & 0.0 ... 1.0 & Ratio of the initial timeline canvas height to the screen height\tabularnewline
\hline 
TIME\_SCROLL\_UNIT\_RATIO & 0.0 ... 1.0 & Unit increment of the horizontal scrollbar in the fraction of timeline
...
\hline 
\hline 
Y\_AXIS\_ROOT\_VISIBLE & true, false & Whether to show the top of the y-axis tree-styled directory label.\tabularnewline
\hline 
ACTIVE\_REFRESH & false & Whether to let Jumpshot-4 actively update the timeline canvas.\tabularnewline
\hline 
BACKGROUND\_COLOR & Black, DarkGray, Gray, LightGray, White & Background color of the timeline canvas\tabularnewline
\hline 
STATE\_HEIGHT\_FACTOR & 0.0 ... 1.0 & Ratio of the outermost rectangle height to row height. The larger
the factor is, the larger the outermost rectangle will be with respect
to the row height.\tabularnewline
\hline 
NESTING\_HEIGHT\_FACTOR & 0.0 ... 1.0  & The gap ratio between successive nesting rectangles. The larger the
factor is, the smaller the gap will be.\tabularnewline
\hline 
ARROW\_ANTIALIASING & default, on, off & Whether to draw arrow with anti-aliasing lines. Turning this on will
slow down the canvas drawing by a factor of 3.\tabularnewline
\hline 
MIN\_WIDTH\_TO\_DRAG & integer & Minimum width in pixels to be considered a dragged operation.\tabularnewline
\hline 
CLICK\_RADIUS\_TO\_LINE & integer & Radius in pixels for a click to be considered on the arrow.\tabularnewline
\hline 
LEFTCLICK\_INSTANT\_ZOOM & true, false & Whether to zoom in immediately after left mouse click on canvas.\tabularnewline
\hline 
\end{longtable}

\caption{\label{table:preference_zoomable_all} Parameters for the section
of \emph{All Zoomable Windows} in the Preference window, where integers
...
\begin{table}[!htbp]
\centering
\begin{longtable}{|l|>{\centering}p{2in}|p{2in}|}
\hline 
Parameter & Values & Description\tabularnewline
\hline 
\hline 
STATE\_BORDER & ColorRaised, ColorLowered, WhiteRaised, WhiteLowered, WhitePlain,
Empty & Border style of real states.\tabularnewline
\hline 
ARROW\_HEAD\_LENGTH & integer & Length of the arrow head in pixels.\tabularnewline
\hline 
ARROW\_HEAD\_WIDTH & integer & Width of the arrow head's base in pixels(Even number).\tabularnewline
\hline 
EVENT\_BASE\_WIDTH & integer & Width of the event triangle's base in pixels\tabularnewline
\hline 
PREVIEW\_STATE\_DISPLAY & FitMostLegends, OverlapInclusionRatio, CumulativeInclusionRatio, OverlapExclusionRatio,
CumulativeExclusionRatio, BaseAlignedCumulativeExclusionRatio & Display option of Preview state when Timeline window starts up.\tabularnewline
\hline 
PREVIEW\_STATE\_BORDER & ColorRaised, ColorLowered, ColorXOR, WhiteRaised, WhiteLowered, WhitePlain,
Empty & Border style of preview state.\tabularnewline
\hline 
PREVIEW\_STATE\_BORDER\_WIDTH & integer & The empty border insets' width in pixels for the Preview state.\tabularnewline
\hline 
PREVIEW\_STATE\_BORDER\_HEIGHT & integer & The empty border insets' height in pixels for the Preview state.\tabularnewline
\hline 
PREVIEW\_STATE\_LEGEND\_HEIGHT & integer & Minimum height of the legend division (category strip) in pixels inside
THICKNESS the Preview state\tabularnewline
\hline 
PREVIEW\_ARROW\_LOG\_BASE & integer & The logarithmic base of the number of real arrows amalgamated in preview
arrow. This determines the Preview arrow's width.\tabularnewline
\hline 
\end{longtable}

\caption{\label{table:preference_zoomable_timeline_a}Parameters for the section
of \emph{Timeline Zoomable Window} in the Preference window, all integers
are assumed to be positive.}
\end{table}
...
\begin{longtable}{|c|>{\centering}p{1in}|>{\centering}p{3in}|}
\hline 
Parameter & Values & Description\tabularnewline
\hline 
HIGHLIGHT\_CLICKED\_OBJECT & true, false & Whether the clicked drawables should be highlighted.\tabularnewline
\hline 
POINTER\_ON\_CLICKED\_OBJECT & true, false & Whether pointers are used to locate the ends of clicked drawable.\tabularnewline
\hline 
MARKER\_STATE\_STAYS\_ON\_TOP & true, false & Whether the clicked or searched STATE is shown on top of the nested
stack, states that are on top of the clicked state will be hidden.\tabularnewline
\hline 
MARKER\_POINTER\_MIN\_LENGTH & integer & Minimum Length of the Pointer marker's arrow in pixels\tabularnewline
\hline 
MARKER\_POINTER\_MAX\_LENGTH & integer & Maximum Length of the Pointer marker's arrow in pixels\tabularnewline
\hline 
MARKER\_STATE\_BORDER\_WIDTH & integer & Border width in pixels of the STATE highlight marker.\tabularnewline
\hline 
MARKER\_ARROW\_BORDER\_WIDTH & integer & Border width in pixels of the ARROW highlight marker.\tabularnewline
\hline 
MARKER\_LINE\_BORDER\_WIDTH & integer & Border width in pixels of the PREVIEW ARROW highlight marker.\tabularnewline
\hline 
MARKER\_EVENT\_BORDER\_WIDTH & integer & Border width in pixels of the EVENT highlight marker\tabularnewline
\hline 
\end{longtable}

\caption{\label{table:preference_zoomable_timeline_b}Parameters for the section
of \emph{Timeline Zoomable Window} in the Preference window, all integers
are assumed to be positive. }
\end{table}
...
\begin{table}[!htbp]
\centering
\begin{longtable}{|l|>{\centering}p{1.6in}|p{2.8in}|}
\hline 
Parameter & Values & Description\tabularnewline
\hline 
\hline 
HISTOGRAM\_ZERO\_ORIGIN & true, false & Whether the time ruler is in duration, i.e. starts with 0.0 seconds.\tabularnewline
\hline 
SUMMARY\_STATE\_BORDER & ColorRaised, ColorLowered, ColorXOR, WhiteRaised, WhiteLowered, WhitePlain,
Empty & Border style of summary state when Histogram window starts up.\tabularnewline
\hline 
SUMMARY\_ARROW\_LOG\_BASE & integer & The logarithmic base of the number of real arrows amalgamated in summary
...
\hline 
\hline 
LEGEND\_PREVIEW\_ORDER & true, false & Whether to arrange the legends with a hidden preview order.\tabularnewline
\hline 
LEGEND\_TOPOLOGY\_ORDER & true, false & Whether to arrange the legends with a hidden topology order.\tabularnewline
\hline 
\end{longtable}
...
The level-of-detail support provided in SLOG-2 and Jumpshot-4's timeline
window tends to help locate states that either are longer in time
or occur very frequently. States that are short and occur rarely in
a big logfile are difficult to locate without a special tool. User
can easily spot the rarest states from looking at column \emph{count}
in the Legend window as in Figure \ref{fig:legend_popup}. In Jumpshot-4,
a search and scan facility is provided to facilitate this goal. There
are three search criteria: search time, searchable timeline IDs, and
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/timeline_search_preview}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/timeline_search_preview_zoomed}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/timeline_popup_finer}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/timeline_mpi_overhead}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{pic/histogram_mpi_overhead}
...
\section{Performance Analysis of Threaded MPI Application}
...
The test program, pthread\_sendrecv.c, used here first creates multiple
threads in each process. Each spawned thread then duplicates the MPI\_COMM\_WORLD
...
MPI\_COMM\_WORLD to form a ring. The program is shown at the end of
the document. MPE is built with --enable-threadlogging%
\footnote{--enable-threadlogging enables MPE to build a thread-safe MPI logging
library which is implemented by using a global mutex over MPE logging
library which is not thread-safe yet.%
} and --disable-safePMPI%
\footnote{MPE by defaults does --enable-safePMPI to protect the logging code
...
}. The most accessible MPI implementations with MPI\_THREAD\_MULTIPLE
...
Table \ref{tab:runtime_pthread_sendrecv} shows the total duration
...
thread. For OpenMPI+progress\_thread, the performance isn't as good
...
\hline 
child thread count & MPICH2 & OpenMPI+progress\_thread & OpenMPI\tabularnewline
\hline 
\hline 
1 & 0.025299 & 0.029545 & 0.029230\tabularnewline
\hline 
2 & 0.026213  & 0.030872  & 0.032966 \ref{fig:openmpi_4_2}\tabularnewline
\hline 
3 & 0.028916  & 0.038964  & 0.050484 \ref{fig:openmpi_4_3}\tabularnewline
\hline 
4 & 0.030145  & 0.045354  & 0.054791 \ref{fig:openmpi_4_4}\tabularnewline
\hline 
5 & 0.031977  & 0.058039  & 0.149200 \ref{fig:openmpi_4_5}\tabularnewline
\hline 
6 & 0.034462  & 0.058505  & 0.193399 \ref{fig:openmpi_4_6}\tabularnewline
\hline 
\end{longtable}

\caption{\label{tab:runtime_pthread_sendrecv}The total runtime (in second)
of the 4-process run of pthread\_sendrecv with various number of child
...
MPI\_THREAD\_MULTIPLE support. The 3rd column header, OpenMPI+progress\_thread,
...
which enables the MPI\_THREAD\_MULTIPLE support.}
\end{table}


The problematic data in the last column of Table \ref{tab:runtime_pthread_sendrecv}
are being analyzed with two Jumpshot viewmaps for each run. They are
shown in Figures \ref{fig:openmpi_4_2}, \ref{fig:openmpi_4_3},\ref{fig:openmpi_4_4},\ref{fig:openmpi_4_5}
and \ref{fig:openmpi_4_6}. The legend for these pictures are shown
in Figure\ref{fig:pthread_sendrecv_legend}. 

\begin{figure}[!htbp]
\centering

\includegraphics[scale=0.7]{pic/pthread_sendrecv_legend}

\caption{\label{fig:pthread_sendrecv_legend} The legend table of all the pthread\_sendrecv
runs.}
\end{figure}
...
where a duplicated MPI\_COMM\_WORLD is created for each thread, so
we expect to see 3 to 7 major communicator timelines. MPI\_COMM\_WORLD
is always labeled as 0 in CLOG2 converted SLOG-2 file and other duplicated
MPI\_Comm is labeled with other integer depends on the order of when
it is being created.
...
LabelExpand button \includegraphics{pic/gif2png/TreeExpand24} or
\emph{Alt-E} to expand each process timeline to reveal the thread
timeline. Similarly, user can use the Y-axis LabelCollapse button
\includegraphics{pic/gif2png/TreeCollapse24} or \emph{Alt-C} to collapse
...
Figures \ref{fig:openmpi_4_3}, \ref{fig:openmpi_4_4}, \ref{fig:openmpi_4_5}
and \ref{fig:openmpi_4_6} clearly demonstrate that there is some
...
\subfloat[process-thread view]{

\includegraphics[scale=0.4]{pic/openmpi_4_2_procthd}}

\centering

\subfloat[communicator-thread view]{

\includegraphics[scale=0.4]{pic/openmpi_4_2_commthd}}

\caption{\label{fig:openmpi_4_2}OpenMPI without progress thread: 2 child threads
per process. As shown in both the Process-Thread view and Communicator-Thread
views here, everything performs as expected.}
\end{figure}
...
\includegraphics[scale=0.4]{pic/openmpi_4_3_procthd}}

\centering

\subfloat[communicator-thread view]{

\includegraphics[scale=0.4]{pic/openmpi_4_3_commthd}}

\caption{\label{fig:openmpi_4_3}OpenMPI without progress thread: 3 child threads
per process where there are 3 MPI\_Comm\_dup() calls in the master
thread 0. As shown in the expanded Process-Thread view, the 3rd MPI\_Comm\_dup()
call takes significantly longer than the first two MPI\_Comm\_dup().
The expanded Communicator-Thread view also suggests that the delayed
3rd MPI\_Comm\_dup() is blocking MPI point-to-point communication
in the first two duplicated MPI\_COMM\_WORLD. As soon as the delayed
MPI\_Comm\_dup() exits, the MPI point-to-point communication is restored. }
\end{figure}
...
\includegraphics[scale=0.4]{pic/openmpi_4_4_procthd}}

\centering

\subfloat[communicator-thread view]{

\includegraphics[scale=0.4]{pic/openmpi_4_4_commthd}}

\caption{\label{fig:openmpi_4_4}OpenMPI without progress thread: 4 child threads
per process. Similar to Fig. \ref{fig:openmpi_4_3}, the 3rd MPI\_Comm\_dup()
is delayed but not the 4th MPI\_Comm\_dup(). The interference between
the delayed 3rd MPI\_Comm\_dup() and the other dup MPI\_COMM\_WORLD
seen in Fig. \ref{fig:openmpi_4_3} is not observed here. So the communication
in first two dup MPI\_COMM\_WORLD finishes much earlier than the communication
in the last two communicators.}
\end{figure}
...
\includegraphics[scale=0.4]{pic/openmpi_4_5_procthd}}

\centering

\subfloat[communicator-thread view]{

\includegraphics[scale=0.4]{pic/openmpi_4_5_commthd}}

\caption{\label{fig:openmpi_4_5}OpenMPI without progress thread: 5 child threads
per process. Again, the last MPI\_Comm\_dup() takes longer than previous
MPI\_Comm\_dup()s in finishing up. The feature that we observed in
Fig. \ref{fig:openmpi_4_3} that the delayed MPI\_Comm\_dup() is blocking
other communicator's communication occurs here. However, even long
after all MPI\_Comm\_dup() are done, there are many regions in the
...
\includegraphics[scale=0.4]{pic/openmpi_4_6_procthd}}

\centering

\subfloat[communicator-thread view]{

\includegraphics[scale=0.4]{pic/openmpi_4_6_commthd}}

\caption{\label{fig:openmpi_4_6}OpenMPI without progress thread: 6 child threads
per process. This is very similar to Fig. \ref{fig:openmpi_4_5}.}
\end{figure}
...
The following is the test program, pthread\_sendrecv.c, used in the
previous experiment.
