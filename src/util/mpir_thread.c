...
void MPIR_Thread_CS_Init(void)
{
    ...
    MPIR_Add_mutex(&MPIR_THREAD_POBJ_SEND_MUTEX);
    MPIR_Add_mutex(&MPIR_THREAD_POBJ_PROGRESS_HOOK_MUTEX);
    MPIR_Add_mutex(&MPIR_THREAD_POBJ_PROGRESS_MUTEX);
    MPIR_Add_mutex(&MPIR_THREAD_POBJ_RMA_MUTEX);
    MPIR_Add_mutex(&MPIR_THREAD_POBJ_LMT_MUTEX);
