...
static inline int OPA_fetch_and_add_int_by_llsc(OPA_int_t * ptr, int val)
{
    int prev;
    do {
        prev = OPA_LL_int(ptr);
...
static inline void OPA_add_int_by_llsc(OPA_int_t * ptr, int val)
{
    OPA_fetch_and_add_int_by_llsc(ptr, val);
}

static inline void OPA_incr_int_by_llsc(OPA_int_t * ptr)
{
    OPA_add_int_by_llsc(ptr, 1);
}

static inline void OPA_decr_int_by_llsc(OPA_int_t * ptr)
{
    OPA_add_int_by_llsc(ptr, -1);
}


static inline int OPA_fetch_and_decr_int_by_llsc(OPA_int_t * ptr)
{
    return OPA_fetch_and_add_int_by_llsc(ptr, -1);
}

static inline int OPA_fetch_and_incr_int_by_llsc(OPA_int_t * ptr)
{
    return OPA_fetch_and_add_int_by_llsc(ptr, 1);
}

static inline int OPA_decr_and_test_int_by_llsc(OPA_int_t * ptr)
{
...
static inline void *OPA_swap_ptr_by_llsc(OPA_ptr_t * ptr, void *val)
{
    void *prev;
    do {
        prev = OPA_LL_ptr(ptr);
...
static inline int OPA_fetch_and_add_int_by_cas(OPA_int_t * ptr, int val)
{
    int cmp;
...
static inline int OPA_fetch_and_incr_int_by_faa(OPA_int_t * ptr)
{
    return OPA_fetch_and_add_int(ptr, 1);
}

static inline int OPA_fetch_and_decr_int_by_faa(OPA_int_t * ptr)
{
    return OPA_fetch_and_add_int(ptr, -1);
}

static inline int OPA_decr_and_test_int_by_fad(OPA_int_t * ptr)
{
    return OPA_fetch_and_decr_int(ptr) == 1;
}

static inline void OPA_add_int_by_faa(OPA_int_t * ptr, int val)
{
    OPA_fetch_and_add_int(ptr, val);
}

static inline int OPA_incr_int_by_faa(OPA_int_t * ptr)
{
    return OPA_fetch_and_add_int(ptr, 1);
}

static inline void OPA_incr_int_by_add(OPA_int_t * ptr)
{
    OPA_add_int(ptr, 1);
}

static inline void OPA_incr_int_by_fai(OPA_int_t * ptr)
{
    OPA_fetch_and_incr_int(ptr);
}

static inline int OPA_decr_int_by_faa(OPA_int_t * ptr)
{
    return OPA_fetch_and_add_int(ptr, -1);
}

static inline void OPA_decr_int_by_add(OPA_int_t * ptr)
{
    OPA_add_int(ptr, -1);
}

static inline void OPA_decr_int_by_fad(OPA_int_t * ptr)
{
