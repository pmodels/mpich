...
MPIR_EXTERN MPID_Thread_mutex_t MPIR_THREAD_POBJ_SEND_MUTEX;
MPIR_EXTERN MPID_Thread_mutex_t MPIR_THREAD_POBJ_PROGRESS_HOOK_MUTEX;
MPIR_EXTERN MPID_Thread_mutex_t MPIR_THREAD_POBJ_PROGRESS_MUTEX;
MPIR_EXTERN MPID_Thread_mutex_t MPIR_THREAD_POBJ_RMA_MUTEX;
MPIR_EXTERN MPID_Thread_mutex_t MPIR_THREAD_POBJ_LMT_MUTEX;
