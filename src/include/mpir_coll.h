...
int MPIR_Ibarrier_sched_intra_recexch(PARAMS_BARRIER, MPIR_Sched_t s);
...
int MPIR_Reduce_scatter_inter_remote_reduce_local_scatter(PARAMS_REDUCE_SCATTER,
                                                          MPIR_Errflag_t * errflag);
...
int MPIR_Ireduce_scatter_sched_inter_remote_reduce_local_scatterv(PARAMS_REDUCE_SCATTER,
                                                                  MPIR_Sched_t s);
...
int MPIR_Reduce_scatter_block_intra_noncommutative(PARAMS_REDUCE_SCATTER_BLOCK,
                                                   MPIR_Errflag_t * errflag);
int MPIR_Reduce_scatter_block_intra_pairwise(PARAMS_REDUCE_SCATTER_BLOCK, MPIR_Errflag_t * errflag);
int MPIR_Reduce_scatter_block_intra_recursive_doubling(PARAMS_REDUCE_SCATTER_BLOCK,
                                                       MPIR_Errflag_t * errflag);
int MPIR_Reduce_scatter_block_intra_recursive_halving(PARAMS_REDUCE_SCATTER_BLOCK,
                                                      MPIR_Errflag_t * errflag);
int MPIR_Reduce_scatter_block_inter_auto(PARAMS_REDUCE_SCATTER_BLOCK, MPIR_Errflag_t * errflag);
int MPIR_Reduce_scatter_block_inter_remote_reduce_local_scatter(PARAMS_REDUCE_SCATTER_BLOCK,
                                                                MPIR_Errflag_t * errflag);
...
int MPIR_Ireduce_scatter_block_sched_intra_noncommutative(PARAMS_REDUCE_SCATTER_BLOCK,
                                                          MPIR_Sched_t s);
int MPIR_Ireduce_scatter_block_sched_intra_pairwise(PARAMS_REDUCE_SCATTER_BLOCK, MPIR_Sched_t s);
int MPIR_Ireduce_scatter_block_sched_intra_recursive_doubling(PARAMS_REDUCE_SCATTER_BLOCK,
                                                              MPIR_Sched_t s);
int MPIR_Ireduce_scatter_block_sched_intra_recursive_halving(PARAMS_REDUCE_SCATTER_BLOCK,
                                                             MPIR_Sched_t s);
int MPIR_Ireduce_scatter_block_sched_inter_auto(PARAMS_REDUCE_SCATTER_BLOCK, MPIR_Sched_t s);
int MPIR_Ireduce_scatter_block_sched_inter_remote_reduce_local_scatterv(PARAMS_REDUCE_SCATTER_BLOCK,
                                                                        MPIR_Sched_t s);
