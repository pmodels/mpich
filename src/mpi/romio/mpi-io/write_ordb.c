                                 ...
                                 MPI_Datatype datatype)
{
    ...
    fn_ptr =
        (QMPI_File_write_ordered_begin_t *) MPIR_QMPI_first_fn_ptrs[MPI_FILE_WRITE_ORDERED_BEGIN_T];
...
.N fortran
@*/
int QMPI_File_write_ordered_begin(QMPI_Context context, int tool_id, MPI_File fh,
