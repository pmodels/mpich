...
extern FORTRAN_API void FORT_CALL MPI_FILE_READ_ORDERED_END(MPI_Fint *, void *, MPI_Status *,
                                                            MPI_Fint *);
#pragma weak MPI_FILE_READ_ORDERED_END = PMPI_FILE_READ_ORDERED_END
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_ordered_end__(MPI_Fint *, void *, MPI_Status *,
                                                              MPI_Fint *);
...
#pragma weak mpi_file_read_ordered_end = pmpi_file_read_ordered_end
#else
extern FORTRAN_API void FORT_CALL mpi_file_read_ordered_end_(MPI_Fint *, void *, MPI_Status *,
                                                             MPI_Fint *);
