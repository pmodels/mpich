...
extern FORTRAN_API void FORT_CALL MPI_FILE_WRITE(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                 MPI_Status *, MPI_Fint *);
#pragma weak MPI_FILE_WRITE = PMPI_FILE_WRITE
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write__(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                   MPI_Status *, MPI_Fint *);
...
#pragma weak mpi_file_write = pmpi_file_write
#else
extern FORTRAN_API void FORT_CALL mpi_file_write_(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                  MPI_Status *, MPI_Fint *);
