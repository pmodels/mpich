...
extern FORTRAN_API void FORT_CALL MPI_FILE_IWRITE_SHARED(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                         MPI_Fint *, MPI_Fint *);
#pragma weak MPI_FILE_IWRITE_SHARED = PMPI_FILE_IWRITE_SHARED
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_iwrite_shared__(MPI_Fint *, void *, MPI_Fint *,
...
#pragma weak mpi_file_iwrite_shared = pmpi_file_iwrite_shared
#else
extern FORTRAN_API void FORT_CALL mpi_file_iwrite_shared_(MPI_Fint *, void *, MPI_Fint *,
                                                          MPI_Fint *, MPI_Fint *, MPI_Fint *);
