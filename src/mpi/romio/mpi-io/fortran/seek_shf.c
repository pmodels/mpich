...
extern FORTRAN_API void FORT_CALL MPI_FILE_SEEK_SHARED(MPI_Fint *, MPI_Offset *, MPI_Fint *,
                                                       MPI_Fint *);
#pragma weak MPI_FILE_SEEK_SHARED = PMPI_FILE_SEEK_SHARED
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_seek_shared__(MPI_Fint *, MPI_Offset *, MPI_Fint *,
                                                         MPI_Fint *);
...
#pragma weak mpi_file_seek_shared = pmpi_file_seek_shared
#else
extern FORTRAN_API void FORT_CALL mpi_file_seek_shared_(MPI_Fint *, MPI_Offset *, MPI_Fint *,
                                                        MPI_Fint *);
...
FORTRAN_API void FORT_CALL mpi_file_seek_shared_(MPI_Fint * fh, MPI_Offset * offset,
