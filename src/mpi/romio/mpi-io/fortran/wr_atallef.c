...
extern FORTRAN_API void FORT_CALL MPI_FILE_WRITE_AT_ALL_END(MPI_Fint *, void *, MPI_Status *,
                                                            MPI_Fint *);
#pragma weak MPI_FILE_WRITE_AT_ALL_END = PMPI_FILE_WRITE_AT_ALL_END
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write_at_all_end__(MPI_Fint *, void *, MPI_Status *,
                                                              MPI_Fint *);
...
#pragma weak mpi_file_write_at_all_end = pmpi_file_write_at_all_end
#else
extern FORTRAN_API void FORT_CALL mpi_file_write_at_all_end_(MPI_Fint *, void *, MPI_Status *,
                                                             MPI_Fint *);
