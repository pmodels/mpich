...
extern FORTRAN_API void FORT_CALL MPI_FILE_WRITE_ALL(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                     MPI_Status *, MPI_Fint *);
#pragma weak MPI_FILE_WRITE_ALL = PMPI_FILE_WRITE_ALL
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write_all__(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                       MPI_Status *, MPI_Fint *);
...
#pragma weak mpi_file_write_all = pmpi_file_write_all
#else
extern FORTRAN_API void FORT_CALL mpi_file_write_all_(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                      MPI_Status *, MPI_Fint *);
