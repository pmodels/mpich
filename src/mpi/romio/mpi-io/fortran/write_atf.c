...
extern FORTRAN_API void FORT_CALL MPI_FILE_WRITE_AT(MPI_Fint *, MPI_Offset *, void *, MPI_Fint *,
                                                    MPI_Fint *, MPI_Status *, MPI_Fint *);
#pragma weak MPI_FILE_WRITE_AT = PMPI_FILE_WRITE_AT
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write_at__(MPI_Fint *, MPI_Offset *, void *, MPI_Fint *,
                                                      MPI_Fint *, MPI_Status *, MPI_Fint *);
...
#pragma weak mpi_file_write_at = pmpi_file_write_at
#else
extern FORTRAN_API void FORT_CALL mpi_file_write_at_(MPI_Fint *, MPI_Offset *, void *, MPI_Fint *,
                                                     MPI_Fint *, MPI_Status *, MPI_Fint *);
