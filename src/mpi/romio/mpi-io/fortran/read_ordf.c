...
extern FORTRAN_API void FORT_CALL MPI_FILE_READ_ORDERED(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                        MPI_Status *, MPI_Fint *);
#pragma weak MPI_FILE_READ_ORDERED = PMPI_FILE_READ_ORDERED
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_ordered__(MPI_Fint *, void *, MPI_Fint *,
...
#pragma weak mpi_file_read_ordered = pmpi_file_read_ordered
#else
extern FORTRAN_API void FORT_CALL mpi_file_read_ordered_(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                         MPI_Status *, MPI_Fint *);
