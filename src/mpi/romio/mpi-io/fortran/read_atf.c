...
extern FORTRAN_API void FORT_CALL MPI_FILE_READ_AT(MPI_Fint *, MPI_Offset *, void *, MPI_Fint *,
                                                   MPI_Fint *, MPI_Status *, MPI_Fint *);
#pragma weak MPI_FILE_READ_AT = PMPI_FILE_READ_AT
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_read_at__(MPI_Fint *, MPI_Offset *, void *, MPI_Fint *,
                                                     MPI_Fint *, MPI_Status *, MPI_Fint *);
...
#pragma weak mpi_file_read_at = pmpi_file_read_at
#else
extern FORTRAN_API void FORT_CALL mpi_file_read_at_(MPI_Fint *, MPI_Offset *, void *, MPI_Fint *,
                                                    MPI_Fint *, MPI_Status *, MPI_Fint *);
