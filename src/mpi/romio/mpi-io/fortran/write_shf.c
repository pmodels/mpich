...
extern FORTRAN_API void FORT_CALL MPI_FILE_WRITE_SHARED(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                        MPI_Status *, MPI_Fint *);
#pragma weak MPI_FILE_WRITE_SHARED = PMPI_FILE_WRITE_SHARED
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_write_shared__(MPI_Fint *, void *, MPI_Fint *,
...
#pragma weak mpi_file_write_shared = pmpi_file_write_shared
#else
extern FORTRAN_API void FORT_CALL mpi_file_write_shared_(MPI_Fint *, void *, MPI_Fint *, MPI_Fint *,
                                                         MPI_Status *, MPI_Fint *);
