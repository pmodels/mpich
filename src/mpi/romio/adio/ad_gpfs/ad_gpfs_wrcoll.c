...
static void ADIOI_W_Exchange_data_alltoallv(ADIO_File fd, const void *buf, char *write_buf,     /* 1 */
                                            ...
                                            int *count, int *start_pos, int *partial_recv, int *sent_to_proc, int nprocs, int myrank, int buftype_is_contig, MPI_Count contig_access_count, ADIO_Offset min_st_offset, ADIO_Offset fd_size, ADIO_Offset * fd_start, ADIO_Offset * fd_end, ADIOI_Access * others_req, int *send_buf_idx, int *curr_to_proc,      /* 3 */
...
/* Uses a generalized version of the extended two-phase method described
   ...
   http://www.mcs.anl.gov/home/thakur/ext2ph.ps */
    ...
    MPI_Count contig_access_count = 0, interleave_count = 0, buftype_is_contig;
