...
struct ADIOI_Fns_struct ADIO_DAOS_operations = {
    ...
    ADIOI_DAOS_ReadStridedColl, /* ReadStridedColl */
    ADIOI_DAOS_WriteStridedColl,        /* WriteStridedColl */
    ...
    ADIOI_DAOS_IreadStridedColl,        /* IreadStridedColl */
    ADIOI_DAOS_IwriteStridedColl,       /* IwriteStridedColl */
};
