...
#undef FUNCNAME
#define FUNCNAME a2av_make_all_combined_msgs
#undef FCNAME
...
#undef FUNCNAME
#define FUNCNAME a2av_send_own_off_counts
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME a2av_get_friend_off_counts
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
...
#undef FUNCNAME
#define FUNCNAME a2av_exchange_data_with_friend
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
        ...
        void **exchange_sendbuf_ptr, void **exchange_recvbuf_ptr)
{
    ...
    *(char**)exchange_recvbuf_ptr = exchange_recvbuf; /* to return to the caller */
    ...
    print_vec(comm_ptr->rank, own_off_counts_sum,
