 ...
 */
#undef FUNCNAME
#define FUNCNAME MPIR_Reduce_scatter__intra__noncommutative
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Reduce_scatter__intra__noncommutative(const void *sendbuf, void *recvbuf, const int recvcounts[],
