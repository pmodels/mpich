...
#undef FUNCNAME
#define FUNCNAME MPIR_Reduce_scatter__inter__remote_reduce_local_scatter
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Reduce_scatter__inter__remote_reduce_local_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[],
                              ...
                              MPIR_Errflag_t *errflag)
{
    ...
    if (comm_ptr->is_low_group) {
        ...
        mpi_errno = MPIR_Reduce__inter__auto(sendbuf, tmp_buf, total_count, datatype, op,
