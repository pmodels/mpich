...
#include "mpiimpl.h"
#undef FUNCNAME
#define FUNCNAME MPIR_Alltoallw_pairwise_sendrecv_replace
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Alltoallw_pairwise_sendrecv_replace(const void *sendbuf, const int sendcounts[], const int sdispls[],
