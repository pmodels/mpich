                               ...
                               MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
    ...
    MPIR_COLL_CHKLMEM_MALLOC(tmp_buf, pack_size, attr, mpi_errno, "tmp_buf", MPL_MEM_BUFFER);
    ...
    MPIR_COLL_CHKLMEM_MALLOC_HOST(displs, comm_size * sizeof(int), mpi_errno, "displs",
                                  MPL_MEM_BUFFER);
