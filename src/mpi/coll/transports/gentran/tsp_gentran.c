...
int MPII_Genutil_sched_selective_sink(MPIR_TSP_sched_t s, int n_in_vtcs, int *in_vtcs)
{
    MPII_Genutil_sched_t *sched = s;
    vtx_t *vtxp;
    int vtx_id;
...
int MPII_Genutil_sched_start(MPIR_TSP_sched_t s, MPIR_Comm * comm, MPIR_Request ** req)
{
    MPII_Genutil_sched_t *sched = s;
    int mpi_errno = MPI_SUCCESS;
    int is_complete;
