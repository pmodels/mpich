...
#undef FUNCNAME
#define FUNCNAME MPIR_Ineighbor_alltoall_sched__intra__auto
#undef FCNAME
...
#undef FUNCNAME
#define FUNCNAME MPIR_Ineighbor_alltoall_sched__inter__auto
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
    ...
    if (comm_ptr->comm_kind == MPIR_COMM_KIND__INTRACOMM) {
        switch (MPIR_Ineighbor_alltoall_intra_algo_choice) {
            ...
            case MPIR_INEIGHBOR_ALLTOALL_INTRA_ALGO_AUTO:
                MPL_FALLTHROUGH;
            default:
                mpi_errno = MPIR_Ineighbor_alltoall_sched__intra__auto(sendbuf, sendcount, sendtype,
                                                          recvbuf, recvcount, recvtype,
                                                          comm_ptr, s);
                break;
        }
        ...
        switch (MPIR_Ineighbor_alltoall_inter_algo_choice) {
            ...
            case MPIR_INEIGHBOR_ALLTOALL_INTER_ALGO_AUTO:
                MPL_FALLTHROUGH;
            default:
                mpi_errno = MPIR_Ineighbor_alltoall_sched__inter__auto(sendbuf, sendcount, sendtype,
                                                          recvbuf, recvcount, recvtype,
                                                          comm_ptr, s);
                break;
        }
...
#   endif /* HAVE_ERROR_CHECKING */
    ...
    mpi_errno = MPIR_Ineighbor_alltoall(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, &request_ptr);
    if (mpi_errno) MPIR_ERR_POP(mpi_errno);
