...
#undef FUNCNAME
#define FUNCNAME MPIR_Ialltoallv_sched__intra__auto
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Ialltoallv_sched__intra__auto(const void *sendbuf, const int sendcounts[], const int sdispls[],
                          MPI_Datatype sendtype, void *recvbuf, const int recvcounts[],
                          ...
                          MPIR_Sched_t s)
{
    ...
    if (sendbuf == MPI_IN_PLACE) {
        mpi_errno = MPIR_Ialltoallv_sched__intra__inplace(sendbuf, sendcounts, sdispls,
                                                  sendtype, recvbuf, recvcounts,
                                                  rdispls, recvtype, comm_ptr, s);
    } else {
        mpi_errno = MPIR_Ialltoallv_sched__intra__blocked(sendbuf, sendcounts, sdispls,
                                                  sendtype, recvbuf, recvcounts,
                                                  rdispls, recvtype, comm_ptr, s);
    }
...
#undef FUNCNAME
#define FUNCNAME MPIR_Ialltoallv_sched__inter__auto
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Ialltoallv_sched__inter__auto(const void *sendbuf, const int sendcounts[], const int sdispls[],
                          MPI_Datatype sendtype, void *recvbuf, const int recvcounts[],
                          const int rdispls[], MPI_Datatype recvtype, MPIR_Comm *comm_ptr,
                          MPIR_Sched_t s)
{
    ...
    mpi_errno = MPIR_Ialltoallv_sched__inter__pairwise_exchange(sendbuf, sendcounts, sdispls,
                                            sendtype, recvbuf, recvcounts,
                                            rdispls, recvtype, comm_ptr, s);
    ...
    if (comm_ptr->comm_kind == MPIR_COMM_KIND__INTRACOMM) {
        ...
        switch (MPIR_Ialltoallv_intra_algo_choice) {
            ...
            case MPIR_IALLTOALLV_INTRA_ALGO_AUTO:
                MPL_FALLTHROUGH;
            default:
                mpi_errno = MPIR_Ialltoallv_sched__intra__auto(sendbuf, sendcounts, sdispls,
                 sendtype, recvbuf, recvcounts, rdispls, recvtype, comm_ptr, s);
                break;
        }
    } else {
        ...
        switch (MPIR_Ialltoallv_inter_algo_choice) {
            ...
            case MPIR_IALLTOALLV_INTER_ALGO_AUTO:
                MPL_FALLTHROUGH;
            default:
                mpi_errno = MPIR_Ialltoallv_sched__inter__auto(sendbuf, sendcounts, sdispls,
                 sendtype, recvbuf, recvcounts, rdispls, recvtype, comm_ptr, s);
                break;
        }
    }
