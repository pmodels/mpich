...
#undef FUNCNAME
#define FUNCNAME MPIR_TSP_Iallreduce_sched_intra_recexch_reduce_scatter_recexch_allgatherv
#undef FCNAME
                                                                              ...
                                                                              sched)
{
    ...
    if (in_step2) {
        int *cnts = (int *) MPL_malloc(nranks * sizeof(int), MPL_MEM_COLL);
        int *displs = (int *) MPL_malloc(nranks * sizeof(int), MPL_MEM_COLL);
        int index = 0;
        int rem = nranks - p_of_k;
...
#undef FUNCNAME
#define FUNCNAME MPIR_TSP_Iallreduce_intra_recexch_reduce_scatter_recexch_allgatherv
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
