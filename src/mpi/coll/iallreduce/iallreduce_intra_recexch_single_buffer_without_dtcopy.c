...
#undef FUNCNAME
#define FUNCNAME MPIR_Iallreduce_intra_recexch_single_buffer_without_dtcopy
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Iallreduce_intra_recexch_single_buffer_without_dtcopy(const void *sendbuf, void *recvbuf,
