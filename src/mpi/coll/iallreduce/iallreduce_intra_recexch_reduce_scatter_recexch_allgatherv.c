...
#undef FUNCNAME
#define FUNCNAME MPIR_Iallreduce_intra_recexch_reduce_scatter_recexch_allgatherv
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Iallreduce_intra_recexch_reduce_scatter_recexch_allgatherv(const void *sendbuf,
