...
#undef FUNCNAME
#define FUNCNAME MPIR_Ireduce_scatter_generic_inter_sched
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Ireduce_scatter_generic_inter_sched(const void *sendbuf, void *recvbuf, const int recvcounts[],
