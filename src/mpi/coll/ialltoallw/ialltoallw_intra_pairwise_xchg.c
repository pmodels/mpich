...
#undef FUNCNAME
#define FUNCNAME MPIR_Ialltoallw_intra_pairwise_xchg_sched
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Ialltoallw_intra_pairwise_xchg_sched(const void *sendbuf, const int sendcounts[], const int sdispls[],
