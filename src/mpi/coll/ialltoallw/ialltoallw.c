...
#undef FUNCNAME
#define FUNCNAME MPIR_Ialltoallw_sched_intra
#undef FCNAME
...
#undef FUNCNAME
#define FUNCNAME MPIR_Ialltoallw_sched_inter
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
    ...
    if (comm_ptr->comm_kind == MPIR_COMM_KIND__INTRACOMM) {
        ...
        switch (MPIR_Ialltoallw_intra_algo_choice) {
            ...
            case MPIR_IALLTOALLW_INTRA_ALGO_AUTO:
                MPL_FALLTHROUGH;
            default:
                mpi_errno = MPIR_Ialltoallw_sched_intra(sendbuf, sendcounts, sdispls,
                 sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm_ptr, s);
                break;
        }
    } else {
        ...
        switch (MPIR_Ialltoallw_inter_algo_choice) {
            ...
            case MPIR_IALLTOALLW_INTER_ALGO_AUTO:
                MPL_FALLTHROUGH;
            default:
                mpi_errno = MPIR_Ialltoallw_sched_inter(sendbuf, sendcounts, sdispls,
                 sendtypes, recvbuf, recvcounts, rdispls, recvtypes, comm_ptr, s);
                break;
        }
    }
