...
#undef FUNCNAME
#define FUNCNAME MPIR_Ialltoallw_sched__inter__pairwise_exchange
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Ialltoallw_sched__inter__pairwise_exchange(const void *sendbuf, const int sendcounts[], const int sdispls[],
