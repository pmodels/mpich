                         ...
                         MPIR_Errflag_t *errflag)
{
    ...
    mpi_errno = MPIR_Alltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm_ptr, errflag);
                   ...
                   MPI_Datatype recvtype, MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag)
{
    ...
    int use_coll = MPIR_CVAR_USE_ALLTOALLV;
    if(comm_ptr->comm_kind == MPIR_COMM_KIND__INTERCOMM)
        use_coll = DEFAULT_ALLTOALLV;
    switch (use_coll) {
        case DEFAULT_ALLTOALLV:
        default:
            mpi_errno = MPIC_DEFAULT_Alltoallv(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype, comm_ptr, errflag);
            break;
    }
