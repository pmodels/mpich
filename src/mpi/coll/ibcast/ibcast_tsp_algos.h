                                     ...
                                     MPIR_TSP_sched_t * sched)
{
    ...
    MPII_Algo_calculate_pipeline_chunk_info(segsize, type_size, count, &num_chunks,
                                            &chunk_size_floor, &chunk_size_ceil);
    /* print chunking information */
    MPL_DBG_MSG_FMT(MPIR_DBG_COLL, VERBOSE, (MPL_DBG_FDEST,
                                             "Broadcast pipeline info: segsize=%d count=%d num_chunks=%d chunk_size_floor=%d chunk_size_ceil=%d \n",
                                             segsize, count, num_chunks,
                                             chunk_size_floor, chunk_size_ceil));
                               ...
                               int segsize)
{
    ...
    *req = NULL;
    ...
    mpi_errno = MPIR_TSP_Ibcast_sched_intra_tree(buffer, count, datatype, root, tag, comm,
