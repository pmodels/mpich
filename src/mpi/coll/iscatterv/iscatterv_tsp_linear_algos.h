...
#undef FUNCNAME
#define FUNCNAME MPIR_TSP_Iscatterv_sched_allcomm_linear
#undef FCNAME
...
#undef FUNCNAME
#define FUNCNAME MPIR_TSP_Iscatterv_allcomm_linear
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
                                      ...
                                      MPIR_Comm * comm, MPIR_Request ** req)
{
    ...
    *req = NULL;
    ...
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIR_TSP_TSP_ISCATTERV_ALLCOMM_LINEAR);
