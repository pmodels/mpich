...
#undef FUNCNAME
#define FUNCNAME MPIR_Alltoallw_sendrecv_replace
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Alltoallw_sendrecv_replace(
    const void *sendbuf,
...
#undef FUNCNAME
#define FUNCNAME MPIR_Alltoallw_isend_irecv
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Alltoallw_isend_irecv(
    const void *sendbuf,
    const int sendcounts[],
    const int sdispls[],
    const MPI_Datatype sendtypes[],
...
#undef FUNCNAME
#define FUNCNAME MPIR_Alltoallw_pairwise_exchange
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Alltoallw_pairwise_exchange(
    const void *sendbuf,
    const int sendcounts[],
    const int sdispls[],
    const MPI_Datatype sendtypes[],
