                             ...
                             MPIR_Info * info_ptr, MPIR_Request ** request)
{
    ...
    mpi_errno = MPIR_Iallreduce_sched_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr,
                        ...
                        MPIR_Request ** request)
{
    ...
    if ((MPIR_CVAR_DEVICE_COLLECTIVES == MPIR_CVAR_DEVICE_COLLECTIVES_all) ||
        ...
        mpi_errno =
            MPIR_Allreduce_init_impl(sendbuf, recvbuf, count, datatype, op, comm_ptr, info_ptr,
                                     request);
    }
