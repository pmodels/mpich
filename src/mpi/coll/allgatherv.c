...
#undef FUNCNAME
#define FUNCNAME MPIR_Allgatherv_recursive_doubling
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Allgatherv_recursive_doubling(
    const void *sendbuf,
    int sendcount,
    MPI_Datatype sendtype,
    void *recvbuf,
    ...
    MPIR_Errflag_t *errflag )
{
    ...
    int dst_tree_root = 0;
    int my_tree_root = 0;
    int is_homogeneous = 0;
    int position = 0;
    int send_offset = 0;
    int recv_offset = 0;
    int last_recv_cnt = 0;
    int nprocs_completed = 0;
    int k = 0;
    int offset = 0;
    int tmp_mask = 0;
    int tree_root = 0;
...
#undef FUNCNAME
#define FUNCNAME MPIR_Allgatherv_bruck
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Allgatherv_bruck(
    const void *sendbuf,
    int sendcount,
    MPI_Datatype sendtype,
    void *recvbuf,
