                    ...
                    MPIR_Comm *comm_ptr, MPIR_Errflag_t *errflag)
{
    ...
    int use_coll = MPIR_CVAR_USE_ALLGATHERV;
    if(comm_ptr->comm_kind == MPIR_COMM_KIND__INTERCOMM)
        use_coll = MPIC_DEFAULT_ALLGATHERV;

    switch(use_coll) {
        case MPIC_DEFAULT_ALLGATHERV:
        default:
            mpi_errno = MPIC_DEFAULT_Allgatherv(sendbuf, sendcount, sendtype,
