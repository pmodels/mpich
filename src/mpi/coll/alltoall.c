...
#undef FUNCNAME
#define FUNCNAME MPIR_Alltoall_sendrecv_replace
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Alltoall_sendrecv_replace(
    const void *sendbuf,
    int sendcount,
    MPI_Datatype sendtype,
    void *recvbuf,
...
#undef FUNCNAME
#define FUNCNAME MPIR_Alltoall_bruck
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Alltoall_bruck(
    const void *sendbuf,
    int sendcount,
    MPI_Datatype sendtype,
    void *recvbuf,
    ...
    MPIR_Errflag_t *errflag)
{
    ...
    MPI_Aint recvtype_extent = 0;
    MPI_Aint recvtype_true_extent = 0;
    MPI_Aint recvbuf_extent = 0;
    MPI_Aint recvtype_true_lb = 0;
    int mpi_errno = MPI_SUCCESS;
    int src = 0;
    int dst = 0;
    int rank = -1;
...
#undef FUNCNAME
#define FUNCNAME MPIR_Alltoall_isend_irecv
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Alltoall_isend_irecv(
    const void *sendbuf,
    int sendcount,
    MPI_Datatype sendtype,
    void *recvbuf,
...
#undef FUNCNAME
#define FUNCNAME MPIR_Alltoall_pairwise_exchange
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
int MPIR_Alltoall_pairwise_exchange(
    const void *sendbuf,
    int sendcount,
    MPI_Datatype sendtype,
    void *recvbuf,
    ...
    MPIR_Errflag_t *errflag)
{
    ...
    pof2 = MPIU_is_pof2(comm_size, NULL);
