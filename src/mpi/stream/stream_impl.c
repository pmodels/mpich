                                 ...
                                 MPIR_Comm ** newcomm_ptr)
{
    ...
    mpi_errno = MPIR_Allgather_impl(&vci, 1, MPI_INT, vci_table, 1, MPI_INT, comm_ptr);
    MPIR_ERR_CHECK(mpi_errno);
                                           ...
                                           MPIR_Comm ** newcomm_ptr)
{
    ...
    mpi_errno = MPIR_Allgather_impl(&num_tmp, 1, MPI_AINT, num_table, 1, MPI_AINT, comm_ptr);
    MPIR_ERR_CHECK(mpi_errno);
