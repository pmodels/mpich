...
int MPIR_Threadcomm_barrier_impl(MPIR_Comm * comm)
{
    ...
    if (comm->local_size == 1) {
        ...
        mpi_errno = MPIR_Barrier_intra_dissemination(comm, 0);
    }
                               ...
                               int root, MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Bcast_intra_binomial(buffer, count, datatype, root, comm, 0);
                                ...
                                int root, MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Gather_intra_binomial(sendbuf, sendcount, sendtype,
                                           recvbuf, recvcount, recvtype, root, comm, 0);
                                 ...
                                 int root, MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Gatherv_allcomm_linear(sendbuf, sendcount, sendtype,
                                            recvbuf, recvcounts, displs, recvtype, root, comm, 0);
                                   ...
                                   MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Allgather_intra_brucks(sendbuf, sendcount, sendtype,
                                            recvbuf, recvcount, recvtype, comm, 0);
                                    ...
                                    MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Allgatherv_intra_brucks(sendbuf, sendcount, sendtype,
                                             recvbuf, recvcounts, displs, recvtype, comm, 0);
                                   ...
                                   MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Alltoallv_intra_scattered(sendbuf, sendcounts, sdispls, sendtype,
                                               recvbuf, recvcounts, rdispls, recvtype, comm, 0);
                                   ...
                                   MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Alltoallw_intra_scattered(sendbuf, sendcounts, sdispls, sendtypes,
                                               recvbuf, recvcounts, rdispls, recvtypes, comm, 0);
                                ...
                                MPI_Op op, int root, MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Reduce_intra_binomial(sendbuf, recvbuf, count, datatype, op, root, comm, 0);
                              ...
                              MPI_Aint count, MPI_Datatype datatype, MPI_Op op, MPIR_Comm * comm)
{
    ...
    mpi_errno = MPIR_Scan_intra_recursive_doubling(sendbuf, recvbuf, count, datatype, op, comm, 0);
