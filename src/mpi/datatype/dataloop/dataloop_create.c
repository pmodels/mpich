				     ...
				     int flag)
{
	...
	*dlp_p = old_dlp;
	...
	case MPI_COMBINER_STRUCT:
	    if (ints[0] == 0) {
		MPIR_Dataloop_create_contiguous(0,
							   MPI_INT,
							   dlp_p,
							   dlsz_p,
							   dldepth_p,
	...
	case MPI_COMBINER_DUP:
		...
		*dldepth_p = old_dldepth;
		...
		MPIR_Dataloop_create_contiguous(1,
							   types[0], 
							   dlp_p, dlsz_p,
							   dldepth_p,
							   flag);
	...
	case MPI_COMBINER_SUBARRAY:
	    ndims = ints[0];
	    MPIR_Type_convert_subarray(ndims,
						  &ints[1] /* sizes */,
					...
					int flag)
{
	...
	if (dlp != NULL) {
	    ...
	    *dlp_p = dlp;
	    ...
	    MPIR_Dataloop_create_pairtype(type,
						     dlp_p,
						     dlsz_p,
						     dldepth_p,
						     flag);
