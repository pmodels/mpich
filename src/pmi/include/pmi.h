...
#define PMI_GROUP_NODE_ROOTS ((int *)3)
...
PMI_GROUP_NODE, PMI_GROUP_NODE_ROOTS, can be used to represent commonly
used special groups. When such constants are used, the count parameter is
ignored.
...
@*/
    int PMI_Barrier_group(int *group, int count);
