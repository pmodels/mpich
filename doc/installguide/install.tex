...
\begin{verbatim}
    cd  /tmp/you/mpich2-1.0.7rc1
    /home/you/libraries/mpich2-1.0.7rc1/configure \
...
\texttt{mpich2-1.0.7rc1/src/pm/mpd/README}.
...
% the directory \texttt{mpich2-1.0.7rc1/examples}.  
...
\texttt{mpich2-1.0.7rc1/examples} directory.  If the current directory is the top
...
From version 1.0.7rc1 onwards, by default, the MPICH2 library is built
...
\end{verbatim}
where \texttt{PATH\_TO\_MPICH2\_EXAMPLES} is the path to the
\texttt{mpich2-1.0.7rc1/examples} directory.
