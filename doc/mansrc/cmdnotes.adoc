...
-arch architecture_name:: name of the computer architecture required for this executable
-wdir working_directory:: The working directory to use when running the executable (set before the executable starts)
