...
case for using some mechanism, such as thread locks, to ensure that 
only one thread at a time makes use of this routine.  
// end::ThreadSafeInfoRead[]


// tag::ThreadSafeNoUpdate[]
...
// tag::MPI_ERR_NOT_SAME[]
* MPI_ERR_NOT_SAME - 
// end::MPI_ERR_NOT_SAME[]
...
// tag::MPI_ERR_UNSUPPORTED_OPERATION[]
* MPI_ERR_UNSUPPORTED_OPERATION - 
// end::MPI_ERR_UNSUPPORTED_OPERATION[]
...
// tag::MPI_ERR_LOCKTYPE[]
* MPI_ERR_LOCKTYPE - 
// end::MPI_ERR_LOCKTYPE[]


// tag::MPI_ERR_RMA_CONFLICT[]
* MPI_ERR_RMA_CONFLICT - 
// end::MPI_ERR_RMA_CONFLICT[]
...
* MPI_T_ERR_INVALID_ITEM - Same as MPI_T_ERR_INVALID_INDEX. Index is invalid or has been deleted.
